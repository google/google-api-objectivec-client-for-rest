 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeDataprocMetastoreCloudPlatform;
...
/**
 *  Service for executing Dataproc Metastore API queries.
 *
 *  The Dataproc Metastore API is used to manage the lifecycle and configuration
 *  of metastore services.
 */
@interface GTLRDataprocMetastoreService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRDataprocMetastoreQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
