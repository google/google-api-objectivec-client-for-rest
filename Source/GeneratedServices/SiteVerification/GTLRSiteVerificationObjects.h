...
@class GTLRSiteVerification_WebResourceGettokenRequestSite;
@class GTLRSiteVerification_WebResourceResource;
@class GTLRSiteVerification_WebResourceResourceSite;
 ...
 *  The site for which a verification token will be generated.
 */
@interface GTLRSiteVerification_WebResourceGettokenRequestSite : GTLRObject
 ...
 *  The address and type of a site that is verified or will be verified.
 */
@interface GTLRSiteVerification_WebResourceResourceSite : GTLRObject
