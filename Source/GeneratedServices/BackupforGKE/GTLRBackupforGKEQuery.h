...
@class GTLRBackupforGKE_GoogleLongrunningCancelOperationRequest;
@class GTLRBackupforGKE_Restore;
@class GTLRBackupforGKE_RestorePlan;
@class GTLRBackupforGKE_SetIamPolicyRequest;
@class GTLRBackupforGKE_TestIamPermissionsRequest;
