...
NSString * const kGTLRRemoteBuildExecution_GoogleDevtoolsRemotebuildbotCommandEvents_OutputLocation_LocationExecRootAndWorkingDirRelativeOutputOutsideWorkingDir = @"LOCATION_EXEC_ROOT_AND_WORKING_DIR_RELATIVE_OUTPUT_OUTSIDE_WORKING_DIR";
...
NSString * const kGTLRRemoteBuildExecution_GoogleDevtoolsRemotebuildbotCommandEvents_OutputLocation_LocationExecRootRelativeOutputOutsideWorkingDir = @"LOCATION_EXEC_ROOT_RELATIVE_OUTPUT_OUTSIDE_WORKING_DIR";
...
NSString * const kGTLRRemoteBuildExecution_GoogleDevtoolsRemotebuildbotCommandStatus_Code_DockerCreateComputeSystemIncorrectParameterError = @"DOCKER_CREATE_COMPUTE_SYSTEM_INCORRECT_PARAMETER_ERROR";
...
NSString * const kGTLRRemoteBuildExecution_GoogleDevtoolsRemotebuildbotCommandStatus_Code_UploadOutputsBytesLimitExceeded = @"UPLOAD_OUTPUTS_BYTES_LIMIT_EXCEEDED";
...
NSString * const kGTLRRemoteBuildExecution_GoogleDevtoolsRemotebuildbotCommandStatus_Code_WorkingDirNotRelative = @"WORKING_DIR_NOT_RELATIVE";
...
NSString * const kGTLRRemoteBuildExecution_GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicy_LinuxIsolation_Off = @"OFF";
