...
@class GTLRCloudRedis_ClusterSlots;
@class GTLRCloudRedis_Endpoint;
...
@class GTLRCloudRedis_PrivateServiceConnect;
 ...
 */
@property(nonatomic, strong, nullable) NSNumber *defaultReplicaCount;
 ...
 *  cluster.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudRedis_Endpoint *> *endpoints;
...
@property(nonatomic, strong, nullable) GTLRCloudRedis_PrivateServiceConnect *privateServiceConnect;

/**
 *  Optional. Redis configuration parameters, according to
 *  http://redis.io/topics/config. Currently, the only supported parameters are:
 *  Redis version 6.x and newer: * lfu-decay-time * lfu-log-factor *
 *  maxmemory-policy
 */
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudRedis_ClusterSlots *> *slots;
 ...
 *  Uses NSNumber of intValue.
 */
@property(nonatomic, strong, nullable) NSNumber *totalMemorySizeGb;
 ...
 */
@interface GTLRCloudRedis_ClusterSlots : GTLRObject
 ...
 *  Uses NSNumber of intValue.
 */
@property(nonatomic, strong, nullable) NSNumber *endSlotsExclusive;
 ...
 *  Uses NSNumber of intValue.
 */
@property(nonatomic, strong, nullable) NSNumber *startSlotsInclusive;
 ...
 *  is ready.
 */
@interface GTLRCloudRedis_Endpoint : GTLRObject
 ...
 */
@interface GTLRCloudRedis_PrivateServiceConnect : GTLRObject

/**
 *  Output only. The address of the Private Service Connect (PSC) service that
 *  the customer can use to connect this instance to their local network.
 */
@property(nonatomic, copy, nullable) NSString *pscService;

/**
 *  Optional. The service route to connect using Private Service Connect. On
 *  Instance creation, this will automatically connect this route to this
 *  instance.
 */
@property(nonatomic, copy, nullable) NSString *pscServiceRoute;
