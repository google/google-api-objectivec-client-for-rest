 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeDocumentCloudPlatform;
...
/**
 *  Service for executing Cloud Document AI API queries.
 *
 *  Service to parse structured information from unstructured or semi-structured
 *  documents using state-of-the-art Google AI such as natural language,
 *  computer vision, translation, and AutoML.
 */
@interface GTLRDocumentService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRDocumentQuery.h. The query can the be sent with GTLRService's execute
// methods,
//
