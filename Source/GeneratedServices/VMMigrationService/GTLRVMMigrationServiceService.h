 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeVMMigrationServiceCloudPlatform;
 ...
 *  workloads.
 */
@interface GTLRVMMigrationServiceService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRVMMigrationServiceQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
