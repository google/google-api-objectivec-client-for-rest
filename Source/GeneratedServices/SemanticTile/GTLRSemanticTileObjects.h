 ...
 *        of triangles with three vertex indices per triangle.
 *        The vertex indices can be found in the triangle_indices field.
 ...
 *        / \\ / \\
 *        / \\ / \\
 *        (1)----(2) (3)----(5) (Value: "INDEXED_TRIANGLES")
 *    @arg @c kGTLRSemanticTile_Area_Type_TriangleFan The first vertex in
 *        vertex_offset is the center of a triangle fan. The
 *        other vertices are arranged around this vertex in a fan shape. The
 *        following diagram showes a triangle fan polygon with the vertices
 *        labelled with their indices in the vertex_offset list.
 *        Triangle fan polygons always have a single boundary loop.
 ...
 *        where each triangle uses the last edge of the
 *        previous triangle.
 *        Vertices may be in either a clockwise or counterclockwise order.
 ...
 *        with grade-separated crossings that is accessed exclusively by
 *        ramps. These are usually called "freeways" or "motorways".
 ...
 *        people receive general (not vocation or
 *        professional) education. (Value: "SCHOOL")
 ...
 *        out OK. The cache-control header determines how long
 ...
 *        API. (Value: "STATUS_OK_DATA_UNCHANGED")
 */
 ...
 *  The origin of this coordinate system is always at the northwest corner of
 *  the
