...
@class GTLRCloudDataplex_GoogleCloudDataplexV1CancelJobRequest;
...
@class GTLRCloudDataplex_GoogleIamV1SetIamPolicyRequest;
@class GTLRCloudDataplex_GoogleIamV1TestIamPermissionsRequest;
@class GTLRCloudDataplex_GoogleLongrunningCancelOperationRequest;
