 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeBareMetalSolutionCloudPlatform;
...
// GTLRBareMetalSolutionQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
