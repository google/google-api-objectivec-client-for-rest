 ...
 *        enabled).
 */
@interface GTLRAssuredworkloads_GoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse : GTLRCollectionObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRAssuredworkloads_GoogleCloudAssuredworkloadsV1beta1Workload *> *workloads;
