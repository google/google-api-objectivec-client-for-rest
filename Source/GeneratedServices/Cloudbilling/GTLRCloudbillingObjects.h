 ...
 *        nature, e.g. a license sku. Global skus are available in all regions,
 *        and so have an empty region list. (Value: "GLOBAL")
 *    @arg @c kGTLRCloudbilling_GeoTaxonomy_Type_MultiRegional The sku is
 *        associated with multiple regions, e.g. "us-west2" and "us-east1".
 *        (Value: "MULTI_REGIONAL")
 ...
 *  time range. This is guaranteed to be greater than or equal to the start_time
 *  field in the request and less than the end_time field in the request. If a
 *  time range was not specified in the request this field will be equivalent to
 *  a time within the last 12 hours, indicating the latest pricing info.
 */
