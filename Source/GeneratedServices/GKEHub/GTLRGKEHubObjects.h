...
@class GTLRGKEHub_PolicyControllerPolicyControllerHubConfig;
@class GTLRGKEHub_PolicyControllerPolicyControllerHubState;
@class GTLRGKEHub_PolicyControllerPolicyControllerHubState_DeploymentStates;
@class GTLRGKEHub_PolicyControllerPolicyControllerHubVersion;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_PolicyControllerMembershipState_State_Decomissioning;
/**
...
/**
 *  Request to disable Policy Controller. If Policy Controller is not installed,
 *  it will be installed but disabled.
 *
 *  Value: "INSTALL_SPEC_DISABLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_PolicyControllerPolicyControllerHubConfig_InstallSpec_InstallSpecDisabled;
/**
 *  Request to install and enable Policy Controller.
 *
 *  Value: "INSTALL_SPEC_ENABLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_PolicyControllerPolicyControllerHubConfig_InstallSpec_InstallSpecEnabled;
/**
 *  Request to uninstall Policy Controller.
 *
 *  Value: "INSTALL_SPEC_NOT_INSTALLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_PolicyControllerPolicyControllerHubConfig_InstallSpec_InstallSpecNotInstalled;
/**
 *  Spec is unknown.
 *
 *  Value: "INSTALL_SPEC_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_PolicyControllerPolicyControllerHubConfig_InstallSpec_InstallSpecUnspecified;
 ...
 *  Deployment was attempted to be installed, but has errors
 *
 *  Value: "DEPLOYMENT_STATE_ERROR"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_PolicyControllerPolicyControllerHubState_DeploymentStates_DeploymentState_DeploymentStateError;
/**
 *  Deployment is installed
 *
 *  Value: "DEPLOYMENT_STATE_INSTALLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_PolicyControllerPolicyControllerHubState_DeploymentStates_DeploymentState_DeploymentStateInstalled;
/**
 *  Deployment is not installed
 *
 *  Value: "DEPLOYMENT_STATE_NOT_INSTALLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_PolicyControllerPolicyControllerHubState_DeploymentStates_DeploymentState_DeploymentStateNotInstalled;
/**
 *  Deployment's state cannot be determined
 *
 *  Value: "DEPLOYMENT_STATE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_PolicyControllerPolicyControllerHubState_DeploymentStates_DeploymentState_DeploymentStateUnspecified;
...
/** Policy Controller configuration for the cluster. */
@property(nonatomic, strong, nullable) GTLRGKEHub_PolicyControllerPolicyControllerHubConfig *policyControllerHubConfig;
 ...
 *  The user-defined name for the cluster used by ClusterSelectors to group
 *  clusters together. This should match Membership's membership_name, unless
 *  the user installed PC on the cluster manually prior to enabling the PC hub
 *  feature. Unique within a Policy Controller installation.
 */
@property(nonatomic, copy, nullable) NSString *clusterName;
 ...
 *  intended state
 */
@property(nonatomic, strong, nullable) GTLRGKEHub_PolicyControllerMembershipSpec *membershipSpec;

/** Policy Controller state observed by the Policy Controller Hub */
@property(nonatomic, strong, nullable) GTLRGKEHub_PolicyControllerPolicyControllerHubState *policyControllerHubState;
 ...
 *    @arg @c kGTLRGKEHub_PolicyControllerMembershipState_State_Decomissioning
 *        The PC may have resources on the cluster, but the PCH wishes to remove
 *        the Membership. The Membership still exists. (Value: "DECOMISSIONING")
 ...
 *  Configuration for Policy Controller
 */
@interface GTLRGKEHub_PolicyControllerPolicyControllerHubConfig : GTLRObject
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRGKEHub_PolicyControllerPolicyControllerHubConfig_InstallSpec_InstallSpecDisabled
 *        Request to disable Policy Controller. If Policy Controller is not
 *        installed, it will be installed but disabled. (Value:
 *        "INSTALL_SPEC_DISABLED")
 *    @arg @c kGTLRGKEHub_PolicyControllerPolicyControllerHubConfig_InstallSpec_InstallSpecEnabled
 *        Request to install and enable Policy Controller. (Value:
 *        "INSTALL_SPEC_ENABLED")
 *    @arg @c kGTLRGKEHub_PolicyControllerPolicyControllerHubConfig_InstallSpec_InstallSpecNotInstalled
 *        Request to uninstall Policy Controller. (Value:
 *        "INSTALL_SPEC_NOT_INSTALLED")
 *    @arg @c kGTLRGKEHub_PolicyControllerPolicyControllerHubConfig_InstallSpec_InstallSpecUnspecified
 ...
 */
@property(nonatomic, strong, nullable) GTLRGKEHub_PolicyControllerTemplateLibraryConfig *templateLibraryConfig;
 ...
 */
@interface GTLRGKEHub_PolicyControllerPolicyControllerHubState : GTLRObject
 ...
 *  gatekeeper-mutation.
 */
@property(nonatomic, strong, nullable) GTLRGKEHub_PolicyControllerPolicyControllerHubState_DeploymentStates *deploymentStates;

/** The version of Gatekeeper Policy Controller deployed. */
@property(nonatomic, strong, nullable) GTLRGKEHub_PolicyControllerPolicyControllerHubVersion *version;
 ...
 *        fetch them all at once.
 */
@interface GTLRGKEHub_PolicyControllerPolicyControllerHubState_DeploymentStates : GTLRObject
@end
 ...
 */
@interface GTLRGKEHub_PolicyControllerPolicyControllerHubVersion : GTLRObject
 ...
 *  Uses NSNumber of boolValue.
 */
@property(nonatomic, strong, nullable) NSNumber *included;
