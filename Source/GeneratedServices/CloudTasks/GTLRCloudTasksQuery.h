...
@class GTLRCloudTasks_AcknowledgeTaskRequest;
 ...
 *    @c kGTLRAuthScopeCloudTasksCloudPlatform
 */
@interface GTLRCloudTasksQuery_ProjectsLocationsQueuesTasksAcknowledge : GTLRCloudTasksQuery
// Previous library name was
//   +[GTLQueryCloudTasks queryForProjectsLocationsQueuesTasksAcknowledgeWithObject:name:]
 ...
 *    @c kGTLRAuthScopeCloudTasksCloudPlatform
 */
@interface GTLRCloudTasksQuery_ProjectsLocationsQueuesTasksCancelLease : GTLRCloudTasksQuery
// Previous library name was
//   +[GTLQueryCloudTasks queryForProjectsLocationsQueuesTasksCancelLeaseWithObject:name:]
 ...
 *
 *  Method: cloudtasks.projects.locations.queues.tasks.renewLease
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeCloudTasksCloudPlatform
 */
@interface GTLRCloudTasksQuery_ProjectsLocationsQueuesTasksRenewLease : GTLRCloudTasksQuery
// Previous library name was
//   +[GTLQueryCloudTasks queryForProjectsLocationsQueuesTasksRenewLeaseWithObject:name:]
 ...
 *  returned in Task.schedule_time.
 *
 *  @param object The @c GTLRCloudTasks_RenewLeaseRequest to include in the
 *    query.
 *  @param name Required.
 *    The task name. For example:
 *    `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`
