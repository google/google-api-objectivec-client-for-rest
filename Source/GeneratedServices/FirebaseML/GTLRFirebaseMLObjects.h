 ...
 */
@interface GTLRFirebaseML_CancelOperationRequest : GTLRObject
@end
 ...
 *        enabled).
 */
@interface GTLRFirebaseML_ListOperationsResponse : GTLRCollectionObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRFirebaseML_Operation *> *operations;
