 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeArea120TablesDriveFile;
/**
...
/**
 *  Service for executing Area120 Tables API queries.
 */
@interface GTLRArea120TablesService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRArea120TablesQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
