 ...
 *
 *  Method: youtube.thirdPartyLink.delete
 */
@interface GTLRYouTubeQuery_ThirdPartyLinkDelete : GTLRYouTubeQuery
// Previous library name was
//   +[GTLQueryYouTube queryForThirdPartyLinkDeleteWithlinkingToken:type:]

/**
 *  The linkingToken parameter specifies the linking token for the link that is
 *  being deleted.
 */
@property(nonatomic, copy, nullable) NSString *linkingToken;

/**
 *  The type parameter specifies the third-party account link type for which all
 *  matching resources should be retrieved.
 *
 *  Likely values:
 *    @arg @c kGTLRYouTubeTypeChannelToStoreLink Link from a YouTube channel to
 *        a merchandise store. (Value: "channelToStoreLink")
 */
@property(nonatomic, copy, nullable) NSString *type;
 ...
 *  Deletes a third-party account link.
 *
 *  @param linkingToken The linkingToken parameter specifies the linking token
 *    for the link that is being deleted.
 *  @param type The type parameter specifies the third-party account link type
 *    for which all matching resources should be retrieved.
 *
 *  Likely values for @c type:
 *    @arg @c kGTLRYouTubeTypeChannelToStoreLink Link from a YouTube channel to
 *        a merchandise store. (Value: "channelToStoreLink")
 *
 *  @return GTLRYouTubeQuery_ThirdPartyLinkDelete
 */
 ...
 *
 *  Method: youtube.thirdPartyLink.insert
 */
@interface GTLRYouTubeQuery_ThirdPartyLinkInsert : GTLRYouTubeQuery
// Previous library name was
//   +[GTLQueryYouTube queryForThirdPartyLinkInsertWithObject:part:]
 ...
 *    properties that the API response will include.
 *
 *  @return GTLRYouTubeQuery_ThirdPartyLinkInsert
 */
...
/**
 *  Returns a collection of third-party account links that match the API request
 *  parameters. For example, you can retrieve all links that the authenticated
...
/**
 *  The linkingToken parameter specifies a unique linking token for the resource
 *  that is being retrieved. In a thirdPartyLink resource, the linking_token
...
/**
 *  The part parameter specifies a comma-separated list of one or more
 *  third-party account link resource properties that the API response will
 *  include.
 *  If the parameter identifies a property that contains child properties, the
 *  child properties will be included in the response. For example, in a
 *  thirdPartyLink resource, the snippet property contains properties like type,
 *  and link_content. As such, if you set part=snippet, the API response will
 ...
 *
 *  @param part The part parameter specifies a comma-separated list of one or
 *    more third-party account link resource properties that the API response
 *    will include.
 *    If the parameter identifies a property that contains child properties, the
 *    child properties will be included in the response. For example, in a
 *    thirdPartyLink resource, the snippet property contains properties like
 *    type, and link_content. As such, if you set part=snippet, the API response
...
/**
 *  Modifies a third-party account link. For example, you could change a
 *  third-party account link's type.
 *
 *  Method: youtube.thirdPartyLink.update
 */
@interface GTLRYouTubeQuery_ThirdPartyLinkUpdate : GTLRYouTubeQuery
// Previous library name was
//   +[GTLQueryYouTube queryForThirdPartyLinkUpdateWithObject:part:]
 ...
 *  Note that this method will override the existing values for mutable
 *  properties that are contained in any parts that the request body specifies.
 *  For example, a third-party account link's type is contained in the snippet
 *  part, which must be included in the request body. If the request does not
 *  specify a value for the snippet.type property, the third-party account
 *  link's existing type will be deleted.
 */
@property(nonatomic, copy, nullable) NSString *part;
 ...
 *    Note that this method will override the existing values for mutable
 *    properties that are contained in any parts that the request body
 *    specifies. For example, a third-party account link's type is contained in
 *    the snippet part, which must be included in the request body. If the
 *    request does not specify a value for the snippet.type property, the
 *    third-party account link's existing type will be deleted.
 *
 *  @return GTLRYouTubeQuery_ThirdPartyLinkUpdate
 */
+ (instancetype)queryWithObject:(GTLRYouTube_ThirdPartyLink *)object
                           part:(NSString *)part;
 ...
 *    API response.
 *  @param uploadParameters The media to include in this query. Maximum size
 *    128GB. Accepted MIME types: application/octet-stream, video/ *
 *
