 ...
 *    @arg @c kGTLRYouTubeTextFormatHtml Value "html"
 *    @arg @c kGTLRYouTubeTextFormatPlainText Value "plainText"
 *
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRYouTubeModerationStatusPublished Value "published"
 *    @arg @c kGTLRYouTubeModerationStatusHeldForReview Value "heldForReview"
 *    @arg @c kGTLRYouTubeModerationStatusLikelySpam Value "likelySpam"
 *    @arg @c kGTLRYouTubeModerationStatusRejected Value "rejected"
 */
 ...
 *    @arg @c kGTLRYouTubeOrderTime Value "time"
 *    @arg @c kGTLRYouTubeOrderRelevance Value "relevance"
 *
 *  @note If not set, the documented server-side default will be
 ...
 *    @arg @c kGTLRYouTubeBroadcastStatusAll Value "all"
 *    @arg @c kGTLRYouTubeBroadcastStatusActive Value "active"
 *    @arg @c kGTLRYouTubeBroadcastStatusUpcoming Value "upcoming"
 *    @arg @c kGTLRYouTubeBroadcastStatusCompleted Value "completed"
 */
 ...
 *    @arg @c kGTLRYouTubeBroadcastTypeAll Value "all"
 *    @arg @c kGTLRYouTubeBroadcastTypeEvent Value "event"
 *    @arg @c kGTLRYouTubeBroadcastTypePersistent Value "persistent"
 *
 *  @note If not set, the documented server-side default will be
 ...
 *        "statusUnspecified"
 *    @arg @c kGTLRYouTubeBroadcastStatusTesting Value "testing"
 *    @arg @c kGTLRYouTubeBroadcastStatusLive Value "live"
 *    @arg @c kGTLRYouTubeBroadcastStatusComplete Value "complete"
 */
@property(nonatomic, copy, nullable) NSString *broadcastStatus;
 ...
 *    @arg @c kGTLRYouTubeModeUpdates Value "updates"
 *    @arg @c kGTLRYouTubeModeAllCurrent Value "all_current"
 *
 *  @note If not set, the documented server-side default will be
 ...
 *    @arg @c kGTLRYouTubeChannelTypeAny Value "any"
 *    @arg @c kGTLRYouTubeChannelTypeShow Value "show"
 */
 ...
 *    @arg @c kGTLRYouTubeEventTypeUpcoming Value "upcoming"
 *    @arg @c kGTLRYouTubeEventTypeLive Value "live"
 *    @arg @c kGTLRYouTubeEventTypeCompleted Value "completed"
 */
 ...
 *    @arg @c kGTLRYouTubeOrderDate Value "date"
 *    @arg @c kGTLRYouTubeOrderRating Value "rating"
 *    @arg @c kGTLRYouTubeOrderViewCount Value "viewCount"
 *    @arg @c kGTLRYouTubeOrderRelevance Value "relevance"
 *    @arg @c kGTLRYouTubeOrderTitle Value "title"
 *    @arg @c kGTLRYouTubeOrderVideoCount Value "videoCount"
 *
 *  @note If not set, the documented server-side default will be
 ...
 *    @arg @c kGTLRYouTubeSafeSearchNone Value "none"
 *    @arg @c kGTLRYouTubeSafeSearchModerate Value "moderate"
 *    @arg @c kGTLRYouTubeSafeSearchStrict Value "strict"
 *
 *  @note If not set, the documented server-side default will be
 ...
 *    @arg @c kGTLRYouTubeVideoCaptionAny Value "any"
 *    @arg @c kGTLRYouTubeVideoCaptionClosedCaption Value "closedCaption"
 *    @arg @c kGTLRYouTubeVideoCaptionNone Value "none"
 */
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRYouTubeVideoDefinitionAny Value "any"
 *    @arg @c kGTLRYouTubeVideoDefinitionStandard Value "standard"
 *    @arg @c kGTLRYouTubeVideoDefinitionHigh Value "high"
 */
 ...
 *    @arg @c kGTLRYouTubeVideoDimensionX2d 2d (Value: "2d")
 *    @arg @c kGTLRYouTubeVideoDimensionX3d 3d (Value: "3d")
 */
 ...
 *    @arg @c kGTLRYouTubeVideoDurationAny Value "any"
 *    @arg @c kGTLRYouTubeVideoDurationShort Value "short"
 *    @arg @c kGTLRYouTubeVideoDurationMedium Value "medium"
 *    @arg @c kGTLRYouTubeVideoDurationLong Value "long"
 */
 ...
 *    @arg @c kGTLRYouTubeVideoEmbeddableAny Value "any"
 *    @arg @c kGTLRYouTubeVideoEmbeddableTrue Value "true"
 */
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRYouTubeVideoLicenseAny Value "any"
 *    @arg @c kGTLRYouTubeVideoLicenseYoutube Value "youtube"
 *    @arg @c kGTLRYouTubeVideoLicenseCreativeCommon Value "creativeCommon"
 */
 ...
 *    @arg @c kGTLRYouTubeVideoSyndicatedAny Value "any"
 *    @arg @c kGTLRYouTubeVideoSyndicatedTrue Value "true"
 */
 ...
 *    @arg @c kGTLRYouTubeVideoTypeAny Value "any"
 *    @arg @c kGTLRYouTubeVideoTypeMovie Value "movie"
 *    @arg @c kGTLRYouTubeVideoTypeEpisode Value "episode"
 */
 ...
 *    @arg @c kGTLRYouTubeFilterNewest Value "newest"
 *    @arg @c kGTLRYouTubeFilterAll Value "all"
 *
 *  @note If not set, the documented server-side default will be
 ...
 *    @arg @c kGTLRYouTubeOrderRelevance Value "relevance"
 *    @arg @c kGTLRYouTubeOrderUnread Value "unread"
 *    @arg @c kGTLRYouTubeOrderAlphabetical Value "alphabetical"
 *
 *  @note If not set, the documented server-side default will be
 *        kGTLRYouTubeOrderRelevance.
 */
 ...
 *    @arg @c kGTLRYouTubeChartMostPopular Value "mostPopular"
 */
 ...
 *    @arg @c kGTLRYouTubeMyRatingLike Value "like"
 *    @arg @c kGTLRYouTubeMyRatingDislike Value "dislike"
 */
 ...
 *    @arg @c kGTLRYouTubeRatingLike Value "like"
 *    @arg @c kGTLRYouTubeRatingDislike Value "dislike"
 */
