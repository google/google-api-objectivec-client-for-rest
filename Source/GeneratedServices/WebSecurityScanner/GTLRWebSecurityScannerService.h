 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeWebSecurityScannerCloudPlatform;
...
// GTLRWebSecurityScannerQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
