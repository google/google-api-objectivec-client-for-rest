 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeNetworkconnectivityCloudPlatform;
...
// GTLRNetworkconnectivityQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
