...
@class GTLRCloudDeploy_ApproveRolloutRequest;
@class GTLRCloudDeploy_CancelOperationRequest;
@class GTLRCloudDeploy_DeliveryPipeline;
@class GTLRCloudDeploy_Release;
@class GTLRCloudDeploy_Rollout;
@class GTLRCloudDeploy_SetIamPolicyRequest;
@class GTLRCloudDeploy_Target;
@class GTLRCloudDeploy_TestIamPermissionsRequest;
