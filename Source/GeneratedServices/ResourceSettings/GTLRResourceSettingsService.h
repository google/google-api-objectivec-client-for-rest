 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeResourceSettingsCloudPlatform;
...
/**
 *  Service for executing Resource Settings API queries.
 *
 ...
 *  Resource Hierarchy.
 */
@interface GTLRResourceSettingsService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRResourceSettingsQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
