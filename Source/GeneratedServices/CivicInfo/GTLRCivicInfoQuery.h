...
@class GTLRCivicInfo_DivisionRepresentativeInfoRequest;
@class GTLRCivicInfo_DivisionSearchRequest;
@class GTLRCivicInfo_ElectionsQueryRequest;
...
//   +[GTLQueryCivicInfo queryForDivisionsSearchWithObject:]
...
// Previous library name was
//   +[GTLQueryCivicInfo queryForElectionsElectionQueryWithObject:]
...
// Previous library name was
//   +[GTLQueryCivicInfo queryForElectionsVoterInfoQueryWithObject:address:]
...
// Previous library name was
//   +[GTLQueryCivicInfo queryForRepresentativesRepresentativeInfoByAddressWithObject:]
...
// Previous library name was
//   +[GTLQueryCivicInfo queryForRepresentativesRepresentativeInfoByDivisionWithObject:ocdId:]
 ...
 *  Looks up representative information for a single geographic division.
 *
 *  @param object The @c GTLRCivicInfo_DivisionRepresentativeInfoRequest to
