...
@class GTLRStorage_BucketEncryption;
 ...
 */
@property(nonatomic, strong, nullable) GTLRStorage_BucketEncryption *encryption;
 ...
 *  encryption config is specified.
 */
@interface GTLRStorage_BucketEncryption : GTLRObject
