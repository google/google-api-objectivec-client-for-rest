...
@class GTLRCloudBuild_AddBitbucketServerConnectedRepositoryRequest;
 ...
 *
 *  Method: cloudbuild.projects.locations.bitbucketServerConfigs.addBitbucketServerConnectedRepository
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeCloudBuildCloudPlatform
 */
@interface GTLRCloudBuildQuery_ProjectsLocationsBitbucketServerConfigsAddBitbucketServerConnectedRepository : GTLRCloudBuildQuery
...
/**
 *  Fetches a @c GTLRCloudBuild_AddBitbucketServerConnectedRepositoryResponse.
 *
 *  Add a Bitbucket Server repository to a given BitbucketServerConfig's
 *  connected repositories. This API is experimental.
 *
 *  @param object The @c
 *    GTLRCloudBuild_AddBitbucketServerConnectedRepositoryRequest to include in
 *    the query.
 *  @param config Required. The name of the `BitbucketServerConfig` to add a
 *    connected repository. Format:
 *    `projects/{project}/locations/{location}/bitbucketServerConfigs/{config}`
 *
 *  @return GTLRCloudBuildQuery_ProjectsLocationsBitbucketServerConfigsAddBitbucketServerConnectedRepository
 */
