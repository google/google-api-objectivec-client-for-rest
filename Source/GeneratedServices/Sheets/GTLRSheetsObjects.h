 ...
 *  foreground color will be set to the default link color and the text will be
 *  underlined. If these fields are modified in the same request, those values
 *  will be used instead of the link defaults.
 */
