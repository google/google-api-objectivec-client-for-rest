 ...
 *  @param userId Aggregate data for the person identified. Use <code>me</code>
 *    to indicate
 *    the authenticated user. Only <code>me</code> is supported at this time.
 *
 ...
 *  @param userId Create the data source for the person identified. Use
 *    <code>me</code> to
 *    indicate the authenticated user. Only <code>me</code> is supported at this
 *    time.
 *
 ...
 *  Queries for user's data point changes for a particular data source.
 *
 *  @param userId List data points for the person identified. Use
 *    <code>me</code> to indicate
 *    the authenticated user. Only <code>me</code> is supported at this time.
 ...
 *  point will be deleted.
 *
 *  @param userId Delete a dataset for the person identified. Use
 *    <code>me</code> to indicate
 *    the authenticated user. Only <code>me</code> is supported at this time.
 *  @param dataSourceId The data stream ID of the data source that created the
 *    dataset.
 ...
 *  equal to the dataset start time.
 *
 *  @param userId Retrieve a dataset for the person identified. Use
 *    <code>me</code> to
 *    indicate the authenticated user. Only <code>me</code> is supported at this
 *    time.
 *  @param dataSourceId The data stream ID of the data source that created the
 ...
 *  @param userId Patch a dataset for the person identified. Use <code>me</code>
 *    to indicate
 *    the authenticated user. Only <code>me</code> is supported at this time.
 *  @param dataSourceId The data stream ID of the data source that created the
 *    dataset.
 ...
 *  source contains any data points.
 *
 *  @param userId Retrieve a data source for the person identified. Use
 *    <code>me</code> to
 *    indicate the authenticated user. Only <code>me</code> is supported at this
 *    time.
 ...
 *  other scopes.
 *
 *  @param userId List data sources for the person identified. Use
 *    <code>me</code> to
 *    indicate the authenticated user. Only <code>me</code> is supported at this
 *    time.
 *
 ...
 *
 *  @param object The @c GTLRFitness_DataSource to include in the query.
 *  @param userId Update the data source for the person identified. Use
 *    <code>me</code> to
 *    indicate the authenticated user. Only <code>me</code> is supported at this
 *    time.
 ...
 *  Deletes a session specified by the given session ID.
 *
 *  @param userId Delete a session for the person identified. Use
 *    <code>me</code> to indicate
 *    the authenticated user. Only <code>me</code> is supported at this time.
 ...
 *  Lists sessions previously created.
 *
 *  @param userId List sessions for the person identified. Use <code>me</code>
 *    to indicate
 *    the authenticated user. Only <code>me</code> is supported at this time.
 *
 ...
 *  @param userId Create sessions for the person identified. Use <code>me</code>
 *    to indicate
 *    the authenticated user. Only <code>me</code> is supported at this time.
