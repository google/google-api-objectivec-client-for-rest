...
@property(strong, nullable) NSArray<GTLRMirror_AuthToken *> *authTokens;
@property(strong, nullable) NSArray<NSString *> *features;
@property(copy, nullable) NSString *password;
@property(strong, nullable) NSArray<GTLRMirror_UserData *> *userData;
...
@property(copy, nullable) NSString *contentUrl;
 ...
 */
@property(strong, nullable) NSNumber *isProcessingContent;
 ...
 */
@property(strong, nullable) NSArray<GTLRMirror_Attachment *> *items;
...
@property(copy, nullable) NSString *authToken;
 ...
 *  command.
 */
@property(strong, nullable) NSArray<GTLRMirror_Command *> *acceptCommands;
 ...
 *  shown for all items.
 */
@property(strong, nullable) NSArray<NSString *> *acceptTypes;
 ...
 */
@property(strong, nullable) NSArray<NSString *> *imageUrls;
 ...
 *  - ADD_CAPTION
 */
@property(strong, nullable) NSArray<NSString *> *sharingFeatures;
 ...
 *  phonetic.
 */
@property(copy, nullable) NSString *speakableName;
 ...
 *        subscripting on this class.
 */
@property(strong, nullable) NSArray<GTLRMirror_Contact *> *items;
 ...
 */
@property(strong, nullable) NSNumber *accuracy;
 ...
 *        subscripting on this class.
 */
@property(strong, nullable) NSArray<GTLRMirror_Location *> *items;
 ...
 */
@property(copy, nullable) NSString *contextualCommand;
 ...
 */
@property(copy, nullable) NSString *payload;
 ...
 *  Uses NSNumber of boolValue.
 */
@property(strong, nullable) NSNumber *removeWhenSelected;
 ...
 */
@property(strong, nullable) NSArray<GTLRMirror_MenuValue *> *values;
...
@property(strong, nullable) NSArray<GTLRMirror_UserAction *> *userActions;
 ...
 *  notifications.
 */
@property(copy, nullable) NSString *verifyToken;
...
@property(strong, nullable) GTLRDateTime *deliveryTime;
 ...
 */
@property(strong, nullable) GTLRMirror_Notification *notification;
 ...
 */
@property(strong, nullable) NSArray<NSString *> *operation;
 ...
 *        subscripting on this class.
 */
@property(strong, nullable) NSArray<GTLRMirror_Subscription *> *items;
 ...
 *  attachment.
 */
@property(strong, nullable) NSArray<GTLRMirror_Attachment *> *attachments;
 ...
 */
@property(copy, nullable) NSString *canonicalUrl;
...
@property(strong, nullable) GTLRMirror_Contact *creator;
 ...
 */
@property(strong, nullable) GTLRDateTime *displayTime;
 ...
 */
@property(copy, nullable) NSString *inReplyTo;
 ...
 *  Uses NSNumber of boolValue.
 */
@property(strong, nullable) NSNumber *isBundleCover;
 ...
 *  Uses NSNumber of boolValue.
 */
@property(strong, nullable) NSNumber *isDeleted;
 ...
 */
@property(strong, nullable) NSNumber *pinScore;

/** A list of users or groups that this item has been shared with. */
@property(strong, nullable) NSArray<GTLRMirror_Contact *> *recipients;
 ...
 *  notification.
 */
@property(copy, nullable) NSString *speakableText;
 ...
 */
@property(copy, nullable) NSString *speakableType;
 ...
 *        subscripting on this class.
 */
@property(strong, nullable) NSArray<GTLRMirror_TimelineItem *> *items;
