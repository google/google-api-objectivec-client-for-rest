 ...
 *
 *  @returns GTLRServiceUsageQuery_OperationsCancel
 */
 ...
 *
 *  @returns GTLRServiceUsageQuery_OperationsDelete
 */
...
/**
 *  Fetches a @c GTLRServiceUsage_ServiceState.
 *
 *  Returns the service definition and EnabledState for a given service.
 *
 ...
 *
 *  Method: serviceusage.services.listEnabled
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeServiceUsageCloudPlatform
 *    @c kGTLRAuthScopeServiceUsageCloudPlatformReadOnly
 */
@interface GTLRServiceUsageQuery_ServicesListEnabled : GTLRServiceUsageQuery
// Previous library name was
//   +[GTLQueryServiceUsage queryForServicesListEnabledWithparent:]
...
/**
 *  Fetches a @c GTLRServiceUsage_ListEnabledServicesResponse.
 *
 *  List enabled services.
 *
 ...
 *    projects/123
 *
 *  @returns GTLRServiceUsageQuery_ServicesListEnabled
 *
 *  @note Automatic pagination will be done when @c shouldFetchNextPages is
 *        enabled. See @c shouldFetchNextPages on @c GTLRService for more
 *        information.
 ...
 *
 *  Method: serviceusage.services.search
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeServiceUsageCloudPlatform
 *    @c kGTLRAuthScopeServiceUsageCloudPlatformReadOnly
 */
@interface GTLRServiceUsageQuery_ServicesSearch : GTLRServiceUsageQuery
// Previous library name was
//   +[GTLQueryServiceUsage queryForServicesSearch]
...
/**
 *  Fetches a @c GTLRServiceUsage_SearchServicesResponse.
 *
 *  Search available services.
 *  When no filter is specified, returns all accessible services. This includes
 *  public services and services for which the calling user has the
 *  "servicemanagement.services.bind" permission.
 *
 *  @returns GTLRServiceUsageQuery_ServicesSearch
 *
 *  @note Automatic pagination will be done when @c shouldFetchNextPages is
 *        enabled. See @c shouldFetchNextPages on @c GTLRService for more
 *        information.
