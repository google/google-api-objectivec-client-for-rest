...
@class GTLRServiceUsage_Visibility;
@class GTLRServiceUsage_VisibilityRule;
...
@property(nonatomic, strong, nullable) GTLRServiceUsage_Visibility *visibility;
 ...
 */
@interface GTLRServiceUsage_Visibility : GTLRObject

/**
 *  A list of visibility rules that apply to individual API elements.
 *  **NOTE:** All service configuration rules follow "last one wins" order.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRServiceUsage_VisibilityRule *> *rules;
 ...
 *  element.
 */
@interface GTLRServiceUsage_VisibilityRule : GTLRObject
