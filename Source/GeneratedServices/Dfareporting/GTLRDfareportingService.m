...
+ (NSDictionary<NSString *, Class> *)kindStringToClassMap {
  return @{
    ...
    @"dfareporting#channelGrouping" : [GTLRDfareporting_ChannelGrouping class],
    @"dfareporting#channelGroupingRule" : [GTLRDfareporting_ChannelGroupingRule class],
    ...
    @"dfareporting#customVariable" : [GTLRDfareporting_CustomVariable class],
    ...
    @"dfareporting#disjunctiveMatchStatement" : [GTLRDfareporting_DisjunctiveMatchStatement class],
    ...
    @"dfareporting#eventFilter" : [GTLRDfareporting_EventFilter class],
    ...
    @"dfaReporting#pathFilter" : [GTLRDfareporting_PathFilter class],
    @"dfareporting#pathReportCompatibleFields" : [GTLRDfareporting_PathReportCompatibleFields class],
    @"dfareporting#pathReportDimensionValue" : [GTLRDfareporting_PathReportDimensionValue class],
