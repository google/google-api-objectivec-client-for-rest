...
+ (NSDictionary<NSString *, Class> *)kindStringToClassMap {
  return @{
    ...
    @"androidenterprise#collection" : [GTLRAndroidEnterprise_Collection class],
    @"androidenterprise#collectionsListResponse" : [GTLRAndroidEnterprise_CollectionsListResponse class],
    @"androidenterprise#collectionViewersListResponse" : [GTLRAndroidEnterprise_CollectionViewersListResponse class],
