...
/**
 *  Service for executing Organization Policy API queries.
 *
 *  The Org Policy API allows users to configure governance ruleson their GCP
 *  resources across the Cloud Resource Hierarchy.
 */
@interface GTLROrgPolicyAPIService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLROrgPolicyAPIQuery.h. The query can the be sent with GTLRService's execute
// methods,
//
