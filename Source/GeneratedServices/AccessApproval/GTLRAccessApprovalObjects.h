 ...
 *  Spanner * Cloud SQL * Cloud Storage * Google Kubernetes Engine * Persistent
 *  Disk Note: These values are supported as input for legacy purposes, but will
 *  not be returned from the API. * all * appengine.googleapis.com *
 ...
 *  supported at both 'GA' and 'Preview' levels. More information about levels
 *  of support is available at
