...
@class GTLRIdeahub_GoogleSearchIdeahubV1alphaIdeaActivity;
...
/**
 *  Fetches a @c GTLRIdeahub_GoogleSearchIdeahubV1alphaIdeaActivity.
 *
 *  Creates an idea activity entry.
 *
 *  @param object The @c GTLRIdeahub_GoogleSearchIdeahubV1alphaIdeaActivity to
