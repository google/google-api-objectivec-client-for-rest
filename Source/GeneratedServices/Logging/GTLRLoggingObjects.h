...
@class GTLRLogging_TableFieldSchema;
@class GTLRLogging_TableSchema;
 ...
 *  buckets.
 */
@property(nonatomic, strong, nullable) GTLRLogging_TableSchema *schema;
...
/**
 *  A field in TableSchema. The fields describe the static fields in the
 ...
 *  field.
 */
@interface GTLRLogging_TableFieldSchema : GTLRObject
 ...
 *  RECORD.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRLogging_TableFieldSchema *> *fields;
 ...
 *  INT64) FLOAT (or FLOAT64) BOOLEAN (or BOOL) TIMESTAMP RECORD (or STRUCT)Use
 *  of RECORD/STRUT indicates that the field contains a nested schema.
 */
@property(nonatomic, copy, nullable) NSString *type;
 ...
 */
@interface GTLRLogging_TableSchema : GTLRObject
