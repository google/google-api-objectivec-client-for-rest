...
@implementation GTLRCloudRunQuery_ApiV1NamespacesGet

@dynamic name;

+ (instancetype)queryWithName:(NSString *)name {
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"api/v1/{+name}";
  GTLRCloudRunQuery_ApiV1NamespacesGet *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:nil
                       pathParameterNames:pathParams];
  query.name = name;
  query.expectedObjectClass = [GTLRCloudRun_Namespace class];
  query.loggingName = @"run.api.v1.namespaces.get";
  return query;
}

@end

@implementation GTLRCloudRunQuery_ApiV1NamespacesPatch
...
+ (instancetype)queryWithObject:(GTLRCloudRun_Namespace *)object
  ...
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"api/v1/{+name}";
  GTLRCloudRunQuery_ApiV1NamespacesPatch *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"PATCH"
                       pathParameterNames:pathParams];
  ...
  query.name = name;
  query.expectedObjectClass = [GTLRCloudRun_Namespace class];
  query.loggingName = @"run.api.v1.namespaces.patch";
  return query;
}

@end

@implementation GTLRCloudRunQuery_ApiV1NamespacesSecretsCreate
...
+ (instancetype)queryWithObject:(GTLRCloudRun_Secret *)object
  ...
  NSString *pathURITemplate = @"api/v1/{+parent}/secrets";
  GTLRCloudRunQuery_ApiV1NamespacesSecretsCreate *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"POST"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  query.parent = parent;
  query.expectedObjectClass = [GTLRCloudRun_Secret class];
  query.loggingName = @"run.api.v1.namespaces.secrets.create";
  return query;
}

@end

@implementation GTLRCloudRunQuery_ApiV1NamespacesSecretsGet
...
+ (instancetype)queryWithName:(NSString *)name {
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"api/v1/{+name}";
  GTLRCloudRunQuery_ApiV1NamespacesSecretsGet *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:nil
                       pathParameterNames:pathParams];
  query.name = name;
  query.expectedObjectClass = [GTLRCloudRun_Secret class];
  query.loggingName = @"run.api.v1.namespaces.secrets.get";
  return query;
}

@end

@implementation GTLRCloudRunQuery_ApiV1NamespacesSecretsReplaceSecret
...
+ (instancetype)queryWithObject:(GTLRCloudRun_Secret *)object
  ...
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"api/v1/{+name}";
  GTLRCloudRunQuery_ApiV1NamespacesSecretsReplaceSecret *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"PUT"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  query.name = name;
  query.expectedObjectClass = [GTLRCloudRun_Secret class];
  query.loggingName = @"run.api.v1.namespaces.secrets.replaceSecret";
  return query;
}
...
@implementation GTLRCloudRunQuery_ProjectsLocationsNamespacesGet
...
+ (instancetype)queryWithName:(NSString *)name {
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"v1/{+name}";
  GTLRCloudRunQuery_ProjectsLocationsNamespacesGet *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:nil
                       pathParameterNames:pathParams];
  query.name = name;
  query.expectedObjectClass = [GTLRCloudRun_Namespace class];
  query.loggingName = @"run.projects.locations.namespaces.get";
  return query;
}

@end

@implementation GTLRCloudRunQuery_ProjectsLocationsNamespacesPatch
...
+ (instancetype)queryWithObject:(GTLRCloudRun_Namespace *)object
  ...
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"v1/{+name}";
  GTLRCloudRunQuery_ProjectsLocationsNamespacesPatch *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"PATCH"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  query.name = name;
  query.expectedObjectClass = [GTLRCloudRun_Namespace class];
  query.loggingName = @"run.projects.locations.namespaces.patch";
  return query;
}
...
@implementation GTLRCloudRunQuery_ProjectsLocationsSecretsCreate
...
+ (instancetype)queryWithObject:(GTLRCloudRun_Secret *)object
  ...
  GTLRCloudRunQuery_ProjectsLocationsSecretsCreate *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"POST"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  query.parent = parent;
  query.expectedObjectClass = [GTLRCloudRun_Secret class];
  query.loggingName = @"run.projects.locations.secrets.create";
  return query;
}

@end

@implementation GTLRCloudRunQuery_ProjectsLocationsSecretsGet
...
+ (instancetype)queryWithName:(NSString *)name {
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"v1/{+name}";
  GTLRCloudRunQuery_ProjectsLocationsSecretsGet *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:nil
                       pathParameterNames:pathParams];
  query.name = name;
  query.expectedObjectClass = [GTLRCloudRun_Secret class];
  query.loggingName = @"run.projects.locations.secrets.get";
  return query;
}

@end

@implementation GTLRCloudRunQuery_ProjectsLocationsSecretsReplaceSecret
...
+ (instancetype)queryWithObject:(GTLRCloudRun_Secret *)object
  ...
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"v1/{+name}";
  GTLRCloudRunQuery_ProjectsLocationsSecretsReplaceSecret *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"PUT"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  query.name = name;
  query.expectedObjectClass = [GTLRCloudRun_Secret class];
  query.loggingName = @"run.projects.locations.secrets.replaceSecret";
  return query;
}
