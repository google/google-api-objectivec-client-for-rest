...
@class GTLRAlertCenter_GoogleAppsAlertcenterV1beta1BatchDeleteAlertsRequest;
@class GTLRAlertCenter_GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsRequest;
@class GTLRAlertCenter_GoogleAppsAlertcenterV1beta1Settings;
@class GTLRAlertCenter_GoogleAppsAlertcenterV1beta1UndeleteAlertRequest;
 ...
 *
 *  @param object The @c
 *    GTLRAlertCenter_GoogleAppsAlertcenterV1beta1BatchDeleteAlertsRequest to
 ...
 *
 *  @param object The @c
 *    GTLRAlertCenter_GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsRequest to
 *    include in the query.
 *
...
/**
 *  Fetches a @c GTLRAlertCenter_GoogleProtobufEmpty.
 *
 *  Marks the specified alert for deletion. An alert that has been marked for
 *  deletion is removed from Alert Center after 30 days. Marking an alert for
 *  deletion has no effect on an alert which has already been marked for
...
/**
 *  Fetches a @c GTLRAlertCenter_GoogleAppsAlertcenterV1beta1AlertFeedback.
 *
 *  Creates new feedback for an alert. Attempting to create a feedback for a
 *  non-existent alert returns `NOT_FOUND` error. Attempting to create a
 *  feedback for an alert that is marked for deletion returns
 ...
 *
 *  @param object The @c
 *    GTLRAlertCenter_GoogleAppsAlertcenterV1beta1AlertFeedback to include in
 *    the query.
...
/**
 *  Fetches a @c GTLRAlertCenter_GoogleAppsAlertcenterV1beta1Alert.
 *
 *  Gets the specified alert. Attempting to get a nonexistent alert returns
 *  `NOT_FOUND` error.
 *
...
/**
 *  Fetches a @c GTLRAlertCenter_GoogleAppsAlertcenterV1beta1AlertMetadata.
 *
 *  Returns the metadata of an alert. Attempting to get metadata for a
 *  non-existent alert returns `NOT_FOUND` error.
 *
...
/**
 *  Fetches a @c GTLRAlertCenter_GoogleAppsAlertcenterV1beta1ListAlertsResponse.
 *
 *  Lists the alerts.
 *
 ...
 *
 *  @param object The @c
 *    GTLRAlertCenter_GoogleAppsAlertcenterV1beta1UndeleteAlertRequest to
 *    include in the query.
...
/**
 *  Fetches a @c GTLRAlertCenter_GoogleAppsAlertcenterV1beta1Settings.
 *
 *  Returns customer-level settings.
 *
 ...
 *  Updates the customer-level settings.
 *
 *  @param object The @c GTLRAlertCenter_GoogleAppsAlertcenterV1beta1Settings to
 *    include in the query.
 *
