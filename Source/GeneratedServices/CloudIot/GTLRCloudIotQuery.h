...
/** Value: "GATEWAY" */
GTLR_EXTERN NSString * const kGTLRCloudIotGatewayTypeGateway;
/** Value: "GATEWAY_TYPE_UNSPECIFIED" */
GTLR_EXTERN NSString * const kGTLRCloudIotGatewayTypeGatewayTypeUnspecified;
/** Value: "NON_GATEWAY" */
GTLR_EXTERN NSString * const kGTLRCloudIotGatewayTypeNonGateway;
 ...
 *
 *  Method: cloudiot.projects.locations.groups.devices.list
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeCloudIot
 *    @c kGTLRAuthScopeCloudIotCloudPlatform
 */
@interface GTLRCloudIotQuery_ProjectsLocationsGroupsDevicesList : GTLRCloudIotQuery
// Previous library name was
//   +[GTLQueryCloudIot queryForProjectsLocationsGroupsDevicesListWithparent:]
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRCloudIotGatewayTypeGatewayTypeUnspecified Value
 *        "GATEWAY_TYPE_UNSPECIFIED"
 *    @arg @c kGTLRCloudIotGatewayTypeGateway Value "GATEWAY"
 *    @arg @c kGTLRCloudIotGatewayTypeNonGateway Value "NON_GATEWAY"
 */
 ...
 *  Deletes a device.
 *
 *  Method: cloudiot.projects.locations.registries.groups.devices.delete
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeCloudIot
 *    @c kGTLRAuthScopeCloudIotCloudPlatform
 */
@interface GTLRCloudIotQuery_ProjectsLocationsRegistriesGroupsDevicesDelete : GTLRCloudIotQuery
// Previous library name was
//   +[GTLQueryCloudIot queryForProjectsLocationsRegistriesGroupsDevicesDeleteWithname:]
