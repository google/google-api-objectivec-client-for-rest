...
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1CreateAnnotationSpecSetRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1CreateDatasetRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1CreateEvaluationJobRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1CreateInstructionRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1EvaluationJob;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1ExportDataRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1FeedbackMessage;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1ImportDataRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1LabelImageRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1LabelTextRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1LabelVideoRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1PauseEvaluationJobRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1ResumeEvaluationJobRequest;
@class GTLRDataLabeling_GoogleCloudDatalabelingV1beta1SearchExampleComparisonsRequest;
