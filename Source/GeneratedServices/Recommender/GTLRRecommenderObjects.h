...
@class GTLRRecommender_GoogleCloudRecommenderV1beta1Insight;
@class GTLRRecommender_GoogleCloudRecommenderV1beta1Insight_Content;
@class GTLRRecommender_GoogleCloudRecommenderV1beta1InsightRecommendationReference;
@class GTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo;
@class GTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo_StateMetadata;
@class GTLRRecommender_GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest_StateMetadata;
...
@class GTLRRecommender_GoogleCloudRecommenderV1beta1RecommendationInsightReference;
 ...
 */
@interface GTLRRecommender_GoogleCloudRecommenderV1beta1Insight : GTLRObject

/** Recommendations derived from this insight. */
@property(nonatomic, strong, nullable) NSArray<GTLRRecommender_GoogleCloudRecommenderV1beta1InsightRecommendationReference *> *associatedRecommendations;

/**
 *  Category being targeted by the insight.
 *
 *  Likely values:
 *    @arg @c kGTLRRecommender_GoogleCloudRecommenderV1beta1Insight_Category_CategoryUnspecified
 *        Unspecified category. (Value: "CATEGORY_UNSPECIFIED")
 *    @arg @c kGTLRRecommender_GoogleCloudRecommenderV1beta1Insight_Category_Cost
 *        The insight is related to cost. (Value: "COST")
 *    @arg @c kGTLRRecommender_GoogleCloudRecommenderV1beta1Insight_Category_Manageability
 *        This insight is related to manageability. (Value: "MANAGEABILITY")
 *    @arg @c kGTLRRecommender_GoogleCloudRecommenderV1beta1Insight_Category_Performance
 *        The insight is related to performance. (Value: "PERFORMANCE")
 *    @arg @c kGTLRRecommender_GoogleCloudRecommenderV1beta1Insight_Category_Security
 ...
 */
@property(nonatomic, strong, nullable) GTLRRecommender_GoogleCloudRecommenderV1beta1Insight_Content *content;
...
@property(nonatomic, strong, nullable) GTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo *stateInfo;
 ...
 */
@interface GTLRRecommender_GoogleCloudRecommenderV1beta1Insight_Content : GTLRObject
@end
 ...
 */
@interface GTLRRecommender_GoogleCloudRecommenderV1beta1InsightRecommendationReference : GTLRObject
 ...
 */
@interface GTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo : GTLRObject

/**
 *  Insight state.
 *
 *  Likely values:
 *    @arg @c kGTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo_State_Accepted
 *        Some action has been taken based on this insight. Insights become
 ...
 *    @arg @c kGTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo_State_Active
 ...
 *    @arg @c kGTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo_State_Dismissed
 *        Insight is dismissed. Content for DISMISSED insights can be updated by
 *        Google. DISMISSED insights can be marked as ACTIVE. (Value:
 *        "DISMISSED")
 *    @arg @c kGTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo_State_StateUnspecified
 ...
 */
@property(nonatomic, strong, nullable) GTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo_StateMetadata *stateMetadata;
 ...
 */
@interface GTLRRecommender_GoogleCloudRecommenderV1beta1InsightStateInfo_StateMetadata : GTLRObject
@end
 ...
 *        enabled).
 */
@interface GTLRRecommender_GoogleCloudRecommenderV1beta1ListInsightsResponse : GTLRCollectionObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRRecommender_GoogleCloudRecommenderV1beta1Insight *> *insights;
 ...
 */
@interface GTLRRecommender_GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) GTLRRecommender_GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest_StateMetadata *stateMetadata;
 ...
 *        fetch them all at once.
 */
@interface GTLRRecommender_GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest_StateMetadata : GTLRObject
@end
...
@property(nonatomic, strong, nullable) NSArray<GTLRRecommender_GoogleCloudRecommenderV1beta1RecommendationInsightReference *> *associatedInsights;
 ...
 */
@interface GTLRRecommender_GoogleCloudRecommenderV1beta1RecommendationInsightReference : GTLRObject
