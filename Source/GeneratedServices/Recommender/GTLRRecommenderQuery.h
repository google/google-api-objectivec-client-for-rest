...
@class GTLRRecommender_GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest;
...
/**
 *  Fetches a @c GTLRRecommender_GoogleCloudRecommenderV1beta1Insight.
 *
 *  Gets the requested insight. Requires the recommender.*.get IAM permission
 *  for the specified insight type.
 *
 ...
 *
 *  @param object The @c
 *    GTLRRecommender_GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest to
