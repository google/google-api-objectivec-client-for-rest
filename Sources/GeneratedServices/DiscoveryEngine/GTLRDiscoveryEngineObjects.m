...
@dynamic boostSpec, branch, contentSearchSpec, embeddingSpec, facetSpecs,
         filter, imageQuery, offset, orderBy, pageSize, pageToken, params,
         query, queryExpansionSpec, rankingExpression, safeSearch,
