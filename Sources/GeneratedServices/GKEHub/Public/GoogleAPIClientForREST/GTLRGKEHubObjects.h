...
@class GTLRGKEHub_AnthosVMMembershipSpec;
@class GTLRGKEHub_AnthosVMMembershipState;
@class GTLRGKEHub_AnthosVMSubFeatureSpec;
...
@class GTLRGKEHub_LocalControllerState;
...
@class GTLRGKEHub_MigrateSpec;
@class GTLRGKEHub_MigrateState;
 ...
 *  installation failed
 *
 *  Value: "INSTALLATION_STATE_FAILED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_AnthosVMSubFeatureState_InstallationState_InstallationStateFailed;
/**
 *  component is successfully installed
 *
 *  Value: "INSTALLATION_STATE_INSTALLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_AnthosVMSubFeatureState_InstallationState_InstallationStateInstalled;
/**
 *  component is not installed
 *
 *  Value: "INSTALLATION_STATE_NOT_INSTALLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_AnthosVMSubFeatureState_InstallationState_InstallationStateNotInstalled;
/**
 *  state of installation is unknown
 *
 *  Value: "INSTALLATION_STATE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_AnthosVMSubFeatureState_InstallationState_InstallationStateUnspecified;
 ...
 *  Value: "INSTALLATION_STATE_FAILED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_LocalControllerState_InstallationState_InstallationStateFailed;
/**
 *  component is successfully installed
 *
 *  Value: "INSTALLATION_STATE_INSTALLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_LocalControllerState_InstallationState_InstallationStateInstalled;
/**
 *  component is not installed
 *
 *  Value: "INSTALLATION_STATE_NOT_INSTALLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_LocalControllerState_InstallationState_InstallationStateNotInstalled;
/**
 *  state of installation is unknown
 *
 *  Value: "INSTALLATION_STATE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRGKEHub_LocalControllerState_InstallationState_InstallationStateUnspecified;
 ...
 *  membership/cluster.
 */
@interface GTLRGKEHub_AnthosVMMembershipSpec : GTLRObject

/**
 *  List of configurations of the Anthos For VM subfeatures that are to be
 *  enabled
 */
@property(nonatomic, strong, nullable) NSArray<GTLRGKEHub_AnthosVMSubFeatureSpec *> *subfeaturesSpec;

@end


/**
 *  AnthosVMFeatureState contains the state of the AnthosVM feature. It
 *  represents the actual state in the cluster, while the AnthosVMMembershipSpec
 *  represents the desired state.
 */
@interface GTLRGKEHub_AnthosVMMembershipState : GTLRObject

/** State of the local PE-controller inside the cluster */
@property(nonatomic, strong, nullable) GTLRGKEHub_LocalControllerState *localControllerState;

/** List of AnthosVM subfeature states */
@property(nonatomic, strong, nullable) NSArray<GTLRGKEHub_AnthosVMSubFeatureState *> *subfeatureState;
 ...
 *  membership/cluster.
 */
@interface GTLRGKEHub_AnthosVMSubFeatureSpec : GTLRObject

/**
 *  Indicates whether the subfeature should be enabled on the cluster or not. If
 *  set to true, the subfeature's control plane and resources will be installed
 *  in the cluster. If set to false, the oneof spec if present will be ignored
 *  and nothing will be installed in the cluster.
 *
...
@property(nonatomic, strong, nullable) GTLRGKEHub_MigrateSpec *migrateSpec;

/** ServiceMeshSpec repsents the configuration for Service Mesh subfeature. */
@property(nonatomic, strong, nullable) GTLRGKEHub_ServiceMeshSpec *serviceMeshSpec;
 ...
 */
@interface GTLRGKEHub_AnthosVMSubFeatureState : GTLRObject
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRGKEHub_AnthosVMSubFeatureState_InstallationState_InstallationStateFailed
 *        installation failed (Value: "INSTALLATION_STATE_FAILED")
 *    @arg @c kGTLRGKEHub_AnthosVMSubFeatureState_InstallationState_InstallationStateInstalled
 *        component is successfully installed (Value:
 *        "INSTALLATION_STATE_INSTALLED")
 *    @arg @c kGTLRGKEHub_AnthosVMSubFeatureState_InstallationState_InstallationStateNotInstalled
 *        component is not installed (Value: "INSTALLATION_STATE_NOT_INSTALLED")
 *    @arg @c kGTLRGKEHub_AnthosVMSubFeatureState_InstallationState_InstallationStateUnspecified
 *        state of installation is unknown (Value:
...
@property(nonatomic, strong, nullable) GTLRGKEHub_MigrateState *migrateState;

/** ServiceMeshState represents the state of the Service Mesh subfeature. */
@property(nonatomic, strong, nullable) GTLRGKEHub_ServiceMeshState *serviceMeshState;
 ...
 *  the cluster.
 */
@interface GTLRGKEHub_LocalControllerState : GTLRObject
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRGKEHub_LocalControllerState_InstallationState_InstallationStateFailed
 *        installation failed (Value: "INSTALLATION_STATE_FAILED")
 *    @arg @c kGTLRGKEHub_LocalControllerState_InstallationState_InstallationStateInstalled
 *        component is successfully installed (Value:
 *        "INSTALLATION_STATE_INSTALLED")
 *    @arg @c kGTLRGKEHub_LocalControllerState_InstallationState_InstallationStateNotInstalled
 *        component is not installed (Value: "INSTALLATION_STATE_NOT_INSTALLED")
 *    @arg @c kGTLRGKEHub_LocalControllerState_InstallationState_InstallationStateUnspecified
 *        state of installation is unknown (Value:
 *        "INSTALLATION_STATE_UNSPECIFIED")
 */
@property(nonatomic, copy, nullable) NSString *installationState;
...
/** AnthosVM spec. */
@property(nonatomic, strong, nullable) GTLRGKEHub_AnthosVMMembershipSpec *anthosvm;
...
/** AnthosVM state. */
@property(nonatomic, strong, nullable) GTLRGKEHub_AnthosVMMembershipState *anthosvm;
 ...
 */
@interface GTLRGKEHub_MigrateSpec : GTLRObject
@end
 ...
 */
@interface GTLRGKEHub_MigrateState : GTLRObject
@end
