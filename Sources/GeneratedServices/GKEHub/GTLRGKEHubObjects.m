...
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_MissingControlPlaneConfig = @"MISSING_CONTROL_PLANE_CONFIG";
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_ModernizationAborted = @"MODERNIZATION_ABORTED";
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_ModernizationCompatible = @"MODERNIZATION_COMPATIBLE";
...
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_ModernizationIncompatible = @"MODERNIZATION_INCOMPATIBLE";
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_ModernizationIncompatibleConfig = @"MODERNIZATION_INCOMPATIBLE_CONFIG";
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_ModernizationIncompatibleFleetQuota = @"MODERNIZATION_INCOMPATIBLE_FLEET_QUOTA";
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_ModernizationIncompatibleFleetScale = @"MODERNIZATION_INCOMPATIBLE_FLEET_SCALE";
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_ModernizationIncompatibleGatewayPodScale = @"MODERNIZATION_INCOMPATIBLE_GATEWAY_POD_SCALE";
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_ModernizationIncompatiblePodAnnotation = @"MODERNIZATION_INCOMPATIBLE_POD_ANNOTATION";
...
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_RequiredOrgPolicyDisabled = @"REQUIRED_ORG_POLICY_DISABLED";
NSString * const kGTLRGKEHub_ServiceMeshCondition_Code_SharedVpcMissingPermissions = @"SHARED_VPC_MISSING_PERMISSIONS";
