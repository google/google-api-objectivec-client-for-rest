...
@class GTLRDns_Status;
@class GTLRDns_Status_Details_Item;
 ...
 *  network API call.
 */
@interface GTLRDns_GoogleLongrunningOperation : GTLRObject
...
@property(nonatomic, strong, nullable) GTLRDns_Status *error;
 ...
 */
@interface GTLRDns_GoogleLongrunningOperation_Metadata : GTLRObject
@end
 ...
 *        -additionalProperties to fetch them all at once.
 */
@interface GTLRDns_GoogleLongrunningOperation_Response : GTLRObject
@end
 ...
 */
@interface GTLRDns_Status : GTLRObject
 ...
 *        -additionalProperties to fetch them all at once.
 */
@interface GTLRDns_Status_Details_Item : GTLRObject
@end
