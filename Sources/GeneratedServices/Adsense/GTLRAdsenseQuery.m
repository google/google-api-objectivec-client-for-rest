...
NSString * const kGTLRAdsenseDimensionsTrafficSourceCode     = @"TRAFFIC_SOURCE_CODE";
NSString * const kGTLRAdsenseDimensionsTrafficSourceName     = @"TRAFFIC_SOURCE_NAME";
...
NSString * const kGTLRAdsenseMetricsFunnelClicks               = @"FUNNEL_CLICKS";
NSString * const kGTLRAdsenseMetricsFunnelImpressions          = @"FUNNEL_IMPRESSIONS";
NSString * const kGTLRAdsenseMetricsFunnelRequests             = @"FUNNEL_REQUESTS";
NSString * const kGTLRAdsenseMetricsFunnelRpm                  = @"FUNNEL_RPM";
