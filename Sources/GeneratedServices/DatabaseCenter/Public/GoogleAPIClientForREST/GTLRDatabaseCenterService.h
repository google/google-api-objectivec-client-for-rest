 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeDatabaseCenterCloudPlatform;
...
/**
 *  Service for executing Database Center API queries.
 *
 *  Database Center offers a comprehensive, organization-wide platform for
 *  monitoring database fleet health across various products. It simplifies
 ...
 *  quickly identify and address relevant issues within their database fleets.
 */
@interface GTLRDatabaseCenterService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRDatabaseCenterQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
