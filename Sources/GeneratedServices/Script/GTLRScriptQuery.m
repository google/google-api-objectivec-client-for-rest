...
#import <GoogleAPIClientForREST/GTLRScriptQuery.h>
...
NSString * const kGTLRScriptScriptProcessFilterStatusesExecutionDisabled = @"EXECUTION_DISABLED";
...
NSString * const kGTLRScriptUserProcessFilterStatusesExecutionDisabled = @"EXECUTION_DISABLED";
