...
/**
 *  Service for executing Reader Revenue Subscription Linking API queries.
 *
 *  readerrevenuesubscriptionlinking.googleapis.com API.
 */
@interface GTLRSubscriptionLinkingService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRSubscriptionLinkingQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
