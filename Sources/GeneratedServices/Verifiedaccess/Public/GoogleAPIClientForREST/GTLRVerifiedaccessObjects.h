...
@class GTLRVerifiedaccess_Antivirus;
 ...
 *  Value: "DISABLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRVerifiedaccess_Antivirus_State_Disabled;
/**
 *  At least one antivirus was enabled on the device.
 *
 *  Value: "ENABLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRVerifiedaccess_Antivirus_State_Enabled;
/**
 *  No antivirus was detected on the device.
 *
 *  Value: "MISSING"
 */
FOUNDATION_EXTERN NSString * const kGTLRVerifiedaccess_Antivirus_State_Missing;
/**
 *  Unspecified.
 *
 *  Value: "STATE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRVerifiedaccess_Antivirus_State_StateUnspecified;
 ...
 */
@interface GTLRVerifiedaccess_Antivirus : GTLRObject
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRVerifiedaccess_Antivirus_State_Disabled At least one
 *        antivirus was installed on the device but none was enabled. (Value:
 *        "DISABLED")
 *    @arg @c kGTLRVerifiedaccess_Antivirus_State_Enabled At least one antivirus
 *        was enabled on the device. (Value: "ENABLED")
 *    @arg @c kGTLRVerifiedaccess_Antivirus_State_Missing No antivirus was
 *        detected on the device. (Value: "MISSING")
 *    @arg @c kGTLRVerifiedaccess_Antivirus_State_StateUnspecified Unspecified.
 *        (Value: "STATE_UNSPECIFIED")
 */
 ...
 *  on Windows only.
 */
@property(nonatomic, strong, nullable) GTLRVerifiedaccess_Antivirus *antivirus;
 ...
 *  is otherwise used. This value may be controlled by an enterprise policy:
