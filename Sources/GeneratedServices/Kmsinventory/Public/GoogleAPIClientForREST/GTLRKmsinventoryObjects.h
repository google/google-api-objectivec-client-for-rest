...
@class GTLRKmsinventory_GoogleCloudKmsInventoryV1Warning;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRKmsinventory_GoogleCloudKmsInventoryV1Warning_WarningCode_ResourceLimitExceededPartialData;
/**
 *  Default value. This value is unused.
 *
 *  Value: "WARNING_CODE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRKmsinventory_GoogleCloudKmsInventoryV1Warning_WarningCode_WarningCodeUnspecified;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRKmsinventory_GoogleCloudKmsV1KeyAccessJustificationsPolicy_AllowedAccessReasons_ModifiedCustomerInitiatedAccess GTLR_DEPRECATED;
/**
 *  Deprecated: This code is no longer generated by Google Cloud. The
 *  GOOGLE_RESPONSE_TO_PRODUCTION_ALERT justification codes available in both
 *  Key Access Justifications and Access Transparency logs provide
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRKmsinventory_GoogleCloudKmsV1KeyAccessJustificationsPolicy_AllowedAccessReasons_ModifiedGoogleInitiatedSystemOperation GTLR_DEPRECATED;
/**
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRKmsinventory_GoogleCloudKmsInventoryV1Warning *> *warnings;
