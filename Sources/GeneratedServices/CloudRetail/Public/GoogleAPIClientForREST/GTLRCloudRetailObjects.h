 ...
 *  Retail. This is an experimental feature. Contact Retail Search support team
 *  if you are interested in enabling it.
 */
 ...
 *        Unspecified spell correction mode. This defaults to Mode.AUTO. (Value:
 *        "MODE_UNSPECIFIED")
