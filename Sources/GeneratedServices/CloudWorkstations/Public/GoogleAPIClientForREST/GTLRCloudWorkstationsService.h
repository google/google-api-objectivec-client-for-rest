 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeCloudWorkstationsCloudPlatform;
...
// GTLRCloudWorkstationsQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
