 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeParameterManagerCloudPlatform;
...
/**
 *  Service for executing Parameter Manager API queries.
 *
 *  Parameter Manager is a single source of truth to store, access and manage
 *  the lifecycle of your workload parameters. Parameter Manager aims to make
 *  management of sensitive application parameters effortless for customers
 *  without diminishing focus on security.
 */
@interface GTLRParameterManagerService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRParameterManagerQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
