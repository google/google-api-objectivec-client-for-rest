...
#import <GoogleAPIClientForREST/GTLRApigeeObjects.h>
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1AnalyticsConfig_State_AddonStateUnspecified = @"ADDON_STATE_UNSPECIFIED";
NSString * const kGTLRApigee_GoogleCloudApigeeV1AnalyticsConfig_State_Disabled = @"DISABLED";
NSString * const kGTLRApigee_GoogleCloudApigeeV1AnalyticsConfig_State_Disabling = @"DISABLING";
NSString * const kGTLRApigee_GoogleCloudApigeeV1AnalyticsConfig_State_Enabled = @"ENABLED";
NSString * const kGTLRApigee_GoogleCloudApigeeV1AnalyticsConfig_State_Enabling = @"ENABLING";

// GTLRApigee_GoogleCloudApigeeV1ApimServiceExtension.state
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtension_State_Active = @"ACTIVE";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtension_State_Creating = @"CREATING";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtension_State_Deleting = @"DELETING";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtension_State_StateUnspecified = @"STATE_UNSPECIFIED";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtension_State_Updating = @"UPDATING";

// GTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension.supportedEvents
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension_SupportedEvents_RequestBody = @"REQUEST_BODY";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension_SupportedEvents_RequestHeaders = @"REQUEST_HEADERS";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension_SupportedEvents_RequestTrailers = @"REQUEST_TRAILERS";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension_SupportedEvents_ResponseBody = @"RESPONSE_BODY";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension_SupportedEvents_ResponseHeaders = @"RESPONSE_HEADERS";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension_SupportedEvents_ResponseTrailers = @"RESPONSE_TRAILERS";
NSString * const kGTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension_SupportedEvents_SupportedEventUnspecified = @"SUPPORTED_EVENT_UNSPECIFIED";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1AppGroupMonetizationConfig_BillingType_BillingTypeUnspecified = @"BILLING_TYPE_UNSPECIFIED";
NSString * const kGTLRApigee_GoogleCloudApigeeV1AppGroupMonetizationConfig_BillingType_Postpaid = @"POSTPAID";
NSString * const kGTLRApigee_GoogleCloudApigeeV1AppGroupMonetizationConfig_BillingType_Prepaid = @"PREPAID";

// GTLRApigee_GoogleCloudApigeeV1BatchComputeSecurityAssessmentResultsRequestResourceArrayResource.type
NSString * const kGTLRApigee_GoogleCloudApigeeV1BatchComputeSecurityAssessmentResultsRequestResourceArrayResource_Type_ApiHubDeployment = @"API_HUB_DEPLOYMENT";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1Deployment_ProxyDeploymentType_Extensible = @"EXTENSIBLE";
NSString * const kGTLRApigee_GoogleCloudApigeeV1Deployment_ProxyDeploymentType_ProxyDeploymentTypeUnspecified = @"PROXY_DEPLOYMENT_TYPE_UNSPECIFIED";
NSString * const kGTLRApigee_GoogleCloudApigeeV1Deployment_ProxyDeploymentType_Standard = @"STANDARD";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1EndpointAttachment_ConnectionState_AcceptedLimitedCapacity = @"ACCEPTED_LIMITED_CAPACITY";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1Environment_Type_Base = @"BASE";
NSString * const kGTLRApigee_GoogleCloudApigeeV1Environment_Type_Comprehensive = @"COMPREHENSIVE";
NSString * const kGTLRApigee_GoogleCloudApigeeV1Environment_Type_EnvironmentTypeUnspecified = @"ENVIRONMENT_TYPE_UNSPECIFIED";
NSString * const kGTLRApigee_GoogleCloudApigeeV1Environment_Type_Intermediate = @"INTERMEDIATE";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1Organization_SubscriptionPlan_Subscription2021 = @"SUBSCRIPTION_2021";
NSString * const kGTLRApigee_GoogleCloudApigeeV1Organization_SubscriptionPlan_Subscription2024 = @"SUBSCRIPTION_2024";
NSString * const kGTLRApigee_GoogleCloudApigeeV1Organization_SubscriptionPlan_SubscriptionPlanUnspecified = @"SUBSCRIPTION_PLAN_UNSPECIFIED";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1RuntimeTraceConfigOverride_TraceProtocol_Otlp = @"OTLP";
NSString * const kGTLRApigee_GoogleCloudApigeeV1RuntimeTraceConfigOverride_TraceProtocol_TraceProtocolUnspecified = @"TRACE_PROTOCOL_UNSPECIFIED";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityAssessmentResultResourceApiHubDeploymentDetails_GatewayType_ApigeeEdge = @"APIGEE_EDGE";
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityAssessmentResultResourceApiHubDeploymentDetails_GatewayType_ApigeeHybrid = @"APIGEE_HYBRID";
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityAssessmentResultResourceApiHubDeploymentDetails_GatewayType_ApigeeOpdk = @"APIGEE_OPDK";
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityAssessmentResultResourceApiHubDeploymentDetails_GatewayType_ApigeeX = @"APIGEE_X";
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityAssessmentResultResourceApiHubDeploymentDetails_GatewayType_ApiHubGatewayTypeUnspecified = @"API_HUB_GATEWAY_TYPE_UNSPECIFIED";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityAssessmentResultScoringResultAssessmentRecommendation_Verdict_NotApplicable = @"NOT_APPLICABLE";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityProfileV2_RiskAssessmentType_ApiHub = @"API_HUB";
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityProfileV2_RiskAssessmentType_RiskAssessmentTypeUnspecified = @"RISK_ASSESSMENT_TYPE_UNSPECIFIED";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityProfileV2ProfileAssessmentConfigApiHubGatewayTypeArray_GatewayTypes_ApigeeEdge = @"APIGEE_EDGE";
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityProfileV2ProfileAssessmentConfigApiHubGatewayTypeArray_GatewayTypes_ApigeeHybrid = @"APIGEE_HYBRID";
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityProfileV2ProfileAssessmentConfigApiHubGatewayTypeArray_GatewayTypes_ApigeeOpdk = @"APIGEE_OPDK";
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityProfileV2ProfileAssessmentConfigApiHubGatewayTypeArray_GatewayTypes_ApigeeX = @"APIGEE_X";
NSString * const kGTLRApigee_GoogleCloudApigeeV1SecurityProfileV2ProfileAssessmentConfigApiHubGatewayTypeArray_GatewayTypes_ApiHubGatewayTypeUnspecified = @"API_HUB_GATEWAY_TYPE_UNSPECIFIED";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1TargetServer_Protocol_GrpcTarget = @"GRPC_TARGET";
NSString * const kGTLRApigee_GoogleCloudApigeeV1TargetServer_Protocol_Http = @"HTTP";
NSString * const kGTLRApigee_GoogleCloudApigeeV1TargetServer_Protocol_Http2 = @"HTTP2";
...
NSString * const kGTLRApigee_GoogleCloudApigeeV1TargetServerConfig_Protocol_ExternalCallout = @"EXTERNAL_CALLOUT";
NSString * const kGTLRApigee_GoogleCloudApigeeV1TargetServerConfig_Protocol_Grpc = @"GRPC";
NSString * const kGTLRApigee_GoogleCloudApigeeV1TargetServerConfig_Protocol_GrpcTarget = @"GRPC_TARGET";
NSString * const kGTLRApigee_GoogleCloudApigeeV1TargetServerConfig_Protocol_Http = @"HTTP";
NSString * const kGTLRApigee_GoogleCloudApigeeV1TargetServerConfig_Protocol_Http2 = @"HTTP2";
...
@dynamic advancedApiOpsConfig, analyticsConfig, apiSecurityConfig,
         connectorsPlatformConfig, integrationConfig, monetizationConfig;
@end


// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AdjustAppGroupBalanceRequest
//

@implementation GTLRApigee_GoogleCloudApigeeV1AdjustAppGroupBalanceRequest
@dynamic adjustment;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AnalyticsConfig
//

@implementation GTLRApigee_GoogleCloudApigeeV1AnalyticsConfig
@dynamic enabled, expireTimeMillis, state, updateTime;
@end
...
@dynamic asyncApiDocumentation, graphqlDocumentation, oasDocumentation;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ApimServiceExtension
//

@implementation GTLRApigee_GoogleCloudApigeeV1ApimServiceExtension
@dynamic createTime, extensionProcessor, extensions, lbForwardingRule, name,
         network, networkConfigs, state, updateTime;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"extensions" : [GTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension class],
    @"networkConfigs" : [GTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionNetworkConfig class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension
//

@implementation GTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionExtension
@dynamic failOpen, hostname, matchCondition, name, supportedEvents;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionNetworkConfig
//

@implementation GTLRApigee_GoogleCloudApigeeV1ApimServiceExtensionNetworkConfig
@dynamic region, subnet;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1APIProductAssociation
//

@implementation GTLRApigee_GoogleCloudApigeeV1APIProductAssociation
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ApiSecurityConfig
//

@implementation GTLRApigee_GoogleCloudApigeeV1ApiSecurityConfig
...
@dynamic apiProducts, appGroup, appId, attributes, callbackUrl, companyName,
         createdAt, credentials, developerEmail, developerId, keyExpiresIn,
         lastModifiedAt, name, scopes, status;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AppGroup
//

@implementation GTLRApigee_GoogleCloudApigeeV1AppGroup
@dynamic appGroupId, attributes, channelId, channelUri, createdAt, displayName,
         email, lastModifiedAt, name, organization, status;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AppGroupApp
//

@implementation GTLRApigee_GoogleCloudApigeeV1AppGroupApp
@dynamic apiProducts, appGroup, appId, attributes, callbackUrl, createdAt,
         credentials, keyExpiresIn, lastModifiedAt, name, scopes, status;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AppGroupAppKey
//

@implementation GTLRApigee_GoogleCloudApigeeV1AppGroupAppKey
@dynamic apiProducts, attributes, consumerKey, consumerSecret, expiresAt,
         expiresInSeconds, issuedAt, scopes, status;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"apiProducts" : [GTLRApigee_GoogleCloudApigeeV1APIProductAssociation class],
    @"attributes" : [GTLRApigee_GoogleCloudApigeeV1Attribute class],
    @"scopes" : [NSString class]
  };
  return map;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AppGroupBalance
//

@implementation GTLRApigee_GoogleCloudApigeeV1AppGroupBalance
@dynamic wallets;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"wallets" : [GTLRApigee_GoogleCloudApigeeV1AppGroupBalanceWallet class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AppGroupBalanceWallet
//

@implementation GTLRApigee_GoogleCloudApigeeV1AppGroupBalanceWallet
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AppGroupMonetizationConfig
//

@implementation GTLRApigee_GoogleCloudApigeeV1AppGroupMonetizationConfig
@dynamic billingType;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AppGroupSubscription
//

@implementation GTLRApigee_GoogleCloudApigeeV1AppGroupSubscription
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1AsyncApiDocumentation
//

@implementation GTLRApigee_GoogleCloudApigeeV1AsyncApiDocumentation
@dynamic spec;
@end
...
@dynamic apiHubApis, apiHubGateways, include, includeAllResources, pageSize,
         pageToken, profile, scope;
@end
...
@implementation GTLRApigee_GoogleCloudApigeeV1BatchComputeSecurityAssessmentResultsRequestApiHubApiArray
@dynamic apis;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1BatchComputeSecurityAssessmentResultsRequestApiHubGatewayArray
//
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ComputeEnvironmentScoresRequest
//

@implementation GTLRApigee_GoogleCloudApigeeV1ComputeEnvironmentScoresRequest
@dynamic filters, pageSize, pageToken, timeRange;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"filters" : [GTLRApigee_GoogleCloudApigeeV1ComputeEnvironmentScoresRequestFilter class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ComputeEnvironmentScoresRequestFilter
//

@implementation GTLRApigee_GoogleCloudApigeeV1ComputeEnvironmentScoresRequestFilter
@dynamic scorePath;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ComputeEnvironmentScoresResponse
//

@implementation GTLRApigee_GoogleCloudApigeeV1ComputeEnvironmentScoresResponse
@dynamic nextPageToken, scores;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"scores" : [GTLRApigee_GoogleCloudApigeeV1Score class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1CreditAppGroupBalanceRequest
//

@implementation GTLRApigee_GoogleCloudApigeeV1CreditAppGroupBalanceRequest
...
@dynamic apiProxy, deployStartTime, environment, errors, instances, pods,
         proxyDeploymentType, revision, routeConflicts, serviceAccount, state;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1DisableSecurityActionRequest
//

@implementation GTLRApigee_GoogleCloudApigeeV1DisableSecurityActionRequest
@end
...
@implementation GTLRApigee_GoogleCloudApigeeV1EnableSecurityActionRequest
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ExpireAppGroupSubscriptionRequest
//

@implementation GTLRApigee_GoogleCloudApigeeV1ExpireAppGroupSubscriptionRequest
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1GrpcOperationConfig
//

@implementation GTLRApigee_GoogleCloudApigeeV1GrpcOperationConfig
@dynamic apiSource, attributes, methods, quota, service;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1GrpcOperationGroup
//

@implementation GTLRApigee_GoogleCloudApigeeV1GrpcOperationGroup
@dynamic operationConfigs;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"operationConfigs" : [GTLRApigee_GoogleCloudApigeeV1GrpcOperationConfig class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1KeyValueEntry
//

@implementation GTLRApigee_GoogleCloudApigeeV1KeyValueEntry
@dynamic name, value;
@end
...
@dynamic encrypted, maskedValues, name;
@end
...
@implementation GTLRApigee_GoogleCloudApigeeV1ListApimServiceExtensionsResponse
@dynamic apimServiceExtensions, nextPageToken;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"apimServiceExtensions" : [GTLRApigee_GoogleCloudApigeeV1ApimServiceExtension class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ListAppGroupAppsResponse
//

@implementation GTLRApigee_GoogleCloudApigeeV1ListAppGroupAppsResponse
@dynamic appGroupApps, nextPageToken;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"appGroupApps" : [GTLRApigee_GoogleCloudApigeeV1AppGroupApp class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ListAppGroupsResponse
//

@implementation GTLRApigee_GoogleCloudApigeeV1ListAppGroupsResponse
@dynamic appGroups, nextPageToken, totalSize;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"appGroups" : [GTLRApigee_GoogleCloudApigeeV1AppGroup class]
  };
  return map;
}
...
@implementation GTLRApigee_GoogleCloudApigeeV1ListAppGroupSubscriptionsResponse
@dynamic appGroupSubscriptions, nextPageToken;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"appGroupSubscriptions" : [GTLRApigee_GoogleCloudApigeeV1AppGroupSubscription class]
  };
  return map;
}
...
@dynamic app, nextPageToken, totalSize;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ListKeyValueEntriesResponse
//

@implementation GTLRApigee_GoogleCloudApigeeV1ListKeyValueEntriesResponse
@dynamic keyValueEntries, nextPageToken;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"keyValueEntries" : [GTLRApigee_GoogleCloudApigeeV1KeyValueEntry class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ListSecurityActionsResponse
//

@implementation GTLRApigee_GoogleCloudApigeeV1ListSecurityActionsResponse
@dynamic nextPageToken, securityActions;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"securityActions" : [GTLRApigee_GoogleCloudApigeeV1SecurityAction class]
  };
  return map;
}
...
@implementation GTLRApigee_GoogleCloudApigeeV1ListSecurityProfileRevisionsResponse
@dynamic nextPageToken, securityProfiles;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"securityProfiles" : [GTLRApigee_GoogleCloudApigeeV1SecurityProfile class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ListSecurityProfilesResponse
//

@implementation GTLRApigee_GoogleCloudApigeeV1ListSecurityProfilesResponse
@dynamic nextPageToken, securityProfiles;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ListSecurityReportsResponse
//

@implementation GTLRApigee_GoogleCloudApigeeV1ListSecurityReportsResponse
@dynamic nextPageToken, securityReports;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"securityReports" : [GTLRApigee_GoogleCloudApigeeV1SecurityReport class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1LlmOperation
//

@implementation GTLRApigee_GoogleCloudApigeeV1LlmOperation
@dynamic methods, model, resource;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1LlmOperationConfig
//

@implementation GTLRApigee_GoogleCloudApigeeV1LlmOperationConfig
@dynamic apiSource, attributes, llmOperations, llmTokenQuota;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"attributes" : [GTLRApigee_GoogleCloudApigeeV1Attribute class],
    @"llmOperations" : [GTLRApigee_GoogleCloudApigeeV1LlmOperation class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1LlmOperationGroup
//

@implementation GTLRApigee_GoogleCloudApigeeV1LlmOperationGroup
@dynamic operationConfigs;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"operationConfigs" : [GTLRApigee_GoogleCloudApigeeV1LlmOperationConfig class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1LlmTokenQuota
//

@implementation GTLRApigee_GoogleCloudApigeeV1LlmTokenQuota
...
@dynamic addonsConfig, analyticsRegion, apiConsumerDataEncryptionKeyName,
         ...
         authorizedNetwork, billingType, caCertificate, caCertificates,
...
@dynamic location, organization, projectId, projectIds;
...
@dynamic analyticsRegion, authorizedNetwork, disableVpcPeering, runtimeLocation;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1RuntimeAddonsConfig
//
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1RuntimeAnalyticsConfig
//

@implementation GTLRApigee_GoogleCloudApigeeV1RuntimeAnalyticsConfig
@dynamic billingPipelineEnabled, enabled;
@end


// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1RuntimeApiSecurityConfig
//

@implementation GTLRApigee_GoogleCloudApigeeV1RuntimeApiSecurityConfig
@dynamic enabled;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1Score
//

@implementation GTLRApigee_GoogleCloudApigeeV1Score
@dynamic component, subcomponents, timeRange;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"subcomponents" : [GTLRApigee_GoogleCloudApigeeV1ScoreComponent class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ScoreComponent
//

@implementation GTLRApigee_GoogleCloudApigeeV1ScoreComponent
@dynamic calculateTime, dataCaptureTime, drilldownPaths, recommendations, score,
         scorePath;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"drilldownPaths" : [NSString class],
    @"recommendations" : [GTLRApigee_GoogleCloudApigeeV1ScoreComponentRecommendation class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ScoreComponentRecommendation
//

@implementation GTLRApigee_GoogleCloudApigeeV1ScoreComponentRecommendation
@dynamic actions, descriptionProperty, impact, title;
...
+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"actions" : [GTLRApigee_GoogleCloudApigeeV1ScoreComponentRecommendationAction class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ScoreComponentRecommendationAction
//

@implementation GTLRApigee_GoogleCloudApigeeV1ScoreComponentRecommendationAction
@dynamic actionContext, descriptionProperty;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1ScoreComponentRecommendationActionActionContext
//
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityAction
//
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityActionAllow
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityActionAllow
@end


// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityActionConditionConfig
//
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityActionDeny
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityActionDeny
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityActionFlag
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityActionFlag
@dynamic headers;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"headers" : [GTLRApigee_GoogleCloudApigeeV1SecurityActionHttpHeader class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityActionHttpHeader
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityActionHttpHeader
@dynamic name, value;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityActionsConfig
//
...
@dynamic displayName, gateway, gatewayType, resourceUri, sourceProject;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityProfile
//
...
+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"environments" : [GTLRApigee_GoogleCloudApigeeV1SecurityProfileEnvironment class],
    @"scoringConfigs" : [GTLRApigee_GoogleCloudApigeeV1SecurityProfileScoringConfig class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityProfileEnvironment
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityProfileEnvironment
@dynamic attachTime, environment;
@end
...
@implementation GTLRApigee_GoogleCloudApigeeV1SecurityProfileEnvironmentAssociation
@dynamic attachTime, name, securityProfileRevisionId;
@end


// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityProfileScoringConfig
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityProfileScoringConfig
@dynamic descriptionProperty, scorePath, title;
...
@dynamic createTime, descriptionProperty, googleDefined, name,
         profileAssessmentConfigs, riskAssessmentType, updateTime;
...
@implementation GTLRApigee_GoogleCloudApigeeV1SecurityProfileV2ProfileAssessmentConfigApiHubGatewayTypeArray
@dynamic gatewayTypes;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"gatewayTypes" : [NSString class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityReport
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityReport
@dynamic created, displayName, envgroupHostname, error, executionTime,
         queryParams, reportDefinitionId, result, resultFileSize, resultRows,
         selfProperty, state, updated;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityReportMetadata
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityReportMetadata
@dynamic dimensions, endTimestamp, metrics, mimeType, startTimestamp, timeUnit;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityReportQuery
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityReportQuery
@dynamic csvDelimiter, dimensions, displayName, envgroupHostname, filter,
         groupByTimeUnit, limit, metrics, mimeType, reportDefinitionId,
         timeRange;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"dimensions" : [NSString class],
    @"metrics" : [GTLRApigee_GoogleCloudApigeeV1SecurityReportQueryMetric class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityReportQueryMetric
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityReportQueryMetric
@dynamic aggregationFunction, alias, name, operatorProperty, value;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityReportResultMetadata
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityReportResultMetadata
@dynamic expires, selfProperty;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SecurityReportResultView
//

@implementation GTLRApigee_GoogleCloudApigeeV1SecurityReportResultView
@dynamic code, error, metadata, rows, state;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1SetAddonEnablementRequest
//

@implementation GTLRApigee_GoogleCloudApigeeV1SetAddonEnablementRequest
@dynamic analyticsEnabled, apiSecurityEnabled;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleCloudApigeeV1UpdateAppGroupAppKeyRequest
//

@implementation GTLRApigee_GoogleCloudApigeeV1UpdateAppGroupAppKeyRequest
@dynamic action, apiProducts, appGroupAppKey;
...
// ----------------------------------------------------------------------------
//
//   GTLRApigee_GoogleTypeInterval
//

@implementation GTLRApigee_GoogleTypeInterval
