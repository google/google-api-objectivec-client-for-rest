 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeApiKeysServiceCloudPlatform;
/**
...
/**
 *  Service for executing API Keys API queries.
 *
 *  Manages the API keys associated with developer projects.
 */
@interface GTLRApiKeysServiceService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRApiKeysServiceQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
