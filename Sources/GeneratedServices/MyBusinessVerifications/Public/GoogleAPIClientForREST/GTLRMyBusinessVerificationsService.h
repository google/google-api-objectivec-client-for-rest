...
/**
 *  Service for executing My Business Verifications API queries.
 *
 *  The My Business Verifications API provides an interface for taking
 *  verifications related actions for locations.
 */
@interface GTLRMyBusinessVerificationsService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRMyBusinessVerificationsQuery.h. The query can the be sent with
