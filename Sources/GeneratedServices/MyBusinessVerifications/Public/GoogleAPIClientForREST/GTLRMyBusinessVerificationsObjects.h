...
@class GTLRMyBusinessVerifications_LocationData;
 ...
 *  Value: "FAILED"
 */
FOUNDATION_EXTERN NSString * const kGTLRMyBusinessVerifications_GenerateInstantVerificationTokenResponse_Result_Failed;
/**
 ...
 *  Value: "SUCCEEDED"
 */
FOUNDATION_EXTERN NSString * const kGTLRMyBusinessVerifications_GenerateInstantVerificationTokenResponse_Result_Succeeded;
 ...
 */
@interface GTLRMyBusinessVerifications_GenerateInstantVerificationTokenRequest : GTLRObject

/**
 *  Immutable. The address and other details of the location to generate an
 *  instant verification token for.
 */
@property(nonatomic, strong, nullable) GTLRMyBusinessVerifications_LocationData *locationData;
 ...
 *  Google My Business API. Note: the caller must be an owner or manager of this
 *  listing in order to generate a verification token. See the [location
 ...
 */
@interface GTLRMyBusinessVerifications_GenerateInstantVerificationTokenResponse : GTLRObject

/** The generated instant verification token. */
@property(nonatomic, copy, nullable) NSString *instantVerificationToken;

/**
 *  Output only. The result of the instant verification token generation.
 *
 *  Likely values:
 *    @arg @c kGTLRMyBusinessVerifications_GenerateInstantVerificationTokenResponse_Result_Failed
 *        The instant verification token was not generated.. (Value: "FAILED")
 *    @arg @c kGTLRMyBusinessVerifications_GenerateInstantVerificationTokenResponse_Result_ResultUnspecified
 ...
 *        The instant verification token was generated successfully. (Value:
 *        "SUCCEEDED")
 */
 ...
 */
@interface GTLRMyBusinessVerifications_LocationData : GTLRObject
