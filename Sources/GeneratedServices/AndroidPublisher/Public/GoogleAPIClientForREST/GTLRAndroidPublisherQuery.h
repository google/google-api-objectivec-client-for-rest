 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidPublisherAiGeneratedStateAiGeneratedStateAiGeneratedDeveloperAttested;
/**
 *  The content is not generated by AI.
 *
 *  Value: "aiGeneratedStateNotAiGenerated"
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidPublisherAiGeneratedStateAiGeneratedStateNotAiGenerated;
/**
 *  Catch-all for unrecognized enum values. See go/protodosdonts.
 *
 *  Value: "aiGeneratedStateUnspecified"
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidPublisherAiGeneratedStateAiGeneratedStateUnspecified;
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRAndroidPublisherAiGeneratedStateAiGeneratedStateUnspecified
 *        Catch-all for unrecognized enum values. See go/protodosdonts. (Value:
 *        "aiGeneratedStateUnspecified")
 *    @arg @c kGTLRAndroidPublisherAiGeneratedStateAiGeneratedStateNotAiGenerated
 *        The content is not generated by AI. (Value:
 *        "aiGeneratedStateNotAiGenerated")
 *    @arg @c kGTLRAndroidPublisherAiGeneratedStateAiGeneratedStateAiGeneratedDeveloperAttested
