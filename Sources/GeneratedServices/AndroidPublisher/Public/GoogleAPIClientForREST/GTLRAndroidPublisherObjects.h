...
@class GTLRAndroidPublisher_ReleaseSummary;
 ...
 *
 *  Value: "aiGeneratedStateAiGeneratedDeveloperAttested"
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidPublisher_Image_AiGeneratedState_AiGeneratedStateAiGeneratedDeveloperAttested;
/**
 *  The content is not generated by AI.
 *
 *  Value: "aiGeneratedStateNotAiGenerated"
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidPublisher_Image_AiGeneratedState_AiGeneratedStateNotAiGenerated;
/**
 *  Catch-all for unrecognized enum values. See go/protodosdonts.
 *
 *  Value: "aiGeneratedStateUnspecified"
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidPublisher_Image_AiGeneratedState_AiGeneratedStateUnspecified;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidPublisher_ReleaseSummary_ReleaseLifecycleState_ReleaseLifecycleStatePublished;
/**
 *  Not specified.
 *
 *  Value: "RELEASE_LIFECYCLE_STATE_UNSPECIFIED"
 */
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRAndroidPublisher_Image_AiGeneratedState_AiGeneratedStateAiGeneratedDeveloperAttested
 *        The content is generated by AI and attested by the developer. (Value:
 *        "aiGeneratedStateAiGeneratedDeveloperAttested")
 *    @arg @c kGTLRAndroidPublisher_Image_AiGeneratedState_AiGeneratedStateNotAiGenerated
 *        The content is not generated by AI. (Value:
 *        "aiGeneratedStateNotAiGenerated")
 *    @arg @c kGTLRAndroidPublisher_Image_AiGeneratedState_AiGeneratedStateUnspecified
 *        Catch-all for unrecognized enum values. See go/protodosdonts. (Value:
 *        "aiGeneratedStateUnspecified")
 */
@property(nonatomic, copy, nullable) NSString *aiGeneratedState;
 ...
 */
@property(nonatomic, copy, nullable) NSString *releaseLifecycleState;
