...
@class GTLRCloudShell_AddPublicKeyRequest;
@class GTLRCloudShell_AuthorizeEnvironmentRequest;
@class GTLRCloudShell_CancelOperationRequest;
@class GTLRCloudShell_RemovePublicKeyRequest;
@class GTLRCloudShell_StartEnvironmentRequest;
