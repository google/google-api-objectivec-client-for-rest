...
/**
 *  Metadata returned by the long running operation for the SetupSasAnalytics
 *  rpc.
 */
@interface GTLRSASPortal_SetupSasAnalyticsMetadata : GTLRObject
@end
...
/**
 *  Response returned by the long running operation for the SetupSasAnalytics
 *  rpc.
 */
@interface GTLRSASPortal_SetupSasAnalyticsResponse : GTLRObject
@end
