...
@class GTLRDeveloperConnect_GitProxyConfig;
 ...
 *  Value: "GITHUB"
 */
FOUNDATION_EXTERN NSString * const kGTLRDeveloperConnect_ProviderOAuthConfig_SystemProviderId_Github;
/**
 ...
 *  and token endpoints.
 */
@interface GTLRDeveloperConnect_AccountConnector : GTLRObject
 ...
 */
@interface GTLRDeveloperConnect_AccountConnector_Annotations : GTLRObject
@end
 ...
 */
@interface GTLRDeveloperConnect_BitbucketDataCenterConfig : GTLRObject
...
@property(nonatomic, strong, nullable) GTLRDeveloperConnect_BitbucketCloudConfig *bitbucketCloudConfig;

/** Configuration for connections to an instance of Bitbucket Data Center. */
@property(nonatomic, strong, nullable) GTLRDeveloperConnect_BitbucketDataCenterConfig *bitbucketDataCenterConfig;
 ...
 */
@interface GTLRDeveloperConnect_ExchangeError : GTLRObject
 ...
 */
@interface GTLRDeveloperConnect_FetchAccessTokenRequest : GTLRObject
@end
 ...
 */
@interface GTLRDeveloperConnect_FetchAccessTokenResponse : GTLRObject
 ...
 *
 *  @note This class supports NSFastEnumeration and indexed subscripting over
 *        its "accountConnectors" property. If returned as the result of a
 *        query, it should support automatic pagination (when @c
 *        shouldFetchNextPages is enabled).
 */
@interface GTLRDeveloperConnect_ListAccountConnectorsResponse : GTLRCollectionObject
 ...
 *        subscripting on this class.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRDeveloperConnect_AccountConnector *> *accountConnectors;
 ...
 *        enabled).
 */
@interface GTLRDeveloperConnect_ListUsersResponse : GTLRCollectionObject
 ...
 *        subscripting on this class.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRDeveloperConnect_User *> *users;
 ...
 */
@interface GTLRDeveloperConnect_ProcessBitbucketCloudWebhookRequest : GTLRObject
 ...
 *  method.
 */
@interface GTLRDeveloperConnect_ProcessBitbucketDataCenterWebhookRequest : GTLRObject
 ...
 *        https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/scopes-for-oauth-apps#available-scopes
 *        (Value: "GITHUB")
 *    @arg @c kGTLRDeveloperConnect_ProviderOAuthConfig_SystemProviderId_Gitlab
 *        GitLab provider. Scopes can be found at
 *        https://docs.gitlab.com/user/profile/personal_access_tokens/#personal-access-token-scopes
 *        (Value: "GITLAB")
 ...
 *  AccountConnector.
 */
@interface GTLRDeveloperConnect_User : GTLRObject
...
@property(nonatomic, strong, nullable) GTLRDateTime *lastTokenRequestTime;

/**
 *  Identifier. Resource name of the user, in the format `projects/ *
 *  /locations/ * /accountConnectors/ * /users/ *`.
 */
@property(nonatomic, copy, nullable) NSString *name;
