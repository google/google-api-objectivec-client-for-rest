...
/**
 *  Optional. Field to use to order the list of DeploymentEvents. Expects
 *  AIP-132 format "field_name asc" or "field_name desc", e.g. "deploy_time
 *  desc" Supported fields for ordering are: deploy_time, update_time.
 *  Currently, only sorting by a single field is supported. If this field is not
 *  provided, the list will be sorted by "deploy_time desc". For more details on
 *  the ordering syntax, see https://google.aip.dev/132#ordering.
 */
@property(nonatomic, copy, nullable) NSString *orderBy;
