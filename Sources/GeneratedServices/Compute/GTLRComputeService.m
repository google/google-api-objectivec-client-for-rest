...
+ (NSDictionary<NSString *, Class> *)kindStringToClassMap {
  return @{
    ...
    @"compute#backendBucketAggregatedList" : [GTLRCompute_BackendBucketAggregatedList class],
    ...
    @"compute#compositeHealthCheck" : [GTLRCompute_CompositeHealthCheck class],
    @"compute#compositeHealthCheckAggregatedList" : [GTLRCompute_CompositeHealthCheckAggregatedList class],
    @"compute#compositeHealthCheckHealth" : [GTLRCompute_CompositeHealthCheckHealth class],
    @"compute#compositeHealthCheckList" : [GTLRCompute_CompositeHealthCheckList class],
    ...
    @"compute#globalVmExtensionPolicy" : [GTLRCompute_GlobalVmExtensionPolicy class],
    @"compute#globalVmExtensionPolicyList" : [GTLRCompute_GlobalVmExtensionPolicyList class],
    @"compute#guestAttributes" : [GTLRCompute_GuestAttributes class],
    @"compute#healthAggregationPolicy" : [GTLRCompute_HealthAggregationPolicy class],
    @"compute#healthAggregationPolicyAggregatedList" : [GTLRCompute_HealthAggregationPolicyAggregatedList class],
    @"compute#healthAggregationPolicyList" : [GTLRCompute_HealthAggregationPolicyList class],
    ...
    @"compute#healthCheckServiceAggregatedList" : [GTLRCompute_HealthCheckServiceAggregatedList class],
    @"compute#healthCheckServicesList" : [GTLRCompute_HealthCheckServicesList class],
    @"compute#healthSource" : [GTLRCompute_HealthSource class],
    @"compute#healthSourceAggregatedList" : [GTLRCompute_HealthSourceAggregatedList class],
    @"compute#healthSourceHealth" : [GTLRCompute_HealthSourceHealth class],
    @"compute#healthSourceList" : [GTLRCompute_HealthSourceList class],
    @"compute#host" : [GTLRCompute_Host class],
    @"compute#hostList" : [GTLRCompute_HostsListResponse class],
    ...
    @"compute#instantSnapshotGroup" : [GTLRCompute_InstantSnapshotGroup class],
    @"compute#instantSnapshotGroupsList" : [GTLRCompute_ListInstantSnapshotGroups class],
    ...
    @"compute#notificationEndpointAggregatedList" : [GTLRCompute_NotificationEndpointAggregatedList class],
    ...
    @"compute#organizationSecurityPoliciesListAssociationsResponse" : [GTLRCompute_OrganizationSecurityPoliciesListAssociationsResponse class],
    ...
    @"compute#previewFeature" : [GTLRCompute_PreviewFeature class],
    ...
    @"compute#regionInstanceGroupManagerResizeRequestList" : [GTLRCompute_RegionInstanceGroupManagerResizeRequestsListResponse class],
    ...
    @"compute#reliabilityRisk" : [GTLRCompute_ReliabilityRisk class],
    ...
    // Skipping "compute#reservationSlot", was used on multiple classes:
    //     GTLRCompute_ReservationSlot
    //     GTLRCompute_ReservationSlotsListResponse
    ...
    @"compute#rollout" : [GTLRCompute_Rollout class],
    @"compute#rolloutPlan" : [GTLRCompute_RolloutPlan class],
    ...
    @"compute#routersListNamedSets" : [GTLRCompute_RoutersListNamedSets class],
    ...
    @"compute#usableBackendBucketList" : [GTLRCompute_BackendBucketListUsable class],
    ...
    @"compute#vmExtensionPolicy" : [GTLRCompute_VmExtensionPolicy class],
    @"compute#VmExtensionPolicyAggregatedList" : [GTLRCompute_VmExtensionPolicyAggregatedListResponse class],
    @"compute#vmExtensionPolicyList" : [GTLRCompute_VmExtensionPolicyList class],
