...
@class GTLRCloudHealthcare_CheckDataAccessRequest;
...
@class GTLRCloudHealthcare_QueryAccessibleDataRequest;
@class GTLRCloudHealthcare_RejectConsentRequest;
@class GTLRCloudHealthcare_RevokeConsentRequest;
