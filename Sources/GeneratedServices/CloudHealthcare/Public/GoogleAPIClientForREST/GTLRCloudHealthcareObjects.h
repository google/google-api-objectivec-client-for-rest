...
@class GTLRCloudHealthcare_AccessDeterminationLogConfig;
@class GTLRCloudHealthcare_AdminConsents;
...
@class GTLRCloudHealthcare_ConsentAccessorScope;
@class GTLRCloudHealthcare_ConsentArtifact;
@class GTLRCloudHealthcare_ConsentArtifact_Metadata;
@class GTLRCloudHealthcare_ConsentConfig;
@class GTLRCloudHealthcare_ConsentErrors;
@class GTLRCloudHealthcare_ConsentEvaluation;
@class GTLRCloudHealthcare_ConsentHeaderHandling;
...
@class GTLRCloudHealthcare_DicomNotificationConfig;
...
@class GTLRCloudHealthcare_ExplainDataAccessConsentInfo;
@class GTLRCloudHealthcare_ExplainDataAccessConsentScope;
...
@class GTLRCloudHealthcare_PatientScope;
...
@class GTLRCloudHealthcare_TimeRange;
 ...
 *  Value: "DISABLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_AccessDeterminationLogConfig_LogLevel_Disabled;
/**
 *  No log level specified. This value is unused.
 *
 *  Value: "LOG_LEVEL_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_AccessDeterminationLogConfig_LogLevel_LogLevelUnspecified;
/**
 ...
 *  request headers * The `log_level` of the AccessDeterminationLogConfig * The
 *  final consent evaluation (`PERMIT`, `DENY`, or `NO_CONSENT`) * A
 *  human-readable summary of the evaluation
 *
 *  Value: "MINIMUM"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_AccessDeterminationLogConfig_LogLevel_Minimum;
/**
 ...
 *  Value: "VERBOSE"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_AccessDeterminationLogConfig_LogLevel_Verbose;
 ...
 *  Value: "V1"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ConsentConfig_Version_V1;
 ...
 *  two cases by looking at the value of `protopayload.metadata.consentMode`. If
 *  consents scopes are present, they must be valid and within the allowed
 *  limits, otherwise the request will be rejected with a `4xx` code.
 *
 *  Value: "PERMIT_EMPTY_SCOPE"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ConsentHeaderHandling_Profile_PermitEmptyScope;
/**
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ConsentHeaderHandling_Profile_RequiredOnRead;
/**
 *  If not specified, the default value `PERMIT_EMPTY_SCOPE` is used.
 *
 *  Value: "SCOPE_PROFILE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ConsentHeaderHandling_Profile_ScopeProfileUnspecified;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ExplainDataAccessConsentInfo_Type_ConsentPolicyTypeAdmin;
/**
 *  Consent represent a patient consent.
 *
 *  Value: "CONSENT_POLICY_TYPE_PATIENT"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ExplainDataAccessConsentInfo_Type_ConsentPolicyTypePatient;
/**
 ...
 *
 *  Value: "CONSENT_VARIANT_CASCADE"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ExplainDataAccessConsentInfo_Variants_ConsentVariantCascade;
/**
 *  Consent is a standard patient or admin consent.
 *
 *  Value: "CONSENT_VARIANT_STANDARD"
 */
 ...
 *
 *  Value: "CONSENT_VARIANT_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ExplainDataAccessConsentInfo_Variants_ConsentVariantUnspecified;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ExplainDataAccessConsentScope_Decision_ConsentDecisionTypeDeny;
/**
 *  Consent permitted access.
 *
 *  Value: "CONSENT_DECISION_TYPE_PERMIT"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudHealthcare_ExplainDataAccessConsentScope_Decision_ConsentDecisionTypePermit;
/**
 ...
 */
@interface GTLRCloudHealthcare_AccessDeterminationLogConfig : GTLRObject
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRCloudHealthcare_AccessDeterminationLogConfig_LogLevel_Disabled
 *        No additional consent-related logging is added to audit logs. (Value:
 *        "DISABLED")
 *    @arg @c kGTLRCloudHealthcare_AccessDeterminationLogConfig_LogLevel_LogLevelUnspecified
 *        No log level specified. This value is unused. (Value:
 *        "LOG_LEVEL_UNSPECIFIED")
 *    @arg @c kGTLRCloudHealthcare_AccessDeterminationLogConfig_LogLevel_Minimum
 *        The following information is included: * One of the following
 *        [`consentMode`](https://cloud.google.com/healthcare-api/docs/fhir-consent#audit_logs)
 ...
 *        (Value: "MINIMUM")
 *    @arg @c kGTLRCloudHealthcare_AccessDeterminationLogConfig_LogLevel_Verbose
 ...
 */
@interface GTLRCloudHealthcare_AdminConsents : GTLRObject
 ...
 *  when the ApplyAdminConsents method fails to apply one or more Consent
 *  resources.
 */
@interface GTLRCloudHealthcare_ApplyAdminConsentsErrorDetail : GTLRObject

/**
 *  The list of Consent resources that are unsupported or cannot be applied and
 *  the error associated with each of them.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudHealthcare_ConsentErrors *> *consentErrors;
 ...
 */
@property(nonatomic, strong, nullable) NSNumber *existingOperationId;
 ...
 */
@interface GTLRCloudHealthcare_ApplyAdminConsentsRequest : GTLRObject

/**
 *  A new list of admin Consent resources to be applied. Any existing enforced
 *  Consents, which are specified in `consent_config.enforced_admin_consents` of
 *  the FhirStore, that are not part of this list will be disabled. An empty
 ...
 *  `consent_config.enforced_admin_consents`, the method enforces any updates to
 *  the existing resource since the last enforcement. If the existing resource
 *  hasn't been updated since the last enforcement, the resource is unaffected.
 *  After the method finishes, the resulting consent enforcement model is
 *  determined by the contents of the Consent resource(s) when the method was
 *  called: * When `disable_resource_versioning=true`, the result is identical
 *  to the current resource(s) in the FHIR store. * When
 ...
 */
@property(nonatomic, strong, nullable) GTLRCloudHealthcare_AdminConsents *newConsentsList NS_RETURNS_NOT_RETAINED;
 ...
 */
@interface GTLRCloudHealthcare_ApplyAdminConsentsResponse : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSNumber *affectedResources;

/**
 *  If `validate_only=false` in ApplyAdminConsentsRequest, this counter contains
 *  the number of Consent resources that were successfully applied. Otherwise,
 *  it is the number of Consent resources that are supported.
 *
 *  Uses NSNumber of longLongValue.
 */
@property(nonatomic, strong, nullable) NSNumber *consentApplySuccess;
 ...
 *  Uses NSNumber of longLongValue.
 */
@property(nonatomic, strong, nullable) NSNumber *failedResources;
 ...
 */
@interface GTLRCloudHealthcare_ApplyConsentsRequest : GTLRObject

/** Optional. Scope down to a list of patients. */
@property(nonatomic, strong, nullable) GTLRCloudHealthcare_PatientScope *patientScope;
 ...
 */
@property(nonatomic, strong, nullable) GTLRCloudHealthcare_TimeRange *timeRange;
 ...
 */
@interface GTLRCloudHealthcare_ApplyConsentsResponse : GTLRObject
 ...
 *  Uses NSNumber of longLongValue.
 */
@property(nonatomic, strong, nullable) NSNumber *consentApplyFailure;

/**
 *  If `validate_only = false` in ApplyConsentsRequest, this counter is the
 *  number of Consent resources that were successfully applied. Otherwise, it is
 *  the number of Consent resources that are supported.
 *
 *  Uses NSNumber of longLongValue.
 */
@property(nonatomic, strong, nullable) NSNumber *consentApplySuccess;
 ...
 *  environment.
 */
@interface GTLRCloudHealthcare_ConsentAccessorScope : GTLRObject
 ...
 */
@interface GTLRCloudHealthcare_ConsentConfig : GTLRObject
 ...
 *  used.
 */
@property(nonatomic, strong, nullable) GTLRCloudHealthcare_AccessDeterminationLogConfig *accessDeterminationLogConfig;
 ...
 *  Uses NSNumber of boolValue.
 */
@property(nonatomic, strong, nullable) NSNumber *accessEnforced;

/**
 *  Optional. Different options to configure the behaviour of the server when
 *  handling the `X-Consent-Scope` header.
 */
@property(nonatomic, strong, nullable) GTLRCloudHealthcare_ConsentHeaderHandling *consentHeaderHandling;
 ...
 */
@property(nonatomic, strong, nullable) NSArray<NSString *> *enforcedAdminConsents;
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRCloudHealthcare_ConsentConfig_Version_ConsentEnforcementVersionUnspecified
 *        Users must specify an enforcement version or an error is returned.
 *        (Value: "CONSENT_ENFORCEMENT_VERSION_UNSPECIFIED")
 *    @arg @c kGTLRCloudHealthcare_ConsentConfig_Version_V1 Enforcement version
 *        1. See the [FHIR Consent resources in the Cloud Healthcare
 *        API](https://cloud.google.com/healthcare-api/docs/fhir-consent) guide
 *        for more details. (Value: "V1")
 */
 ...
 */
@interface GTLRCloudHealthcare_ConsentErrors : GTLRObject
 ...
 */
@interface GTLRCloudHealthcare_ConsentHeaderHandling : GTLRObject
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRCloudHealthcare_ConsentHeaderHandling_Profile_PermitEmptyScope
 *        When no consent scopes are provided (for example, if there's an empty
 *        or missing header), then consent check is disabled, similar to when
 *        `access_enforced` is `false`. You can use audit logs to differentiate
 *        these two cases by looking at the value of
 ...
 *        request will be rejected with a `4xx` code. (Value:
 *        "PERMIT_EMPTY_SCOPE")
 *    @arg @c kGTLRCloudHealthcare_ConsentHeaderHandling_Profile_RequiredOnRead
 *        The consent header must be non-empty when performing read and search
 *        operations, otherwise the request is rejected with a `4xx` code.
 *        Additionally, invalid consent scopes or scopes exceeding the allowed
 *        limits are rejected. (Value: "REQUIRED_ON_READ")
 *    @arg @c kGTLRCloudHealthcare_ConsentHeaderHandling_Profile_ScopeProfileUnspecified
 *        If not specified, the default value `PERMIT_EMPTY_SCOPE` is used.
 *        (Value: "SCOPE_PROFILE_UNSPECIFIED")
 */
 ...
 */
@interface GTLRCloudHealthcare_DicomNotificationConfig : GTLRObject
 ...
 *  * `seriesInstanceUID`: The series UID of the DICOM instance that was
 *  changed. * `sopInstanceUID`: The instance UID of the DICOM instance that was
 *  changed. * `versionId`: The version ID of the DICOM instance that was
 *  changed. * `modality`: The modality tag of the DICOM instance that was
 ...
 *  a DICOM store.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudHealthcare_DicomNotificationConfig *> *notificationConfigs;
 ...
 */
@interface GTLRCloudHealthcare_ExplainDataAccessConsentInfo : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<NSString *> *cascadeOrigins;

/**
 *  The resource name of this consent resource, in the format:
 *  `projects/{project_id}/locations/{location}/datasets/{dataset_id}/fhirStores/{fhir_store_id}/fhir/Consent/{resource_id}`.
 */
@property(nonatomic, copy, nullable) NSString *consentResource;
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudHealthcare_ConsentAccessorScope *> *matchingAccessorScopes;
 ...
 */
@property(nonatomic, copy, nullable) NSString *patientConsentOwner;

/**
 *  The policy type of consent resource (e.g. PATIENT, ADMIN).
 *
 *  Likely values:
 *    @arg @c kGTLRCloudHealthcare_ExplainDataAccessConsentInfo_Type_ConsentPolicyTypeAdmin
 *        Consent represent an admin consent. (Value:
 *        "CONSENT_POLICY_TYPE_ADMIN")
 *    @arg @c kGTLRCloudHealthcare_ExplainDataAccessConsentInfo_Type_ConsentPolicyTypePatient
 *        Consent represent a patient consent. (Value:
 *        "CONSENT_POLICY_TYPE_PATIENT")
 *    @arg @c kGTLRCloudHealthcare_ExplainDataAccessConsentInfo_Type_ConsentPolicyTypeUnspecified
 ...
 *  consent.
 */
@interface GTLRCloudHealthcare_ExplainDataAccessConsentScope : GTLRObject

/**
 *  The accessor scope that describes who can access, for what purpose, and in
 *  which environment.
 */
@property(nonatomic, strong, nullable) GTLRCloudHealthcare_ConsentAccessorScope *accessorScope;
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRCloudHealthcare_ExplainDataAccessConsentScope_Decision_ConsentDecisionTypeDeny
 *        Consent denied access. (Value: "CONSENT_DECISION_TYPE_DENY")
 *    @arg @c kGTLRCloudHealthcare_ExplainDataAccessConsentScope_Decision_ConsentDecisionTypePermit
 *        Consent permitted access. (Value: "CONSENT_DECISION_TYPE_PERMIT")
 *    @arg @c kGTLRCloudHealthcare_ExplainDataAccessConsentScope_Decision_ConsentDecisionTypeUnspecified
 *        Unspecified consent decision type. (Value:
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudHealthcare_ExplainDataAccessConsentInfo *> *enforcingConsents;

/** Other consent scopes that created exceptions within this scope. */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudHealthcare_ExplainDataAccessConsentScope *> *exceptions;
 ...
 *  given resource.
 */
@interface GTLRCloudHealthcare_ExplainDataAccessResponse : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudHealthcare_ExplainDataAccessConsentScope *> *consentScopes;
 ...
 *  Uses NSNumber of longLongValue.
 */
@property(nonatomic, strong, nullable) NSNumber *versionedStorageSizeBytes;
 ...
 */
@interface GTLRCloudHealthcare_PatientScope : GTLRObject

/**
 *  Optional. The list of patient IDs whose Consent resources will be enforced.
 *  At most 10,000 patients can be specified. An empty list is equivalent to all
 *  patients (meaning the entire FHIR store).
 */
@property(nonatomic, strong, nullable) NSArray<NSString *> *patientIds;
 ...
 *  the time range. Note that after identifying these patients, the server
 *  applies all Consent resources given by those patients, not just the Consent
 *  resources within the timestamp in the range.
 */
@interface GTLRCloudHealthcare_TimeRange : GTLRObject
