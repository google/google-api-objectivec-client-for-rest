 ...
 *  Value: "UNENFORCED"
 */
FOUNDATION_EXTERN NSString * const kGTLRFirebaseappcheck_GoogleFirebaseAppcheckV1Service_ReplayProtection_Unenforced;
 ...
 *        `UNENFORCED` setting will have no effect and App Check will not work
 *        with that service. (Value: "UNENFORCED")
 */
 ...
 *        with that service. (Value: "UNENFORCED")
 */
@property(nonatomic, copy, nullable) NSString *replayProtection;
