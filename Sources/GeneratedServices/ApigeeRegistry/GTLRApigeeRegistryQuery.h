...
@class GTLRApigeeRegistry_CancelOperationRequest;
@class GTLRApigeeRegistry_Instance;
@class GTLRApigeeRegistry_RollbackApiDeploymentRequest;
@class GTLRApigeeRegistry_RollbackApiSpecRequest;
@class GTLRApigeeRegistry_SetIamPolicyRequest;
@class GTLRApigeeRegistry_TagApiDeploymentRevisionRequest;
@class GTLRApigeeRegistry_TagApiSpecRevisionRequest;
@class GTLRApigeeRegistry_TestIamPermissionsRequest;
