...
NSString * const kGTLRPaymentsResellerSubscription_GoogleCloudPaymentsResellerSubscriptionV1Duration_Unit_Hour = @"HOUR";
...
NSString * const kGTLRPaymentsResellerSubscription_GoogleCloudPaymentsResellerSubscriptionV1SubscriptionUpgradeDowngradeDetails_BillingCycleSpec_BillingCycleSpecDeferredToNextRecurrence = @"BILLING_CYCLE_SPEC_DEFERRED_TO_NEXT_RECURRENCE";
...
NSString * const kGTLRPaymentsResellerSubscription_GoogleCloudPaymentsResellerSubscriptionV1YoutubePayload_PartnerPlanType_PartnerPlanTypeHardBundle = @"PARTNER_PLAN_TYPE_HARD_BUNDLE";
NSString * const kGTLRPaymentsResellerSubscription_GoogleCloudPaymentsResellerSubscriptionV1YoutubePayload_PartnerPlanType_PartnerPlanTypeSoftBundle = @"PARTNER_PLAN_TYPE_SOFT_BUNDLE";
NSString * const kGTLRPaymentsResellerSubscription_GoogleCloudPaymentsResellerSubscriptionV1YoutubePayload_PartnerPlanType_PartnerPlanTypeStandalone = @"PARTNER_PLAN_TYPE_STANDALONE";
NSString * const kGTLRPaymentsResellerSubscription_GoogleCloudPaymentsResellerSubscriptionV1YoutubePayload_PartnerPlanType_PartnerPlanTypeUnspecified = @"PARTNER_PLAN_TYPE_UNSPECIFIED";
