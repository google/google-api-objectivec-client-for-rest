...
NSString * const kGTLRAiplatform_CloudAiLargeModelsVisionFilteredText_Category_CelebrityImg = @"CELEBRITY_IMG";
...
NSString * const kGTLRAiplatform_CloudAiLargeModelsVisionFilteredText_Category_WatermarkImgRemoval = @"WATERMARK_IMG_REMOVAL";
...
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceCandidate_FinishReason_FinishReasonBlocklist = @"FINISH_REASON_BLOCKLIST";
...
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceCandidate_FinishReason_FinishReasonProhibitedContent = @"FINISH_REASON_PROHIBITED_CONTENT";
...
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceCandidate_FinishReason_FinishReasonSpii = @"FINISH_REASON_SPII";
...
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServicePromptFeedback_BlockReason_Blocklist = @"BLOCKLIST";
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServicePromptFeedback_BlockReason_Other = @"OTHER";
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServicePromptFeedback_BlockReason_ProhibitedContent = @"PROHIBITED_CONTENT";
...
// GTLRAiplatform_CloudAiNlLlmProtoServiceRaiSignalInfluentialTerm.source
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceRaiSignalInfluentialTerm_Source_Prompt = @"PROMPT";
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceRaiSignalInfluentialTerm_Source_Response = @"RESPONSE";
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceRaiSignalInfluentialTerm_Source_SourceUnspecified = @"SOURCE_UNSPECIFIED";
...
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceSafetyRating_Severity_HarmSeverityHigh = @"HARM_SEVERITY_HIGH";
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceSafetyRating_Severity_HarmSeverityLow = @"HARM_SEVERITY_LOW";
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceSafetyRating_Severity_HarmSeverityMedium = @"HARM_SEVERITY_MEDIUM";
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceSafetyRating_Severity_HarmSeverityNegligible = @"HARM_SEVERITY_NEGLIGIBLE";
NSString * const kGTLRAiplatform_CloudAiNlLlmProtoServiceSafetyRating_Severity_HarmSeverityUnspecified = @"HARM_SEVERITY_UNSPECIFIED";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_CloudGemitAmps = @"CLOUD_GEMIT_AMPS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_CloudGemitAqua = @"CLOUD_GEMIT_AQUA";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_CloudGemitCommonSenseReasoningSchema = @"CLOUD_GEMIT_COMMON_SENSE_REASONING_SCHEMA";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_CloudGemitGsm8kSchema = @"CLOUD_GEMIT_GSM8K_SCHEMA";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_CloudGemitSearchAugmentedResponseGeneration = @"CLOUD_GEMIT_SEARCH_AUGMENTED_RESPONSE_GENERATION";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_CloudSecurityRagCisa = @"CLOUD_SECURITY_RAG_CISA";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_DuetStackoverflowAnswers = @"DUET_STACKOVERFLOW_ANSWERS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_DuetStackoverflowIssues = @"DUET_STACKOVERFLOW_ISSUES";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchBirdSqlLite = @"GEMINI_V1_TAIL_PATCH_BIRD_SQL_LITE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchCcaiDialogSumHuman = @"GEMINI_V1_TAIL_PATCH_CCAI_DIALOG_SUM_HUMAN";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchGoaldmine = @"GEMINI_V1_TAIL_PATCH_GOALDMINE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchJsonTableExtraction = @"GEMINI_V1_TAIL_PATCH_JSON_TABLE_EXTRACTION";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchMathReasoningNonPunting = @"GEMINI_V1_TAIL_PATCH_MATH_REASONING_NON_PUNTING";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchMathReasoningPunting = @"GEMINI_V1_TAIL_PATCH_MATH_REASONING_PUNTING";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchOpenBooksQaAnswerable = @"GEMINI_V1_TAIL_PATCH_OPEN_BOOKS_QA_ANSWERABLE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchOpenBooksQaUnanswerable = @"GEMINI_V1_TAIL_PATCH_OPEN_BOOKS_QA_UNANSWERABLE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchPhotomathIm2solProblemAndSolution = @"GEMINI_V1_TAIL_PATCH_PHOTOMATH_IM2SOL_PROBLEM_AND_SOLUTION";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchTranslation2021Incr = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_2021_INCR";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchTranslationUn = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_UN";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchTranslationWmtEuroparl = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_WMT_EUROPARL";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV1TailPatchTranslationWmtNewscommentary = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_WMT_NEWSCOMMENTARY";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2CodeTransformGithubCommits = @"GEMINI_V2_CODE_TRANSFORM_GITHUB_COMMITS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2CodeTransformGithubPr = @"GEMINI_V2_CODE_TRANSFORM_GITHUB_PR";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2CodeTransformSyntheticErrorFix = @"GEMINI_V2_CODE_TRANSFORM_SYNTHETIC_ERROR_FIX";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2SqlRepairSft = @"GEMINI_V2_SQL_REPAIR_SFT";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2Ssfs = @"GEMINI_V2_SSFS";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchBirdSqlLite = @"GEMINI_V2_TAIL_PATCH_BIRD_SQL_LITE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchCcaiDialogSumHuman = @"GEMINI_V2_TAIL_PATCH_CCAI_DIALOG_SUM_HUMAN";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchFleurs = @"GEMINI_V2_TAIL_PATCH_FLEURS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchJsonTableExtraction = @"GEMINI_V2_TAIL_PATCH_JSON_TABLE_EXTRACTION";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchMathReasoningNonPunting = @"GEMINI_V2_TAIL_PATCH_MATH_REASONING_NON_PUNTING";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchMathReasoningPunting = @"GEMINI_V2_TAIL_PATCH_MATH_REASONING_PUNTING";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchOpenBooksQaAnswerable = @"GEMINI_V2_TAIL_PATCH_OPEN_BOOKS_QA_ANSWERABLE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchOpenBooksQaUnanswerable = @"GEMINI_V2_TAIL_PATCH_OPEN_BOOKS_QA_UNANSWERABLE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchPmc = @"GEMINI_V2_TAIL_PATCH_PMC";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_GeminiV2TailPatchVoxpopuli = @"GEMINI_V2_TAIL_PATCH_VOXPOPULI";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution_Dataset_YtContentInspiration = @"YT_CONTENT_INSPIRATION";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_CloudGemitAmps = @"CLOUD_GEMIT_AMPS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_CloudGemitAqua = @"CLOUD_GEMIT_AQUA";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_CloudGemitCommonSenseReasoningSchema = @"CLOUD_GEMIT_COMMON_SENSE_REASONING_SCHEMA";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_CloudGemitGsm8kSchema = @"CLOUD_GEMIT_GSM8K_SCHEMA";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_CloudGemitSearchAugmentedResponseGeneration = @"CLOUD_GEMIT_SEARCH_AUGMENTED_RESPONSE_GENERATION";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_CloudSecurityRagCisa = @"CLOUD_SECURITY_RAG_CISA";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_DuetStackoverflowAnswers = @"DUET_STACKOVERFLOW_ANSWERS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_DuetStackoverflowIssues = @"DUET_STACKOVERFLOW_ISSUES";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchBirdSqlLite = @"GEMINI_V1_TAIL_PATCH_BIRD_SQL_LITE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchCcaiDialogSumHuman = @"GEMINI_V1_TAIL_PATCH_CCAI_DIALOG_SUM_HUMAN";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchGoaldmine = @"GEMINI_V1_TAIL_PATCH_GOALDMINE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchJsonTableExtraction = @"GEMINI_V1_TAIL_PATCH_JSON_TABLE_EXTRACTION";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchMathReasoningNonPunting = @"GEMINI_V1_TAIL_PATCH_MATH_REASONING_NON_PUNTING";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchMathReasoningPunting = @"GEMINI_V1_TAIL_PATCH_MATH_REASONING_PUNTING";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchOpenBooksQaAnswerable = @"GEMINI_V1_TAIL_PATCH_OPEN_BOOKS_QA_ANSWERABLE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchOpenBooksQaUnanswerable = @"GEMINI_V1_TAIL_PATCH_OPEN_BOOKS_QA_UNANSWERABLE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchPhotomathIm2solProblemAndSolution = @"GEMINI_V1_TAIL_PATCH_PHOTOMATH_IM2SOL_PROBLEM_AND_SOLUTION";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchTranslation2021Incr = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_2021_INCR";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchTranslationUn = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_UN";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchTranslationWmtEuroparl = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_WMT_EUROPARL";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV1TailPatchTranslationWmtNewscommentary = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_WMT_NEWSCOMMENTARY";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2CodeTransformGithubCommits = @"GEMINI_V2_CODE_TRANSFORM_GITHUB_COMMITS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2CodeTransformGithubPr = @"GEMINI_V2_CODE_TRANSFORM_GITHUB_PR";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2CodeTransformSyntheticErrorFix = @"GEMINI_V2_CODE_TRANSFORM_SYNTHETIC_ERROR_FIX";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2JsonModeSysInstruction = @"GEMINI_V2_JSON_MODE_SYS_INSTRUCTION";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2SqlRepairSft = @"GEMINI_V2_SQL_REPAIR_SFT";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2Ssfs = @"GEMINI_V2_SSFS";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchBirdSqlLite = @"GEMINI_V2_TAIL_PATCH_BIRD_SQL_LITE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchCcaiDialogSumHuman = @"GEMINI_V2_TAIL_PATCH_CCAI_DIALOG_SUM_HUMAN";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchFleurs = @"GEMINI_V2_TAIL_PATCH_FLEURS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchJsonTableExtraction = @"GEMINI_V2_TAIL_PATCH_JSON_TABLE_EXTRACTION";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchMathReasoningNonPunting = @"GEMINI_V2_TAIL_PATCH_MATH_REASONING_NON_PUNTING";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchMathReasoningPunting = @"GEMINI_V2_TAIL_PATCH_MATH_REASONING_PUNTING";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchOpenBooksQaAnswerable = @"GEMINI_V2_TAIL_PATCH_OPEN_BOOKS_QA_ANSWERABLE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchOpenBooksQaUnanswerable = @"GEMINI_V2_TAIL_PATCH_OPEN_BOOKS_QA_UNANSWERABLE";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchPmc = @"GEMINI_V2_TAIL_PATCH_PMC";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_GeminiV2TailPatchVoxpopuli = @"GEMINI_V2_TAIL_PATCH_VOXPOPULI";
...
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_AttributionDataset_YtContentInspiration = @"YT_CONTENT_INSPIRATION";
...
// GTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult.sourceCategory
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_SourceCategory_SourceCategoryArxiv = @"SOURCE_CATEGORY_ARXIV";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_SourceCategory_SourceCategoryGithub = @"SOURCE_CATEGORY_GITHUB";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_SourceCategory_SourceCategoryGnews = @"SOURCE_CATEGORY_GNEWS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_SourceCategory_SourceCategoryOthers = @"SOURCE_CATEGORY_OTHERS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_SourceCategory_SourceCategoryPrivateBooks = @"SOURCE_CATEGORY_PRIVATE_BOOKS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_SourceCategory_SourceCategoryPublicBooks = @"SOURCE_CATEGORY_PUBLIC_BOOKS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_SourceCategory_SourceCategoryUnspecified = @"SOURCE_CATEGORY_UNSPECIFIED";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_SourceCategory_SourceCategoryWebdocs = @"SOURCE_CATEGORY_WEBDOCS";
NSString * const kGTLRAiplatform_LanguageLabsAidaTrustRecitationProtoSegmentResult_SourceCategory_SourceCategoryWikipedia = @"SOURCE_CATEGORY_WIKIPEDIA";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_CloudGemitAmps = @"CLOUD_GEMIT_AMPS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_CloudGemitAqua = @"CLOUD_GEMIT_AQUA";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_CloudGemitCommonSenseReasoningSchema = @"CLOUD_GEMIT_COMMON_SENSE_REASONING_SCHEMA";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_CloudGemitGsm8kSchema = @"CLOUD_GEMIT_GSM8K_SCHEMA";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_CloudGemitSearchAugmentedResponseGeneration = @"CLOUD_GEMIT_SEARCH_AUGMENTED_RESPONSE_GENERATION";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_CloudSecurityRagCisa = @"CLOUD_SECURITY_RAG_CISA";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_DuetStackoverflowAnswers = @"DUET_STACKOVERFLOW_ANSWERS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_DuetStackoverflowIssues = @"DUET_STACKOVERFLOW_ISSUES";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchBirdSqlLite = @"GEMINI_V1_TAIL_PATCH_BIRD_SQL_LITE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchCcaiDialogSumHuman = @"GEMINI_V1_TAIL_PATCH_CCAI_DIALOG_SUM_HUMAN";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchGoaldmine = @"GEMINI_V1_TAIL_PATCH_GOALDMINE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchJsonTableExtraction = @"GEMINI_V1_TAIL_PATCH_JSON_TABLE_EXTRACTION";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchMathReasoningNonPunting = @"GEMINI_V1_TAIL_PATCH_MATH_REASONING_NON_PUNTING";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchMathReasoningPunting = @"GEMINI_V1_TAIL_PATCH_MATH_REASONING_PUNTING";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchOpenBooksQaAnswerable = @"GEMINI_V1_TAIL_PATCH_OPEN_BOOKS_QA_ANSWERABLE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchOpenBooksQaUnanswerable = @"GEMINI_V1_TAIL_PATCH_OPEN_BOOKS_QA_UNANSWERABLE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchPhotomathIm2solProblemAndSolution = @"GEMINI_V1_TAIL_PATCH_PHOTOMATH_IM2SOL_PROBLEM_AND_SOLUTION";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchTranslation2021Incr = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_2021_INCR";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchTranslationUn = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_UN";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchTranslationWmtEuroparl = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_WMT_EUROPARL";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV1TailPatchTranslationWmtNewscommentary = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_WMT_NEWSCOMMENTARY";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2CodeTransformGithubCommits = @"GEMINI_V2_CODE_TRANSFORM_GITHUB_COMMITS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2CodeTransformGithubPr = @"GEMINI_V2_CODE_TRANSFORM_GITHUB_PR";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2CodeTransformSyntheticErrorFix = @"GEMINI_V2_CODE_TRANSFORM_SYNTHETIC_ERROR_FIX";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2JsonModeSysInstruction = @"GEMINI_V2_JSON_MODE_SYS_INSTRUCTION";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2SqlRepairSft = @"GEMINI_V2_SQL_REPAIR_SFT";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2Ssfs = @"GEMINI_V2_SSFS";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchBirdSqlLite = @"GEMINI_V2_TAIL_PATCH_BIRD_SQL_LITE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchCcaiDialogSumHuman = @"GEMINI_V2_TAIL_PATCH_CCAI_DIALOG_SUM_HUMAN";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchFleurs = @"GEMINI_V2_TAIL_PATCH_FLEURS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchJsonTableExtraction = @"GEMINI_V2_TAIL_PATCH_JSON_TABLE_EXTRACTION";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchMathReasoningNonPunting = @"GEMINI_V2_TAIL_PATCH_MATH_REASONING_NON_PUNTING";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchMathReasoningPunting = @"GEMINI_V2_TAIL_PATCH_MATH_REASONING_PUNTING";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchOpenBooksQaAnswerable = @"GEMINI_V2_TAIL_PATCH_OPEN_BOOKS_QA_ANSWERABLE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchOpenBooksQaUnanswerable = @"GEMINI_V2_TAIL_PATCH_OPEN_BOOKS_QA_UNANSWERABLE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchPmc = @"GEMINI_V2_TAIL_PATCH_PMC";
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_GeminiV2TailPatchVoxpopuli = @"GEMINI_V2_TAIL_PATCH_VOXPOPULI";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationDocAttribution_Dataset_YtContentInspiration = @"YT_CONTENT_INSPIRATION";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_CloudGemitAmps = @"CLOUD_GEMIT_AMPS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_CloudGemitAqua = @"CLOUD_GEMIT_AQUA";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_CloudGemitCommonSenseReasoningSchema = @"CLOUD_GEMIT_COMMON_SENSE_REASONING_SCHEMA";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_CloudGemitGsm8kSchema = @"CLOUD_GEMIT_GSM8K_SCHEMA";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_CloudGemitSearchAugmentedResponseGeneration = @"CLOUD_GEMIT_SEARCH_AUGMENTED_RESPONSE_GENERATION";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_CloudSecurityRagCisa = @"CLOUD_SECURITY_RAG_CISA";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_DuetStackoverflowAnswers = @"DUET_STACKOVERFLOW_ANSWERS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_DuetStackoverflowIssues = @"DUET_STACKOVERFLOW_ISSUES";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchBirdSqlLite = @"GEMINI_V1_TAIL_PATCH_BIRD_SQL_LITE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchCcaiDialogSumHuman = @"GEMINI_V1_TAIL_PATCH_CCAI_DIALOG_SUM_HUMAN";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchGoaldmine = @"GEMINI_V1_TAIL_PATCH_GOALDMINE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchJsonTableExtraction = @"GEMINI_V1_TAIL_PATCH_JSON_TABLE_EXTRACTION";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchMathReasoningNonPunting = @"GEMINI_V1_TAIL_PATCH_MATH_REASONING_NON_PUNTING";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchMathReasoningPunting = @"GEMINI_V1_TAIL_PATCH_MATH_REASONING_PUNTING";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchOpenBooksQaAnswerable = @"GEMINI_V1_TAIL_PATCH_OPEN_BOOKS_QA_ANSWERABLE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchOpenBooksQaUnanswerable = @"GEMINI_V1_TAIL_PATCH_OPEN_BOOKS_QA_UNANSWERABLE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchPhotomathIm2solProblemAndSolution = @"GEMINI_V1_TAIL_PATCH_PHOTOMATH_IM2SOL_PROBLEM_AND_SOLUTION";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchTranslation2021Incr = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_2021_INCR";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchTranslationUn = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_UN";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchTranslationWmtEuroparl = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_WMT_EUROPARL";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV1TailPatchTranslationWmtNewscommentary = @"GEMINI_V1_TAIL_PATCH_TRANSLATION_WMT_NEWSCOMMENTARY";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2CodeTransformGithubCommits = @"GEMINI_V2_CODE_TRANSFORM_GITHUB_COMMITS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2CodeTransformGithubPr = @"GEMINI_V2_CODE_TRANSFORM_GITHUB_PR";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2CodeTransformSyntheticErrorFix = @"GEMINI_V2_CODE_TRANSFORM_SYNTHETIC_ERROR_FIX";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2JsonModeSysInstruction = @"GEMINI_V2_JSON_MODE_SYS_INSTRUCTION";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2SqlRepairSft = @"GEMINI_V2_SQL_REPAIR_SFT";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2Ssfs = @"GEMINI_V2_SSFS";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchBirdSqlLite = @"GEMINI_V2_TAIL_PATCH_BIRD_SQL_LITE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchCcaiDialogSumHuman = @"GEMINI_V2_TAIL_PATCH_CCAI_DIALOG_SUM_HUMAN";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchFleurs = @"GEMINI_V2_TAIL_PATCH_FLEURS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchJsonTableExtraction = @"GEMINI_V2_TAIL_PATCH_JSON_TABLE_EXTRACTION";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchMathReasoningNonPunting = @"GEMINI_V2_TAIL_PATCH_MATH_REASONING_NON_PUNTING";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchMathReasoningPunting = @"GEMINI_V2_TAIL_PATCH_MATH_REASONING_PUNTING";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchOpenBooksQaAnswerable = @"GEMINI_V2_TAIL_PATCH_OPEN_BOOKS_QA_ANSWERABLE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchOpenBooksQaUnanswerable = @"GEMINI_V2_TAIL_PATCH_OPEN_BOOKS_QA_UNANSWERABLE";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchPmc = @"GEMINI_V2_TAIL_PATCH_PMC";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_GeminiV2TailPatchVoxpopuli = @"GEMINI_V2_TAIL_PATCH_VOXPOPULI";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_AttributionDataset_YtContentInspiration = @"YT_CONTENT_INSPIRATION";
...
// GTLRAiplatform_LearningGenaiRecitationSegmentResult.sourceCategory
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_SourceCategory_SourceCategoryArxiv = @"SOURCE_CATEGORY_ARXIV";
...
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_SourceCategory_SourceCategoryOthers = @"SOURCE_CATEGORY_OTHERS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_SourceCategory_SourceCategoryPrivateBooks = @"SOURCE_CATEGORY_PRIVATE_BOOKS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_SourceCategory_SourceCategoryPublicBooks = @"SOURCE_CATEGORY_PUBLIC_BOOKS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_SourceCategory_SourceCategoryUnspecified = @"SOURCE_CATEGORY_UNSPECIFIED";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_SourceCategory_SourceCategoryWebdocs = @"SOURCE_CATEGORY_WEBDOCS";
NSString * const kGTLRAiplatform_LearningGenaiRecitationSegmentResult_SourceCategory_SourceCategoryWikipedia = @"SOURCE_CATEGORY_WIKIPEDIA";
...
// GTLRAiplatform_LearningGenaiRootCodeyChatMetadata.codeLanguage
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_All = @"ALL";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Bash = @"BASH";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_C = @"C";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Cpp = @"CPP";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Dart = @"DART";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Go = @"GO";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Gradle = @"GRADLE";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Groovy = @"GROOVY";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Html = @"HTML";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Java = @"JAVA";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Javadoc = @"JAVADOC";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Javascript = @"JAVASCRIPT";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Json = @"JSON";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_JupyterNotebook = @"JUPYTER_NOTEBOOK";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Kotlin = @"KOTLIN";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Makefile = @"MAKEFILE";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Markdown = @"MARKDOWN";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Proto = @"PROTO";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Python = @"PYTHON";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_R = @"R";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Sql = @"SQL";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Text = @"TEXT";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Typescript = @"TYPESCRIPT";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Unspecified = @"UNSPECIFIED";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Xml = @"XML";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyChatMetadata_CodeLanguage_Yaml = @"YAML";

// GTLRAiplatform_LearningGenaiRootCodeyCheckpoint.postInferenceStep
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepCustomStopSequenceTruncation = @"STEP_CUSTOM_STOP_SEQUENCE_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepExpectedSampleSize = @"STEP_EXPECTED_SAMPLE_SIZE";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepFinalDeduplication = @"STEP_FINAL_DEDUPLICATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepHeuristicTruncation = @"STEP_HEURISTIC_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepModelConfigStopSequenceTruncation = @"STEP_MODEL_CONFIG_STOP_SEQUENCE_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepModelOutputDeduplication = @"STEP_MODEL_OUTPUT_DEDUPLICATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepOriginalModelOutput = @"STEP_ORIGINAL_MODEL_OUTPUT";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepPostProcessingStepUnspecified = @"STEP_POST_PROCESSING_STEP_UNSPECIFIED";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepRecitationCheck = @"STEP_RECITATION_CHECK";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepReturned = @"STEP_RETURNED";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepScoreThresholding = @"STEP_SCORE_THRESHOLDING";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepStopSequenceTruncation = @"STEP_STOP_SEQUENCE_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepToxicityCheck = @"STEP_TOXICITY_CHECK";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepTreeTrimTruncation = @"STEP_TREE_TRIM_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepWaldTruncation = @"STEP_WALD_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepWalkbackCorrection = @"STEP_WALKBACK_CORRECTION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyCheckpoint_PostInferenceStep_StepWhitespaceTruncation = @"STEP_WHITESPACE_TRUNCATION";

// GTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata.postInferenceStep
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepCustomStopSequenceTruncation = @"STEP_CUSTOM_STOP_SEQUENCE_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepExpectedSampleSize = @"STEP_EXPECTED_SAMPLE_SIZE";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepFinalDeduplication = @"STEP_FINAL_DEDUPLICATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepHeuristicTruncation = @"STEP_HEURISTIC_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepModelConfigStopSequenceTruncation = @"STEP_MODEL_CONFIG_STOP_SEQUENCE_TRUNCATION";
...
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepOriginalModelOutput = @"STEP_ORIGINAL_MODEL_OUTPUT";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepPostProcessingStepUnspecified = @"STEP_POST_PROCESSING_STEP_UNSPECIFIED";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepRecitationCheck = @"STEP_RECITATION_CHECK";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepReturned = @"STEP_RETURNED";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepScoreThresholding = @"STEP_SCORE_THRESHOLDING";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepStopSequenceTruncation = @"STEP_STOP_SEQUENCE_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepToxicityCheck = @"STEP_TOXICITY_CHECK";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepTreeTrimTruncation = @"STEP_TREE_TRIM_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepWaldTruncation = @"STEP_WALD_TRUNCATION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepWalkbackCorrection = @"STEP_WALKBACK_CORRECTION";
NSString * const kGTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata_PostInferenceStep_StepWhitespaceTruncation = @"STEP_WHITESPACE_TRUNCATION";

// GTLRAiplatform_LearningGenaiRootControlDecodingConfigThreshold.policy
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingConfigThreshold_Policy_DangerousContent = @"DANGEROUS_CONTENT";
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingConfigThreshold_Policy_Harassment = @"HARASSMENT";
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingConfigThreshold_Policy_HateSpeech = @"HATE_SPEECH";
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingConfigThreshold_Policy_SexuallyExplicit = @"SEXUALLY_EXPLICIT";
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingConfigThreshold_Policy_Unspecified = @"UNSPECIFIED";

// GTLRAiplatform_LearningGenaiRootControlDecodingRecordPolicyScore.policy
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingRecordPolicyScore_Policy_DangerousContent = @"DANGEROUS_CONTENT";
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingRecordPolicyScore_Policy_Harassment = @"HARASSMENT";
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingRecordPolicyScore_Policy_HateSpeech = @"HATE_SPEECH";
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingRecordPolicyScore_Policy_SexuallyExplicit = @"SEXUALLY_EXPLICIT";
NSString * const kGTLRAiplatform_LearningGenaiRootControlDecodingRecordPolicyScore_Policy_Unspecified = @"UNSPECIFIED";
...
NSString * const kGTLRAiplatform_LearningGenaiRootFilterMetadata_Reason_FilterControlDecoding = @"FILTER_CONTROL_DECODING";
...
NSString * const kGTLRAiplatform_LearningGenaiRootFilterMetadata_Reason_FilterReasonRaiImageChild = @"FILTER_REASON_RAI_IMAGE_CHILD";
...
NSString * const kGTLRAiplatform_LearningGenaiRootFilterMetadata_Reason_FilterReasonRaiVideoFrameChild = @"FILTER_REASON_RAI_VIDEO_FRAME_CHILD";
...
NSString * const kGTLRAiplatform_LearningGenaiRootFilterMetadata_Reason_FilterReasonXai = @"FILTER_REASON_XAI";
...
NSString * const kGTLRAiplatform_LearningServingLlmAtlasOutputMetadata_Source_Factuality = @"FACTUALITY";
NSString * const kGTLRAiplatform_LearningServingLlmAtlasOutputMetadata_Source_Infobot = @"INFOBOT";
NSString * const kGTLRAiplatform_LearningServingLlmAtlasOutputMetadata_Source_Llm = @"LLM";
NSString * const kGTLRAiplatform_LearningServingLlmAtlasOutputMetadata_Source_Unknown = @"UNKNOWN";
...
NSString * const kGTLRAiplatform_LearningServingLlmMessageMetadata_FinishReason_TopNFiltered = @"TOP_N_FILTERED";
...
@dynamic generatedSamples, raiErrorMessage, raiMediaFilteredCount,
         raiMediaFilteredReasons, raiTextFilteredReason;
...
@dynamic factualityDebugMetadata, inputFilterInfo, modelRoutingDecision,
         outputFilterInfo;
...
@dynamic documentMetadata, fileData, functionCall, functionResponse, inlineData,
         lmRootMetadata, text, videoMetadata;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_CloudAiNlLlmProtoServicePartDocumentMetadata
//

@implementation GTLRAiplatform_CloudAiNlLlmProtoServicePartDocumentMetadata
@dynamic originalDocumentBlob, pageNumber;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_CloudAiNlLlmProtoServicePartLMRootMetadata
//

@implementation GTLRAiplatform_CloudAiNlLlmProtoServicePartLMRootMetadata
@dynamic chunkId;
@end
...
@dynamic aidaRecitationResult, blocked, errorCodes, filtered,
         languageFilterResult, raiSignals, translationRequestInfos,
         triggeredBlocklist, triggeredRecitation, triggeredSafetyFilter;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"errorCodes" : [NSNumber class],
    @"raiSignals" : [GTLRAiplatform_CloudAiNlLlmProtoServiceRaiSignal class],
    @"translationRequestInfos" : [GTLRAiplatform_LearningGenaiRootTranslationRequestInfo class]
  };
  return map;
}
...
@dynamic confidence, flagged, influentialTerms, raiCategory, score;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"influentialTerms" : [GTLRAiplatform_CloudAiNlLlmProtoServiceRaiSignalInfluentialTerm class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_CloudAiNlLlmProtoServiceRaiSignalInfluentialTerm
//

@implementation GTLRAiplatform_CloudAiNlLlmProtoServiceRaiSignalInfluentialTerm
...
@dynamic bigQueryDatasetName, createTime, displayName, ETag, metadata, name,
         updateTime;
...
@dynamic bigtable, createTime, dedicatedServingEndpoint, ETag, labels, name,
         optimized, state, updateTime;
...
@dynamic contents, generationConfig, safetySettings, systemInstruction, tools;
...
@dynamic candidateCount, frequencyPenalty, maxOutputTokens, presencePenalty,
         responseMimeType, stopSequences, temperature, topK, topP;
...
@dynamic createApplication, deploy, deployGke, fineTune, openEvaluationPipeline,
...
@dynamic candidateCount, gcsUri, groundingConfig, maxOutputTokens, note,
         promptType, stopSequences, systemInstructionGcsUri, temperature, text,
         topK, topP;
...
@dynamic functionDeclarations, retrieval;
...
@dynamic baseModel, createTime, descriptionProperty, endTime, error, experiment,
         labels, name, startTime, state, supervisedTuningSpec, tunedModel,
         tunedModelDisplayName, tuningDataStats, updateTime;
...
@dynamic attributionDataset, displayAttributionMessage, docAttribution,
         docOccurrences, endIndex, rawText, segmentRecitationAction,
         sourceCategory, startIndex;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootCodeyChatMetadata
//

@implementation GTLRAiplatform_LearningGenaiRootCodeyChatMetadata
@dynamic codeLanguage;
@end


// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootCodeyCheckpoint
//

@implementation GTLRAiplatform_LearningGenaiRootCodeyCheckpoint
@dynamic codeyTruncatorMetadata, currentSample, postInferenceStep;
@end


// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootCodeyCompletionMetadata
//

@implementation GTLRAiplatform_LearningGenaiRootCodeyCompletionMetadata
@dynamic checkpoints;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"checkpoints" : [GTLRAiplatform_LearningGenaiRootCodeyCheckpoint class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata
//

@implementation GTLRAiplatform_LearningGenaiRootCodeyGenerationMetadata
@dynamic output, postInferenceStep;
@end


// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootCodeyOutput
//

@implementation GTLRAiplatform_LearningGenaiRootCodeyOutput
@dynamic codeyChatMetadata, codeyCompletionMetadata, codeyGenerationMetadata;
@end
...
@implementation GTLRAiplatform_LearningGenaiRootCodeyTruncatorMetadata
@dynamic cutoffIndex, truncatedText;
@end


// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootControlDecodingConfigThreshold
//

@implementation GTLRAiplatform_LearningGenaiRootControlDecodingConfigThreshold
@dynamic policy, scoreMax;
@end


// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootControlDecodingRecord
//

@implementation GTLRAiplatform_LearningGenaiRootControlDecodingRecord
@dynamic prefixes, scores, suffiexes, thresholds;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"scores" : [GTLRAiplatform_LearningGenaiRootControlDecodingRecordPolicyScore class],
    @"thresholds" : [GTLRAiplatform_LearningGenaiRootControlDecodingConfigThreshold class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootControlDecodingRecordPolicyScore
//
...
// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootControlDecodingRecords
//

@implementation GTLRAiplatform_LearningGenaiRootControlDecodingRecords
@dynamic records;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"records" : [GTLRAiplatform_LearningGenaiRootControlDecodingRecord class]
  };
  return map;
}
...
@dynamic classifierOutput, defaultMetadata, languageFilterResult, raiOutput,
         raiResult, raiSignal, records, streamRecitationResult, takedownResult,
         toxicityResult;
@end
...
@dynamic contextualDangerous, csam, fringe, grailImageHarmType,
         grailTextHarmType, imageChild, imageCsam, imagePedo, imagePorn,
         imageViolence, pqc, safetycat, spii, threshold, videoFrameChild,
         videoFrameCsam, videoFramePedo, videoFramePorn, videoFrameViolence;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootPerRequestProcessorDebugMetadataFactualityDebugMetadata
//

@implementation GTLRAiplatform_LearningGenaiRootPerRequestProcessorDebugMetadataFactualityDebugMetadata
@dynamic factRetrievalMillisecondsByProvider, prompt2queryMilliseconds;
@end


// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootPerRequestProcessorDebugMetadataFactualityDebugMetadata_FactRetrievalMillisecondsByProvider
//
...
@dynamic computedInputTokenLength, modelId, pickedAsFallback, selected;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRAiplatform_LearningGenaiRootTranslationRequestInfo
//

@implementation GTLRAiplatform_LearningGenaiRootTranslationRequestInfo
@dynamic detectedLanguageCodes, totalContentSize;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"detectedLanguageCodes" : [NSString class]
  };
  return map;
}
...
@implementation GTLRAiplatform_LearningServingLlmAtlasOutputMetadata
@dynamic requestTopic, source;
@end
...
@dynamic atlasMetadata, classifierSummary, codeyOutput, currentStreamTextLength,
         deleted, filterMeta, finalMessageScore, finishReason,
         groundingMetadata, isCode, isFallback, langidResult, language,
         lmPrefix, originalText, perStreamDecodedTokenCount,
         perStreamReturnedTokenCount, raiOutputs, recitationResult,
         returnTokenCount, scores, streamTerminated, totalDecodedTokenCount,
         totalReturnedTokenCount, translatedUserPrompts, vertexRaiResult;
