...
@dynamic codeyChatMetadata, codeyCompletionMetadata;
@end
...
@dynamic classifierSummary, codeyOutput, currentStreamTextLength, deleted,
         filterMeta, finalMessageScore, finishReason, groundingMetadata, isCode,
         isFallback, langidResult, language, lmPrefix, originalText,
