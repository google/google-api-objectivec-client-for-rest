 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeAgentIdentityCredentialsCloudPlatform;
...
// GTLRAgentIdentityCredentialsQuery.h. The query can the be sent with
