 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeHypercomputeClusterCloudPlatform;
...
// GTLRHypercomputeClusterQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
