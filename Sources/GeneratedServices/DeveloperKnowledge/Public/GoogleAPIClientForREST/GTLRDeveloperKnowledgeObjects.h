...
@class GTLRDeveloperKnowledge_Answer;
@class GTLRDeveloperKnowledge_AnswerCitation;
@class GTLRDeveloperKnowledge_AnswerReference;
@class GTLRDeveloperKnowledge_CitationSource;
@class GTLRDeveloperKnowledge_Document;
@class GTLRDeveloperKnowledge_DocumentChunk;
@class GTLRDeveloperKnowledge_DocumentReference;
 ...
 */
@interface GTLRDeveloperKnowledge_Answer : GTLRObject
...
@property(nonatomic, strong, nullable) NSArray<GTLRDeveloperKnowledge_AnswerCitation *> *citations;

/** Output only. Contains references for the answer. */
@property(nonatomic, strong, nullable) NSArray<GTLRDeveloperKnowledge_AnswerReference *> *references;
 ...
 */
@interface GTLRDeveloperKnowledge_AnswerCitation : GTLRObject
...
@property(nonatomic, strong, nullable) NSArray<GTLRDeveloperKnowledge_CitationSource *> *sources;
 ...
 */
@interface GTLRDeveloperKnowledge_AnswerQueryRequest : GTLRObject
 ...
 */
@interface GTLRDeveloperKnowledge_AnswerQueryResponse : GTLRObject

/** The answer to the query. */
@property(nonatomic, strong, nullable) GTLRDeveloperKnowledge_Answer *answer;
 ...
 */
@interface GTLRDeveloperKnowledge_AnswerReference : GTLRObject

/** Output only. The reference document. */
@property(nonatomic, strong, nullable) GTLRDeveloperKnowledge_DocumentReference *documentReference;
 ...
 *  Citation source.
 */
@interface GTLRDeveloperKnowledge_CitationSource : GTLRObject
 ...
 *  Uses NSNumber of intValue.
 */
@property(nonatomic, strong, nullable) NSNumber *contentLengthBytes;
 ...
 *        `title` - `description` - `update_time` - `view` -
 ...
 */
@interface GTLRDeveloperKnowledge_DocumentReference : GTLRObject

/**
 *  Output only. Contains the document chunk. The `document_chunk.id` field is
 *  not set and will be empty.
 */
@property(nonatomic, strong, nullable) GTLRDeveloperKnowledge_DocumentChunk *documentChunk;
