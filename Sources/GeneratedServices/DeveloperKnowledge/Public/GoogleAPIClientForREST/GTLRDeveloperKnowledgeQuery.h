 ...
 *        `description` - `update_time` - `view` - `content_length_bytes` This
 *        is the default of view for DeveloperKnowledge.SearchDocumentChunks.
 *        (Value: "DOCUMENT_VIEW_BASIC")
 ...
 *
 *  Method: developerknowledge.answerQuery
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeDeveloperKnowledgeCloudPlatform
 */
@interface GTLRDeveloperKnowledgeQuery_V1AnswerQuery : GTLRDeveloperKnowledgeQuery

/**
 *  Fetches a @c GTLRDeveloperKnowledge_AnswerQueryResponse.
 *
 *  Answers a query using grounded generation.
 *
 *  @param object The @c GTLRDeveloperKnowledge_AnswerQueryRequest to include in
 *    the query.
 *
 *  @return GTLRDeveloperKnowledgeQuery_V1AnswerQuery
 */
