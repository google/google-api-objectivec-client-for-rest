...
@class GTLRBigQueryDataTransfer_DataplexConfiguration;
 ...
 */
@interface GTLRBigQueryDataTransfer_DataplexConfiguration : GTLRObject
 ...
 */
@property(nonatomic, copy, nullable) NSString *entryGroup;
 ...
 */
@interface GTLRBigQueryDataTransfer_MetadataDestination : GTLRObject
