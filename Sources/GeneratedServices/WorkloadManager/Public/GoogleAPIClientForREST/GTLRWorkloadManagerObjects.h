...
@class GTLRWorkloadManager_SapWorkloadOverview;
...
@class GTLRWorkloadManager_WorkloadProfileOverview;
 ...
 *
 *  @note This class supports NSFastEnumeration and indexed subscripting over
 *        its "workloadOverviews" property. If returned as the result of a
 *        query, it should support automatic pagination (when @c
 *        shouldFetchNextPages is enabled).
 */
@interface GTLRWorkloadManager_ListWorkloadProfilesResponse : GTLRCollectionObject
 ...
 *        subscripting on this class.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRWorkloadManager_WorkloadProfileOverview *> *workloadOverviews;
 ...
 */
@interface GTLRWorkloadManager_SapWorkloadOverview : GTLRObject

/** Output only. The application SID */
@property(nonatomic, copy, nullable) NSString *appSid;

/** Output only. The database SID */
@property(nonatomic, copy, nullable) NSString *dbSid;

/** Output only. The UUID for a SAP workload */
@property(nonatomic, copy, nullable) NSString *sapSystemId;
 ...
 */
@interface GTLRWorkloadManager_SqlserverWorkloadOverview : GTLRObject

/** Output only. The availability groups */
@property(nonatomic, strong, nullable) NSArray<NSString *> *availabilityGroup;

/** Output only. The UUID for a Sqlserver workload */
@property(nonatomic, copy, nullable) NSString *sqlserverSystemId;
 ...
 */
@interface GTLRWorkloadManager_ThreeTierWorkloadOverview : GTLRObject

/** Output only. The UUID for a three tier workload */
@property(nonatomic, copy, nullable) NSString *threeTierSystemId;
 ...
 */
@interface GTLRWorkloadManager_WorkloadProfileOverview : GTLRObject

/** The sap workload overview */
@property(nonatomic, strong, nullable) GTLRWorkloadManager_SapWorkloadOverview *sapWorkloadOverview;

/** The sqlserver workload overview */
@property(nonatomic, strong, nullable) GTLRWorkloadManager_SqlserverWorkloadOverview *sqlserverWorkloadOverview;

/** The three tier workload overview */
@property(nonatomic, strong, nullable) GTLRWorkloadManager_ThreeTierWorkloadOverview *threeTierWorkloadOverview;
