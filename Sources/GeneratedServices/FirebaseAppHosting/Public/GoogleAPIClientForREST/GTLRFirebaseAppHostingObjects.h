...
@class GTLRFirebaseAppHosting_ArchiveSource;
...
@class GTLRFirebaseAppHosting_SourceUserMetadata;
 ...
 */
@property(nonatomic, copy, nullable) NSString *userStorageUri;
 ...
 *  Uses NSNumber of boolValue.
 */
@property(nonatomic, strong, nullable) NSNumber *requestLogsDisabled;
...
/** An archive source. */
@property(nonatomic, strong, nullable) GTLRFirebaseAppHosting_ArchiveSource *archive;
