 ...
 *  Value: "GVNIC"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudBatch_NetworkInterface_NicType_Gvnic;
/**
 *  IRDMA
 *
 *  Value: "IRDMA"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudBatch_NetworkInterface_NicType_Irdma;
/**
 *  MRDMA
 *
 *  Value: "MRDMA"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudBatch_NetworkInterface_NicType_Mrdma;
/**
 *  No type specified.
 *
 *  Value: "NIC_TYPE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudBatch_NetworkInterface_NicType_NicTypeUnspecified;
 ...
 *  and `["zones/us-central1-a", "zones/us-central1-c"]` only allow VMs in zones
 *  `us-central1-a` and `us-central1-c`. However, `["regions/us-central1",
 *  "zones/us-central1-a", "zones/us-central1-b", "zones/us-west1-a"]` causes an
 *  error because it contains multiple regions (`us-central1` and `us-west1`).
 *  The specified region or zones must be in the same region in which the job is
 *  created starting on the following dates: + For projects that have
 *  successfully submitted before July 31, 2026 at least one job that uses the
 *  `allowedLocations[]` field with any region or zones outside of the job's
 *  location, the changes are starting on _June 30, 2027_. + For all other
 *  projects, the changes are starting on _July 31, 2026_. For example, for job
 ...
 *  `regions/us-west1`) or a zone not in `us-central1` (e.g. `zones/us-west1-a`)
 *  causes an error.
 */
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRCloudBatch_NetworkInterface_NicType_Gvnic GVNIC (Value:
 *        "GVNIC")
 *    @arg @c kGTLRCloudBatch_NetworkInterface_NicType_Irdma IRDMA (Value:
 *        "IRDMA")
 *    @arg @c kGTLRCloudBatch_NetworkInterface_NicType_Mrdma MRDMA (Value:
 *        "MRDMA")
 *    @arg @c kGTLRCloudBatch_NetworkInterface_NicType_NicTypeUnspecified No
 *        type specified. (Value: "NIC_TYPE_UNSPECIFIED")
 */
