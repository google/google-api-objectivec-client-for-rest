...
#import <GoogleAPIClientForREST/GTLRPublicCertificateAuthorityObjects.h>

// ----------------------------------------------------------------------------
//
//   GTLRPublicCertificateAuthority_ExternalAccountKey
//

@implementation GTLRPublicCertificateAuthority_ExternalAccountKey
@dynamic b64MacKey, keyId, name;
@end
