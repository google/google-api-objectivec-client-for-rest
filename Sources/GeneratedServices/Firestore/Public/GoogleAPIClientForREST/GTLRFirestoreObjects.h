...
@class GTLRFirestore_Aggregation;
 ...
 *  result.
 */
@interface GTLRFirestore_AggregationResult : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) GTLRFirestore_AggregationResult_AggregateFields *aggregateFields;
 ...
 */
@interface GTLRFirestore_AggregationResult_AggregateFields : GTLRObject
@end
 ...
 */
@interface GTLRFirestore_Count : GTLRObject
 ...
 */
@interface GTLRFirestore_StructuredAggregationQuery : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRFirestore_Aggregation *> *aggregations;
...
/**
 *  A potential prefix of a position in the result set to end the query at. This
 *  is similar to `START_AT` but with it controlling the end position rather
 *  than the start position. Requires: * The number of values cannot be greater
...
/**
 *  The order to apply to the query results. Firestore allows callers to provide
 *  a full ordering, a partial ordering, or no ordering at all. In all cases,
 *  Firestore guarantees a stable ordering through the following rules: * The
 *  `order_by` is required to reference all fields used with an inequality
 *  filter. * All fields that are required to be in the `order_by` but are not
 *  already present are appended in lexicographical ordering of the field name.
