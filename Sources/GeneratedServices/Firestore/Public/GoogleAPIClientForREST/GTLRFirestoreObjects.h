 ...
 *  COUNT_UP_TO(1000) FROM ( SELECT * FROM k ); ``` Requires: * Must be greater
...
/**
 *  A single aggregation result. Not present when reporting partial progress or
 *  when the query produced zero results.
 */
