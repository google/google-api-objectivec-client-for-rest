 ...
 *  moving the resource to this specified destination parent. This can only be a
 *  folder number (such as "folders/123") or an organization number (such as
 *  "organizations/123").
 */
 ...
 *  resources of types [supported by search
 *  APIs](https://cloud.google.com/asset-inventory/docs/supported-asset-types)
 *  or IAM policies.
 *
