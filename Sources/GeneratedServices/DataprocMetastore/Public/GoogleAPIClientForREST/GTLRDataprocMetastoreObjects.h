...
@class GTLRDataprocMetastore_MessageSet;
 ...
 */
@interface GTLRDataprocMetastore_AlterTablePropertiesRequest : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) GTLRDataprocMetastore_AlterTablePropertiesRequest_Properties *properties;
 ...
 */
@interface GTLRDataprocMetastore_AlterTablePropertiesRequest_Properties : GTLRObject
@end
 ...
 *  for customer data encryption, in the following
 ...
 *  "marketing"
 */
@property(nonatomic, strong, nullable) GTLRDataprocMetastore_Federation_Tags *tags;
 ...
 *        fetch them all at once.
 */
@interface GTLRDataprocMetastore_Federation_Tags : GTLRObject
@end
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRDataprocMetastore_CustomRegionMetadata *> *customRegionMetadata GTLR_DEPRECATED;

/**
 *  Deprecated: Use a single region service instead. The multi-region metadata
 *  if the current region is a multi-region.
 */
@property(nonatomic, strong, nullable) GTLRDataprocMetastore_MultiRegionMetadata *multiRegionMetadata GTLR_DEPRECATED;
 ...
 */
GTLR_DEPRECATED
@interface GTLRDataprocMetastore_MessageSet : GTLRObject
@end
...
/**
 *  Deprecated: Use a single region service instead. The metadata for the
...
/**
 *  Optional. The configuration specifying the network settings for the Dataproc
 *  Metastore service.
 */
@property(nonatomic, strong, nullable) GTLRDataprocMetastore_NetworkConfig *networkConfig;
 ...
 *  "marketing"
 */
@property(nonatomic, strong, nullable) GTLRDataprocMetastore_Service_Tags *tags;
 ...
 *        fetch them all at once.
 */
@interface GTLRDataprocMetastore_Service_Tags : GTLRObject
@end
 ...
 */
@interface GTLRDataprocMetastore_StatusProto : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) GTLRDataprocMetastore_MessageSet *messageSet;
