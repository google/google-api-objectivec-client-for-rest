 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeSecurityPostureCloudPlatform;
...
/**
 *  Service for executing Security Posture API queries.
 *
 *  Defines, assesses, and monitors the overall status of your security in
 *  Google Cloud. You can use security postures to evaluate your current cloud
 *  security against defined benchmarks and help maintain the level of security
 *  that your organization requires.
 */
@interface GTLRSecurityPostureService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRSecurityPostureQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
