...
@implementation GTLRBigtableAdminQuery_ProjectsInstancesTablesViewsGetIamPolicy
...
+ (instancetype)queryWithObject:(GTLRBigtableAdmin_GetIamPolicyRequest *)object
  ...
  NSArray *pathParams = @[ @"resource" ];
  NSString *pathURITemplate = @"v2/{+resource}:getIamPolicy";
  GTLRBigtableAdminQuery_ProjectsInstancesTablesViewsGetIamPolicy *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"POST"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  query.resource = resource;
  query.expectedObjectClass = [GTLRBigtableAdmin_Policy class];
  query.loggingName = @"bigtableadmin.projects.instances.tables.views.getIamPolicy";
  return query;
}

@end

@implementation GTLRBigtableAdminQuery_ProjectsInstancesTablesViewsSetIamPolicy
...
+ (instancetype)queryWithObject:(GTLRBigtableAdmin_SetIamPolicyRequest *)object
  ...
  NSArray *pathParams = @[ @"resource" ];
  NSString *pathURITemplate = @"v2/{+resource}:setIamPolicy";
  GTLRBigtableAdminQuery_ProjectsInstancesTablesViewsSetIamPolicy *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"POST"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  query.resource = resource;
  query.expectedObjectClass = [GTLRBigtableAdmin_Policy class];
  query.loggingName = @"bigtableadmin.projects.instances.tables.views.setIamPolicy";
  return query;
}

@end

@implementation GTLRBigtableAdminQuery_ProjectsInstancesTablesViewsTestIamPermissions
...
+ (instancetype)queryWithObject:(GTLRBigtableAdmin_TestIamPermissionsRequest *)object
  ...
  NSArray *pathParams = @[ @"resource" ];
  NSString *pathURITemplate = @"v2/{+resource}:testIamPermissions";
  GTLRBigtableAdminQuery_ProjectsInstancesTablesViewsTestIamPermissions *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"POST"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  query.resource = resource;
  query.expectedObjectClass = [GTLRBigtableAdmin_TestIamPermissionsResponse class];
  query.loggingName = @"bigtableadmin.projects.instances.tables.views.testIamPermissions";
  return query;
}
