...
NSString * const kGTLRContainer_AnonymousAuthenticationConfig_Mode_Enabled = @"ENABLED";
NSString * const kGTLRContainer_AnonymousAuthenticationConfig_Mode_Limited = @"LIMITED";
NSString * const kGTLRContainer_AnonymousAuthenticationConfig_Mode_ModeUnspecified = @"MODE_UNSPECIFIED";
...
NSString * const kGTLRContainer_AutoMonitoringConfig_Scope_ScopeUnspecified = @"SCOPE_UNSPECIFIED";
...
NSString * const kGTLRContainer_DataplaneV2Config_ScalabilityMode_Disabled = @"DISABLED";
NSString * const kGTLRContainer_DataplaneV2Config_ScalabilityMode_ScalabilityModeUnspecified = @"SCALABILITY_MODE_UNSPECIFIED";
NSString * const kGTLRContainer_DataplaneV2Config_ScalabilityMode_ScaleOptimized = @"SCALE_OPTIMIZED";

// GTLRContainer_DesiredEnterpriseConfig.desiredTier
NSString * const kGTLRContainer_DesiredEnterpriseConfig_DesiredTier_ClusterTierUnspecified = @"CLUSTER_TIER_UNSPECIFIED";
NSString * const kGTLRContainer_DesiredEnterpriseConfig_DesiredTier_Enterprise = @"ENTERPRISE";
NSString * const kGTLRContainer_DesiredEnterpriseConfig_DesiredTier_Standard = @"STANDARD";

// GTLRContainer_DisruptionEvent.disruptionType
NSString * const kGTLRContainer_DisruptionEvent_DisruptionType_DisruptionTypeUnspecified = @"DISRUPTION_TYPE_UNSPECIFIED";
NSString * const kGTLRContainer_DisruptionEvent_DisruptionType_PodNotEnoughPdb = @"POD_NOT_ENOUGH_PDB";
NSString * const kGTLRContainer_DisruptionEvent_DisruptionType_PodPdbViolation = @"POD_PDB_VIOLATION";
...
NSString * const kGTLRContainer_EnterpriseConfig_DesiredTier_ClusterTierUnspecified = @"CLUSTER_TIER_UNSPECIFIED";
NSString * const kGTLRContainer_EnterpriseConfig_DesiredTier_Enterprise = @"ENTERPRISE";
NSString * const kGTLRContainer_EnterpriseConfig_DesiredTier_Standard = @"STANDARD";
...
NSString * const kGTLRContainer_HostConfig_Capabilities_HostCapabilityPull = @"HOST_CAPABILITY_PULL";
NSString * const kGTLRContainer_HostConfig_Capabilities_HostCapabilityPush = @"HOST_CAPABILITY_PUSH";
NSString * const kGTLRContainer_HostConfig_Capabilities_HostCapabilityResolve = @"HOST_CAPABILITY_RESOLVE";
NSString * const kGTLRContainer_HostConfig_Capabilities_HostCapabilityUnspecified = @"HOST_CAPABILITY_UNSPECIFIED";
...
NSString * const kGTLRContainer_ManagedOpenTelemetryConfig_Scope_CollectionAndInstrumentationComponents = @"COLLECTION_AND_INSTRUMENTATION_COMPONENTS";
NSString * const kGTLRContainer_ManagedOpenTelemetryConfig_Scope_None = @"NONE";
NSString * const kGTLRContainer_ManagedOpenTelemetryConfig_Scope_ScopeUnspecified = @"SCOPE_UNSPECIFIED";
...
NSString * const kGTLRContainer_MonitoringComponentConfig_EnableComponents_Jobset = @"JOBSET";
...
NSString * const kGTLRContainer_NodeConfig_EffectiveCgroupMode_EffectiveCgroupModeUnspecified = @"EFFECTIVE_CGROUP_MODE_UNSPECIFIED";
NSString * const kGTLRContainer_NodeConfig_EffectiveCgroupMode_EffectiveCgroupModeV1 = @"EFFECTIVE_CGROUP_MODE_V1";
NSString * const kGTLRContainer_NodeConfig_EffectiveCgroupMode_EffectiveCgroupModeV2 = @"EFFECTIVE_CGROUP_MODE_V2";
...
NSString * const kGTLRContainer_NodeCreationConfig_NodeCreationMode_ModeUnspecified = @"MODE_UNSPECIFIED";
NSString * const kGTLRContainer_NodeCreationConfig_NodeCreationMode_ViaControlPlane = @"VIA_CONTROL_PLANE";
NSString * const kGTLRContainer_NodeCreationConfig_NodeCreationMode_ViaKubelet = @"VIA_KUBELET";
...
NSString * const kGTLRContainer_RollbackSafeUpgradeStatus_Mode_KcpMinorUpgradeRollbackSafeMode = @"KCP_MINOR_UPGRADE_ROLLBACK_SAFE_MODE";
NSString * const kGTLRContainer_RollbackSafeUpgradeStatus_Mode_ModeUnspecified = @"MODE_UNSPECIFIED";
...
NSString * const kGTLRContainer_StatusCondition_Code_CloudKmsKeyDestroyed = @"CLOUD_KMS_KEY_DESTROYED";
...
NSString * const kGTLRContainer_StatusCondition_Code_NodeServiceAccountMissingPermissions = @"NODE_SERVICE_ACCOUNT_MISSING_PERMISSIONS";
...
NSString * const kGTLRContainer_UpgradeInfoEvent_EventType_DisruptionEvent = @"DISRUPTION_EVENT";
...
NSString * const kGTLRContainer_UpgradeInfoEvent_ResourceType_NodePool = @"NODE_POOL";
NSString * const kGTLRContainer_UpgradeInfoEvent_ResourceType_UpgradeResourceTypeUnspecified = @"UPGRADE_RESOURCE_TYPE_UNSPECIFIED";
...
+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"podIpv4RangeNames" : [NSString class]
  };
  return map;
}
...
@dynamic agentSandboxConfig, cloudRunConfig, configConnectorConfig,
         dnsCacheConfig, gcePersistentDiskCsiDriverConfig,
         gcpFilestoreCsiDriverConfig, gcsFuseCsiDriverConfig,
         gkeBackupAgentConfig, highScaleCheckpointingConfig,
         horizontalPodAutoscaling, httpLoadBalancing, kubernetesDashboard,
         lustreCsiDriverConfig, networkPolicyConfig, nodeReadinessConfig,
         parallelstoreCsiDriverConfig, podSnapshotConfig, rayOperatorConfig,
         sliceControllerConfig, slurmOperatorConfig, statefulHaConfig;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_AgentSandboxConfig
//

@implementation GTLRContainer_AgentSandboxConfig
@dynamic enabled;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_AutoMonitoringConfig
//

@implementation GTLRContainer_AutoMonitoringConfig
@dynamic scope;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_AutopilotConfig
//

@implementation GTLRContainer_AutopilotConfig
@dynamic enabled;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_CertificateConfig
//

@implementation GTLRContainer_CertificateConfig
@dynamic gcpSecretManagerSecretUri;
@end


// ----------------------------------------------------------------------------
//
//   GTLRContainer_CertificateConfigPair
//

@implementation GTLRContainer_CertificateConfigPair
@dynamic cert, key;
@end
...
@dynamic addonsConfig, alphaClusterFeatureGates, anonymousAuthenticationConfig,
         ...
         costManagementConfig, createTime, currentEmulatedVersion,
         ...
         loggingService, maintenancePolicy,
         ...
         networkPolicy, nodeConfig, nodeCreationConfig, nodeIpv4CidrSize,
         nodePoolAutoConfig, nodePoolDefaults, nodePools, notificationConfig,
         parentProductConfig, podAutoscaling, privateClusterConfig,
         rbacBindingConfig, releaseChannel, resourceLabels,
         resourceUsageExportConfig, rollbackSafeUpgrade, satisfiesPzi,
         satisfiesPzs, scheduleUpgradeConfig, secretManagerConfig,
...
@dynamic additionalPodRangesConfig, desiredAdditionalIpRangesConfig,
         ...
         desiredEmulatedVersion, desiredEnableCiliumClusterwideNetworkPolicy,
         ...
         desiredIdentityServiceConfig, desiredImage, desiredImageProject,
         desiredImageType, desiredIntraNodeVisibilityConfig,
         desiredInTransitEncryptionConfig, desiredK8sBetaApis,
         desiredL4ilbSubsettingConfig, desiredLocations, desiredLoggingConfig,
         desiredLoggingService, desiredManagedMachineLearningDiagnosticsConfig,
         ...
         desiredNetworkTierConfig, desiredNodeCreationConfig,
         ...
         desiredResourceUsageExportConfig, desiredRollbackSafeUpgrade,
         desiredSecretManagerConfig, desiredSecretSyncConfig,
...
@dynamic autoUpgradeStatus, endOfExtendedSupportTimestamp,
         ...
         pausedReason, rollbackSafeUpgradeStatus, upgradeDetails;
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_CompleteControlPlaneUpgradeRequest
//

@implementation GTLRContainer_CompleteControlPlaneUpgradeRequest
@dynamic version;
@end
...
@implementation GTLRContainer_ControlPlaneEndpointsConfig
@dynamic dnsEndpointConfig, ipEndpointsConfig;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_CustomImageConfig
//
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_DataplaneV2Config
//

@implementation GTLRContainer_DataplaneV2Config
@dynamic scalabilityMode;
@end
...
@dynamic privateRegistryAccessConfig, registryHosts, writableCgroups;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"registryHosts" : [GTLRContainer_RegistryHostConfig class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_DesiredAdditionalIPRangesConfig
//

@implementation GTLRContainer_DesiredAdditionalIPRangesConfig
@dynamic additionalIpRangesConfigs;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"additionalIpRangesConfigs" : [GTLRContainer_AdditionalIPRangesConfig class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_DesiredEnterpriseConfig
//
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_DiskIoScheduler
//

@implementation GTLRContainer_DiskIoScheduler
@dynamic nodeAttachedDiskIoScheduler, nodeSystemIoScheduler;
@end
...
@implementation GTLRContainer_DisruptionEvent
@dynamic disruptionType, pdbBlockedNode, pdbBlockedPod, pdbViolationTimeout;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"pdbBlockedPod" : [GTLRContainer_PdbBlockedPod class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_DNSEndpointConfig
//
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_ExclusionUntilEndOfSupport
//

@implementation GTLRContainer_ExclusionUntilEndOfSupport
@dynamic enabled, endTime, startTime;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_GkeAutoUpgradeConfig
//

@implementation GTLRContainer_GkeAutoUpgradeConfig
@dynamic patchMode;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_HostConfig
//

@implementation GTLRContainer_HostConfig
@dynamic ca, capabilities, client, dialTimeout, header, host, overridePath;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"ca" : [GTLRContainer_CertificateConfig class],
    @"capabilities" : [NSString class],
    @"client" : [GTLRContainer_CertificateConfigPair class],
    @"header" : [GTLRContainer_RegistryHeader class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_IPEndpointsConfig
//

@implementation GTLRContainer_IPEndpointsConfig
@dynamic authorizedNetworksConfig, enabled, enablePublicEndpoint, globalAccess,
         privateEndpoint, privateEndpointSubnetwork, publicEndpoint;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_KubeletCertInfo
//

@implementation GTLRContainer_KubeletCertInfo
@dynamic nonTpmBootstrapCertExpireTime, tpmBootstrapCertExpireTime;
@end
...
@dynamic accurateTimeConfig, cgroupMode, customNodeInit, diskIoScheduler,
         hugepages, nodeKernelModuleLoading, nodeVfioConfig, swapConfig,
         sysctls, transparentHugepageDefrag, transparentHugepageEnabled;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_ManagedOpenTelemetryConfig
//

@implementation GTLRContainer_ManagedOpenTelemetryConfig
@dynamic scope;
@end
...
@dynamic autoMonitoringConfig, enabled;
@end
...
@dynamic datapathProvider, dataplaneV2Config, defaultEnablePrivateNodes,
         defaultSnatStatus, disableL4LbFirewallReconciliation, dnsConfig,
...
@dynamic accelerators, advancedMachineFeatures, bootDisk, bootDiskKmsKey,
         ...
         metadata, minCpuPlatform, nodeGroup, nodeImageConfig, oauthScopes,
         preemptible, reservationAffinity, resourceLabels, resourceManagerTags,
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_NodeCreationConfig
//

@implementation GTLRContainer_NodeCreationConfig
@dynamic nodeCreationMode;
@end


// ----------------------------------------------------------------------------
//
//   GTLRContainer_NodeDrainConfig
//

@implementation GTLRContainer_NodeDrainConfig
@dynamic graceTerminationDuration, pdbTimeoutDuration,
...
+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"allowedUnsafeSysctls" : [NSString class]
  };
  return map;
}
...
@dynamic acceleratorNetworkProfile, additionalNodeNetworkConfigs,
         ...
         network, networkPerformanceConfig, networkTierConfig,
...
@dynamic autopilotConfig, autoscaling, bestEffortProvisioning, conditions,
         config, ETag, initialNodeCount, instanceGroupUrls, kubeletCertInfo,
         locations, maintenancePolicy, management, maxPodsConstraint, name,
         networkConfig, nodeDrainConfig, placementPolicy, podIpv4CidrSize,
         queuedProvisioning, selfLink, status, statusMessage, updateInfo,
...
@dynamic linuxNodeConfig, networkTags, nodeKubeletConfig, resourceManagerTags;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_NodePoolMaintenancePolicy
//

@implementation GTLRContainer_NodePoolMaintenancePolicy
@dynamic exclusionUntilEndOfSupport;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_NodeVfioConfig
//

@implementation GTLRContainer_NodeVfioConfig
@dynamic dmaEntryLimit;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_ParallelstoreCsiDriverConfig
//

@implementation GTLRContainer_ParallelstoreCsiDriverConfig
@dynamic enabled;
@end
...
@implementation GTLRContainer_PdbBlockedPod
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_RegistryHeader
//

@implementation GTLRContainer_RegistryHeader
@dynamic key, value;
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_RegistryHostConfig
//

@implementation GTLRContainer_RegistryHostConfig
@dynamic hosts, server;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"hosts" : [GTLRContainer_HostConfig class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_RollbackSafeUpgrade
//

@implementation GTLRContainer_RollbackSafeUpgrade
@dynamic controlPlaneSoakDuration;
@end


// ----------------------------------------------------------------------------
//
//   GTLRContainer_RollbackSafeUpgradeStatus
//

@implementation GTLRContainer_RollbackSafeUpgradeStatus
@dynamic controlPlaneUpgradeRollbackEndTime, mode, previousVersion;
@end
...
@dynamic endTime, initialEmulatedVersion, initialVersion, startTime, startType,
         state, targetEmulatedVersion, targetVersion;
@end
...
@dynamic currentEmulatedVersion, currentVersion, operation, operationStartTime,
         resource, resourceType, targetEmulatedVersion, targetVersion;
@end


// ----------------------------------------------------------------------------
//
//   GTLRContainer_UpgradeInfoEvent
//

@implementation GTLRContainer_UpgradeInfoEvent
@dynamic currentEmulatedVersion, currentVersion, descriptionProperty,
         disruptionEvent, endTime, eventType, extendedSupportEndTime, operation,
         resource, resourceType, standardSupportEndTime, startTime, state,
         targetEmulatedVersion, targetVersion;
...
// ----------------------------------------------------------------------------
//
//   GTLRContainer_UserManagedKeysConfig
//

@implementation GTLRContainer_UserManagedKeysConfig
@dynamic aggregationCa, clusterCa, controlPlaneDiskEncryptionKey,
         controlPlaneDiskEncryptionKeyVersions, etcdApiCa, etcdPeerCa,
         gkeopsEtcdBackupEncryptionKey, serviceAccountSigningKeys,
         serviceAccountVerificationKeys;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"controlPlaneDiskEncryptionKeyVersions" : [NSString class],
    @"serviceAccountSigningKeys" : [NSString class],
    @"serviceAccountVerificationKeys" : [NSString class]
  };
  return map;
}
