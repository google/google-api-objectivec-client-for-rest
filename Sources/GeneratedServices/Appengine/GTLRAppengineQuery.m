...
@implementation GTLRAppengineQuery_ProjectsLocationsApplicationsGet
...
+ (instancetype)queryWithProjectsId:(NSString *)projectsId
  ...
  GTLRAppengineQuery_ProjectsLocationsApplicationsGet *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:nil
                       pathParameterNames:pathParams];
  query.projectsId = projectsId;
  ...
  query.expectedObjectClass = [GTLRAppengine_Application class];
  query.loggingName = @"appengine.projects.locations.applications.get";
  return query;
}

@end

@implementation GTLRAppengineQuery_ProjectsLocationsApplicationsRepair
...
+ (instancetype)queryWithObject:(GTLRAppengine_RepairApplicationRequest *)object
  ...
  NSString *pathURITemplate = @"v1/projects/{projectsId}/locations/{locationsId}/applications/{applicationsId}:repair";
  GTLRAppengineQuery_ProjectsLocationsApplicationsRepair *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"POST"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  ...
  query.applicationsId = applicationsId;
  query.expectedObjectClass = [GTLRAppengine_Operation class];
  query.loggingName = @"appengine.projects.locations.applications.repair";
  return query;
}

@end

@implementation GTLRAppengineQuery_ProjectsLocationsApplicationsServicesGet
...
+ (instancetype)queryWithProjectsId:(NSString *)projectsId
  ...
  GTLRAppengineQuery_ProjectsLocationsApplicationsServicesGet *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:nil
                       pathParameterNames:pathParams];
  query.projectsId = projectsId;
  ...
  query.servicesId = servicesId;
  query.expectedObjectClass = [GTLRAppengine_Service class];
  query.loggingName = @"appengine.projects.locations.applications.services.get";
  return query;
}

@end

@implementation GTLRAppengineQuery_ProjectsLocationsApplicationsServicesList
...
+ (instancetype)queryWithProjectsId:(NSString *)projectsId
  ...
  NSString *pathURITemplate = @"v1/projects/{projectsId}/locations/{locationsId}/applications/{applicationsId}/services";
  GTLRAppengineQuery_ProjectsLocationsApplicationsServicesList *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:nil
                       pathParameterNames:pathParams];
  query.projectsId = projectsId;
  ...
  query.applicationsId = applicationsId;
  query.expectedObjectClass = [GTLRAppengine_ListServicesResponse class];
  query.loggingName = @"appengine.projects.locations.applications.services.list";
  return query;
}
