 ...
 *  Console Activity Log.
 *
 *  Method: appengine.projects.locations.applications.repair
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeAppengineCloudPlatform
 */
@interface GTLRAppengineQuery_ProjectsLocationsApplicationsRepair : GTLRAppengineQuery
 ...
 *  @param object The @c GTLRAppengine_RepairApplicationRequest to include in
 *    the query.
 *  @param projectsId Part of `name`. Name of the application to repair.
 *    Example: apps/myapp
 *  @param locationsId Part of `name`. See documentation of `projectsId`.
 *  @param applicationsId Part of `name`. See documentation of `projectsId`.
 *
 *  @return GTLRAppengineQuery_ProjectsLocationsApplicationsRepair
 */
+ (instancetype)queryWithObject:(GTLRAppengine_RepairApplicationRequest *)object
                     projectsId:(NSString *)projectsId
                    locationsId:(NSString *)locationsId
 ...
 *  Gets the current configuration of the specified service.
 *
 *  Method: appengine.projects.locations.applications.services.get
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeAppengineAdmin
 *    @c kGTLRAuthScopeAppengineCloudPlatform
 *    @c kGTLRAuthScopeAppengineCloudPlatformReadOnly
 */
@interface GTLRAppengineQuery_ProjectsLocationsApplicationsServicesGet : GTLRAppengineQuery
 ...
 *
 *  @return GTLRAppengineQuery_ProjectsLocationsApplicationsServicesGet
 */
+ (instancetype)queryWithProjectsId:(NSString *)projectsId
                        locationsId:(NSString *)locationsId
                     applicationsId:(NSString *)applicationsId
 ...
 *  Lists all the services in the application.
 *
 *  Method: appengine.projects.locations.applications.services.list
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeAppengineAdmin
 *    @c kGTLRAuthScopeAppengineCloudPlatform
 *    @c kGTLRAuthScopeAppengineCloudPlatformReadOnly
 */
@interface GTLRAppengineQuery_ProjectsLocationsApplicationsServicesList : GTLRAppengineQuery
 ...
 *
 *  @return GTLRAppengineQuery_ProjectsLocationsApplicationsServicesList
 *
 *  @note Automatic pagination will be done when @c shouldFetchNextPages is
 *        enabled. See @c shouldFetchNextPages on @c GTLRService for more
 *        information.
