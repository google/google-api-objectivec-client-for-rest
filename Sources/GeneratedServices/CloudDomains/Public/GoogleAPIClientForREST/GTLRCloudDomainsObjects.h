...
/**
 *  Due to SquareSpace's constraints, the auto-renewal update you made may not
 *  be effective during a certain period of time. Generally, the time period is
 *  15 days before expiration for generic TLD domains, and 15 days before
 *  expiration + 3 days after expiration for country-code TLD domains.
 *
 *  Value: "AUTO_RENEWAL_UPDATE_NOT_EFFECTIVE"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudDomains_Registration_Issues_AutoRenewalUpdateNotEffective;
/**
