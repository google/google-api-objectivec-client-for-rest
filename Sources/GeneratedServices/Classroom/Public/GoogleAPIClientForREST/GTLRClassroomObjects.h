...
@class GTLRClassroom_AddOnAttachment;
...
@class GTLRClassroom_CopyHistory;
 ...
 *  Value: "CREATED"
 */
FOUNDATION_EXTERN NSString * const kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_Created;
/**
 ...
 *  Value: "NEW"
 */
FOUNDATION_EXTERN NSString * const kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_New;
/**
 *  Student chose to "unsubmit" the assignment.
 *
 *  Value: "RECLAIMED_BY_STUDENT"
 */
FOUNDATION_EXTERN NSString * const kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_ReclaimedByStudent;
/**
 *  Has been returned to the student.
 *
 *  Value: "RETURNED"
 */
FOUNDATION_EXTERN NSString * const kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_Returned;
/**
 *  No state specified. This should never be returned.
 *
 *  Value: "SUBMISSION_STATE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_SubmissionStateUnspecified;
/**
 *  Has been turned in to the teacher.
 *
 *  Value: "TURNED_IN"
 */
FOUNDATION_EXTERN NSString * const kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_TurnedIn;
 ...
 */
@interface GTLRClassroom_AddOnAttachment : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRClassroom_CopyHistory *> *copyHistory NS_RETURNS_NOT_RETAINED;
 ...
 *  is set. Set to a non-zero value to indicate that the attachment supports
 *  grade passback. If set, this must be a non-negative integer value. When set
 *  to zero, the attachment will not support grade passback.
 *
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_Created
 *        Has been created. (Value: "CREATED")
 *    @arg @c kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_New
 *        The student has never accessed this submission. Attachments are not
 *        returned and timestamps is not set. (Value: "NEW")
 *    @arg @c kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_ReclaimedByStudent
 *        Student chose to "unsubmit" the assignment. (Value:
 *        "RECLAIMED_BY_STUDENT")
 *    @arg @c kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_Returned
 *        Has been returned to the student. (Value: "RETURNED")
 *    @arg @c kGTLRClassroom_AddOnAttachmentStudentSubmission_PostSubmissionState_SubmissionStateUnspecified
 ...
 *        Has been turned in to the teacher. (Value: "TURNED_IN")
 */
 ...
 *  specific post.
 */
@interface GTLRClassroom_AddOnContext : GTLRObject
...
/**
 *  Add-on context corresponding to the requesting user's role as a student. Its
 *  presence implies that the requesting user is a student in the course.
 */
@property(nonatomic, strong, nullable) GTLRClassroom_StudentContext *studentContext;
 ...
 */
@property(nonatomic, strong, nullable) NSNumber *supportsStudentWork;

/**
 *  Add-on context corresponding to the requesting user's role as a teacher. Its
 *  presence implies that the requesting user is a teacher in the course.
 */
@property(nonatomic, strong, nullable) GTLRClassroom_TeacherContext *teacherContext;
 ...
 */
@interface GTLRClassroom_CopyHistory : GTLRObject
 ...
 */
@interface GTLRClassroom_EmbedUri : GTLRObject
 ...
 *        its "addOnAttachments" property. If returned as the result of a query,
 *        it should support automatic pagination (when @c shouldFetchNextPages
 *        is enabled).
 */
@interface GTLRClassroom_ListAddOnAttachmentsResponse : GTLRCollectionObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRClassroom_AddOnAttachment *> *addOnAttachments;
 ...
 */
@interface GTLRClassroom_StudentContext : GTLRObject
 ...
 */
@interface GTLRClassroom_TeacherContext : GTLRObject
@end
