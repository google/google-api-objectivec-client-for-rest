 ...
 *  Composer data and see the email address for your Google Account
 *
 *  Value "https://www.googleapis.com/auth/cloudcomposer"
 */
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeCloudComposerCloudPlatform;
