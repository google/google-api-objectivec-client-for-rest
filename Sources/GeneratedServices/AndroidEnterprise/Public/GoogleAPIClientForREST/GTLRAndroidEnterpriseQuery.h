 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidEnterpriseEnrollmentTokenEnrollmentTokenTypeEnrollmentTokenTypeUnspecified;
/**
 *  The enrollment token is for a user device.
 *
 *  Value: "userDevice"
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidEnterpriseEnrollmentTokenEnrollmentTokenTypeUserDevice;
/**
 *  The enrollment token is for a userless device.
 *
 *  Value: "userlessDevice"
 */
FOUNDATION_EXTERN NSString * const kGTLRAndroidEnterpriseEnrollmentTokenEnrollmentTokenTypeUserlessDevice;
 ...
 */
@property(nonatomic, copy, nullable) NSString *deviceType GTLR_DEPRECATED;
 ...
 *  hour.
 */
@property(nonatomic, strong, nullable) GTLRDuration *enrollmentTokenDuration;

/**
 *  [Required] The type of the enrollment token.
 *
 *  Likely values:
 *    @arg @c kGTLRAndroidEnterpriseEnrollmentTokenEnrollmentTokenTypeEnrollmentTokenTypeUnspecified
 *        The value is unused. (Value: "enrollmentTokenTypeUnspecified")
 *    @arg @c kGTLRAndroidEnterpriseEnrollmentTokenEnrollmentTokenTypeUserlessDevice
 *        The enrollment token is for a userless device. (Value:
 *        "userlessDevice")
 *    @arg @c kGTLRAndroidEnterpriseEnrollmentTokenEnrollmentTokenTypeUserDevice
 *        The enrollment token is for a user device. (Value: "userDevice")
 */
@property(nonatomic, copy, nullable) NSString *enrollmentTokenEnrollmentTokenType;
 ...
 */
@property(nonatomic, copy, nullable) NSString *enrollmentTokenToken;
