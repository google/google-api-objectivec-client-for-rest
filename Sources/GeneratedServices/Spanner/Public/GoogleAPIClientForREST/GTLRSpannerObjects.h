 ...
 *  database within the instance. Once created, the default backup schedule can
 *  be edited or deleted just like any other backup schedule. Currently, the
 *  default backup schedule creates a full backup every 24 hours and retains the
 *  backup for a period of 7 days.
 *
 *  Value: "AUTOMATIC"
 */
 ...
 *        default backup schedule will be created automatically on creation of a
 *        database within the instance. Once created, the default backup
 *        schedule can be edited or deleted just like any other backup schedule.
 *        Currently, the default backup schedule creates a full backup every 24
 *        hours and retains the backup for a period of 7 days. (Value:
 *        "AUTOMATIC")
 ...
 *    @arg @c kGTLRSpanner_Instance_DefaultBackupScheduleType_None No default
 *        backup schedule will be created automatically on creation of a
 *        database within the instance. (Value: "NONE")
 */
