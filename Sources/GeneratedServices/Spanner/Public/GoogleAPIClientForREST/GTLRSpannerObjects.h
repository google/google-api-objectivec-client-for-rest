 ...
 */
@interface GTLRSpanner_Ack : GTLRObject
 ...
 *  even if the message does not exist. This is useful for unconditionally
 *  acking a message, even if it is missing or has already been acked.
 *
 *  Uses NSNumber of boolValue.
 */
@property(nonatomic, strong, nullable) NSNumber *ignoreNotFound;
 ...
 */
@property(nonatomic, strong, nullable) NSArray *key;
...
/**
 *  Metadata type for the long-running operation returned by `CALL
 *  compact_all()`, which can be executed using ExecuteSql or
 *  ExecuteStreamingSql APIs.
 */
@interface GTLRSpanner_CompactDatabaseMetadata : GTLRObject
...
@property(nonatomic, strong, nullable) GTLRSpanner_Ack *ack;
...
@property(nonatomic, strong, nullable) GTLRSpanner_Send *send;
 ...
 */
@interface GTLRSpanner_Send : GTLRObject
 ...
 *  to the current time.
 */
@property(nonatomic, strong, nullable) GTLRDateTime *deliverTime;
