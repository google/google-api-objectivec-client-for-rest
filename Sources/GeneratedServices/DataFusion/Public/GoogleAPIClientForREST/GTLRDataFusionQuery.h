 ...
 *
 *  Method: datafusion.projects.locations.instances.dnsPeerings.create
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeDataFusionCloudPlatform
 */
@interface GTLRDataFusionQuery_ProjectsLocationsInstancesDnsPeeringsCreate : GTLRDataFusionQuery

/** Required. The name of the peering to create. */
@property(nonatomic, copy, nullable) NSString *dnsPeeringId;

/** Required. The resource on which DNS peering will be created. */
@property(nonatomic, copy, nullable) NSString *parent;

/**
 *  Fetches a @c GTLRDataFusion_DnsPeering.
 *
 *  Creates DNS peering on the given resource.
 *
 *  @param object The @c GTLRDataFusion_DnsPeering to include in the query.
 *  @param parent Required. The resource on which DNS peering will be created.
 *
 *  @return GTLRDataFusionQuery_ProjectsLocationsInstancesDnsPeeringsCreate
 */
 ...
 *
 *  Method: datafusion.projects.locations.instances.dnsPeerings.delete
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeDataFusionCloudPlatform
 */
@interface GTLRDataFusionQuery_ProjectsLocationsInstancesDnsPeeringsDelete : GTLRDataFusionQuery
 ...
 *    projects/{project}/locations/{location}/instances/{instance}/dnsPeerings/{dns_peering}
 *
 *  @return GTLRDataFusionQuery_ProjectsLocationsInstancesDnsPeeringsDelete
 */
+ (instancetype)queryWithName:(NSString *)name;
 ...
 *
 *  Method: datafusion.projects.locations.instances.dnsPeerings.list
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeDataFusionCloudPlatform
 */
@interface GTLRDataFusionQuery_ProjectsLocationsInstancesDnsPeeringsList : GTLRDataFusionQuery
...
/**
 *  A page token, received from a previous `ListDnsPeerings` call. Provide this
...
/**
 *  Fetches a @c GTLRDataFusion_ListDnsPeeringsResponse.
 *
 *  Lists DNS peerings for a given resource.
 *
 *  @param parent Required. The parent, which owns this collection of dns
 *    peerings. Format:
 *    projects/{project}/locations/{location}/instances/{instance}
 *
 *  @return GTLRDataFusionQuery_ProjectsLocationsInstancesDnsPeeringsList
 *
