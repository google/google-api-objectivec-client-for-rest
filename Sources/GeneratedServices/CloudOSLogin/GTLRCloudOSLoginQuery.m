...
#import <GoogleAPIClientForREST/GTLRCloudOSLoginQuery.h>
...
@implementation GTLRCloudOSLoginQuery_UsersProjectsProvisionPosixAccount
...
+ (instancetype)queryWithObject:(GTLRCloudOSLogin_ProvisionPosixAccountRequest *)object
  ...
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"v1/{+name}";
  GTLRCloudOSLoginQuery_UsersProjectsProvisionPosixAccount *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:@"POST"
                       pathParameterNames:pathParams];
  query.bodyObject = object;
  query.name = name;
  query.expectedObjectClass = [GTLRCloudOSLogin_PosixAccount class];
  query.loggingName = @"oslogin.users.projects.provisionPosixAccount";
  return query;
}
