 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeWorkspaceEventsChatUsersAvailability;
/**
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeWorkspaceEventsChatUsersAvailabilityReadonly;
/**
