...
@class GTLRCloudKMS_AddQuorumMember;
...
@class GTLRCloudKMS_Challenge;
@class GTLRCloudKMS_ChallengeReply;
...
@class GTLRCloudKMS_DeleteSingleTenantHsmInstance;
@class GTLRCloudKMS_Digest;
@class GTLRCloudKMS_DisableSingleTenantHsmInstance;
@class GTLRCloudKMS_EkmConnection;
@class GTLRCloudKMS_EnableSingleTenantHsmInstance;
...
@class GTLRCloudKMS_QuorumAuth;
@class GTLRCloudKMS_QuorumParameters;
@class GTLRCloudKMS_QuorumReply;
@class GTLRCloudKMS_RefreshSingleTenantHsmInstance;
@class GTLRCloudKMS_RegisterTwoFactorAuthKeys;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_AutokeyConfig_KeyProjectResolutionMode_DedicatedKeyProject;
/**
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_AutokeyConfig_KeyProjectResolutionMode_ResourceProject;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_KeyAccessJustificationsPolicy_AllowedAccessReasons_ModifiedCustomerInitiatedAccess GTLR_DEPRECATED;
/**
 *  Deprecated: This code is no longer generated by Google Cloud. The
 *  GOOGLE_RESPONSE_TO_PRODUCTION_ALERT justification codes available in both
 *  Key Access Justifications and Access Transparency logs provide
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_KeyAccessJustificationsPolicy_AllowedAccessReasons_ModifiedGoogleInitiatedSystemOperation GTLR_DEPRECATED;
/**
 ...
 *  Value: "ACTIVE"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstance_State_Active;
/**
 *  The SingleTenantHsmInstance is being created.
 *
 *  Value: "CREATING"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstance_State_Creating;
/**
 *  The SingleTenantHsmInstance has been deleted.
 *
 *  Value: "DELETED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstance_State_Deleted;
/**
 ...
 *  Value: "DELETING"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstance_State_Deleting;
/**
 *  The SingleTenantHsmInstance is disabled.
 *
 *  Value: "DISABLED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstance_State_Disabled;
/**
 *  The SingleTenantHsmInstance is being disabled.
 *
 *  Value: "DISABLING"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstance_State_Disabling;
/**
 *  The SingleTenantHsmInstance has failed and can not be recovered or used.
 *
 *  Value: "FAILED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstance_State_Failed;
/**
 ...
 *
 *  Value: "PENDING_TWO_FACTOR_AUTH_REGISTRATION"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstance_State_PendingTwoFactorAuthRegistration;
/**
 *  Not specified.
 *
 *  Value: "STATE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstance_State_StateUnspecified;
 ...
 *  Value: "APPROVED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Approved;
/**
 *  The SingleTenantHsmInstanceProposal is being created.
 *
 *  Value: "CREATING"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Creating;
/**
 ...
 *  Value: "DELETED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Deleted;
/**
 *  The SingleTenantHsmInstanceProposal has failed.
 *
 *  Value: "FAILED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Failed;
/**
 *  The SingleTenantHsmInstanceProposal is pending approval.
 *
 *  Value: "PENDING"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Pending;
/**
 *  The SingleTenantHsmInstanceProposal is being executed.
 *
 *  Value: "RUNNING"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Running;
/**
 *  Not specified.
 *
 *  Value: "STATE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_StateUnspecified;
/**
 *  The SingleTenantHsmInstanceProposal has been executed successfully.
 *
 *  Value: "SUCCEEDED"
 */
FOUNDATION_EXTERN NSString * const kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Succeeded;
 ...
 */
@interface GTLRCloudKMS_AddQuorumMember : GTLRObject
 ...
 */
@interface GTLRCloudKMS_ApproveSingleTenantHsmInstanceProposalRequest : GTLRObject

/** Required. The reply to QuorumParameters for approving the proposal. */
@property(nonatomic, strong, nullable) GTLRCloudKMS_QuorumReply *quorumReply;

/**
 *  Required. The reply to RequiredActionQuorumParameters for approving the
 *  proposal.
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_RequiredActionQuorumReply *requiredActionQuorumReply;
 ...
 */
@interface GTLRCloudKMS_ApproveSingleTenantHsmInstanceProposalResponse : GTLRObject
@end
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRCloudKMS_AutokeyConfig_KeyProjectResolutionMode_DedicatedKeyProject
 *        Keys are created in a dedicated project specified by `key_project`.
 *        (Value: "DEDICATED_KEY_PROJECT")
 *    @arg @c kGTLRCloudKMS_AutokeyConfig_KeyProjectResolutionMode_Disabled
 ...
 */
@interface GTLRCloudKMS_Challenge : GTLRObject
 ...
 */
@interface GTLRCloudKMS_ChallengeReply : GTLRObject
 ...
 *  web-safe format).
 */
@property(nonatomic, copy, nullable) NSString *signedChallenge;
 ...
 */
@interface GTLRCloudKMS_DeleteSingleTenantHsmInstance : GTLRObject
@end
 ...
 */
@interface GTLRCloudKMS_DisableSingleTenantHsmInstance : GTLRObject
@end
 ...
 */
@interface GTLRCloudKMS_Empty : GTLRObject
@end
 ...
 */
@interface GTLRCloudKMS_EnableSingleTenantHsmInstance : GTLRObject
@end
 ...
 */
@interface GTLRCloudKMS_ExecuteSingleTenantHsmInstanceProposalRequest : GTLRObject
@end
 ...
 *  to additional ProtectionLevels in the future. Supported resources: *
 ...
 *
 *  @note This class supports NSFastEnumeration and indexed subscripting over
 *        its "singleTenantHsmInstanceProposals" property. If returned as the
 *        result of a query, it should support automatic pagination (when @c
 *        shouldFetchNextPages is enabled).
 */
@interface GTLRCloudKMS_ListSingleTenantHsmInstanceProposalsResponse : GTLRCollectionObject
 ...
 *        subscripting on this class.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudKMS_SingleTenantHsmInstanceProposal *> *singleTenantHsmInstanceProposals;
 ...
 *
 *  @note This class supports NSFastEnumeration and indexed subscripting over
 *        its "singleTenantHsmInstances" property. If returned as the result of
 *        a query, it should support automatic pagination (when @c
 *        shouldFetchNextPages is enabled).
 */
@interface GTLRCloudKMS_ListSingleTenantHsmInstancesResponse : GTLRCollectionObject
 ...
 *        subscripting on this class.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudKMS_SingleTenantHsmInstance *> *singleTenantHsmInstances;
 ...
 */
@interface GTLRCloudKMS_QuorumAuth : GTLRObject
 ...
 *  Uses NSNumber of intValue.
 */
@property(nonatomic, strong, nullable) NSNumber *requiredApproverCount;

/**
 *  Required. The total number of approvers. This is the N value used for M of N
 *  quorum auth. Must be greater than or equal to 3 and less than or equal to
 *  16.
 *
 *  Uses NSNumber of intValue.
 */
@property(nonatomic, strong, nullable) NSNumber *totalApproverCount;

/**
 *  Output only. The public keys associated with the 2FA keys for M of N quorum
 *  auth.
 */
@property(nonatomic, strong, nullable) NSArray<NSString *> *twoFactorPublicKeyPems;
 ...
 */
@interface GTLRCloudKMS_QuorumParameters : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<NSString *> *approvedTwoFactorPublicKeyPems;
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudKMS_Challenge *> *challenges;

/**
 *  Output only. The required numbers of approvers. This is the M value used for
 *  M of N quorum auth. It is less than the number of public keys.
 *
 *  Uses NSNumber of intValue.
 */
@property(nonatomic, strong, nullable) NSNumber *requiredApproverCount;
 ...
 */
@interface GTLRCloudKMS_QuorumReply : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudKMS_ChallengeReply *> *challengeReplies;
 ...
 *  operation.
 */
@interface GTLRCloudKMS_RefreshSingleTenantHsmInstance : GTLRObject
@end
 ...
 */
@interface GTLRCloudKMS_RegisterTwoFactorAuthKeys : GTLRObject
 ...
 *  state to perform this operation.
 */
@interface GTLRCloudKMS_RemoveQuorumMember : GTLRObject
 ...
 */
@interface GTLRCloudKMS_RequiredActionQuorumParameters : GTLRObject
 ...
 *  of these challenges are required to be signed to approve the operation.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudKMS_Challenge *> *quorumChallenges;
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudKMS_Challenge *> *requiredChallenges;
 ...
 */
@interface GTLRCloudKMS_RequiredActionQuorumReply : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudKMS_ChallengeReply *> *quorumChallengeReplies;
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudKMS_ChallengeReply *> *requiredChallengeReplies;
 ...
 */
@interface GTLRCloudKMS_SingleTenantHsmInstance : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_QuorumAuth *quorumAuth;

/**
 *  Output only. The state of the SingleTenantHsmInstance.
 *
 *  Likely values:
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstance_State_Active The
 *        SingleTenantHsmInstance is ready to use. A SingleTenantHsmInstance
 *        must be in the ACTIVE state for all CryptoKeys created within the
 *        SingleTenantHsmInstance to be usable. (Value: "ACTIVE")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstance_State_Creating The
 *        SingleTenantHsmInstance is being created. (Value: "CREATING")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstance_State_Deleted The
 *        SingleTenantHsmInstance has been deleted. (Value: "DELETED")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstance_State_Deleting The
 *        SingleTenantHsmInstance is being deleted. Requests to the instance
 *        will be rejected in this state. (Value: "DELETING")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstance_State_Disabled The
 *        SingleTenantHsmInstance is disabled. (Value: "DISABLED")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstance_State_Disabling The
 *        SingleTenantHsmInstance is being disabled. (Value: "DISABLING")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstance_State_Failed The
 *        SingleTenantHsmInstance has failed and can not be recovered or used.
 *        (Value: "FAILED")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstance_State_PendingTwoFactorAuthRegistration
 *        The SingleTenantHsmInstance is waiting for 2FA keys to be registered.
 *        This can be done by calling CreateSingleTenantHsmInstanceProposal with
 *        the RegisterTwoFactorAuthKeys operation. (Value:
 *        "PENDING_TWO_FACTOR_AUTH_REGISTRATION")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstance_State_StateUnspecified Not
 ...
 */
@interface GTLRCloudKMS_SingleTenantHsmInstanceProposal : GTLRObject
 ...
 *  state to perform this operation.
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_AddQuorumMember *addQuorumMember;
 ...
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_DeleteSingleTenantHsmInstance *deleteSingleTenantHsmInstance;
 ...
 *  the ACTIVE state to perform this operation.
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_DisableSingleTenantHsmInstance *disableSingleTenantHsmInstance;

/**
 *  Enable the SingleTenantHsmInstance. The SingleTenantHsmInstance must be in
 *  the DISABLED state to perform this operation.
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_EnableSingleTenantHsmInstance *enableSingleTenantHsmInstance;
 ...
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_QuorumParameters *quorumParameters;
 ...
 *  operation.
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_RefreshSingleTenantHsmInstance *refreshSingleTenantHsmInstance;
 ...
 *  operation.
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_RegisterTwoFactorAuthKeys *registerTwoFactorAuthKeys;
 ...
 *  state to perform this operation.
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_RemoveQuorumMember *removeQuorumMember;
 ...
 */
@property(nonatomic, strong, nullable) GTLRCloudKMS_RequiredActionQuorumParameters *requiredActionQuorumParameters;

/**
 *  Output only. The state of the SingleTenantHsmInstanceProposal.
 *
 *  Likely values:
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Approved The
 *        SingleTenantHsmInstanceProposal has been approved. (Value: "APPROVED")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Creating The
 *        SingleTenantHsmInstanceProposal is being created. (Value: "CREATING")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Deleted The
 *        SingleTenantHsmInstanceProposal has been deleted and will be purged
 *        after the purge_time. (Value: "DELETED")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Failed The
 *        SingleTenantHsmInstanceProposal has failed. (Value: "FAILED")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Pending The
 *        SingleTenantHsmInstanceProposal is pending approval. (Value:
 *        "PENDING")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Running The
 *        SingleTenantHsmInstanceProposal is being executed. (Value: "RUNNING")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_StateUnspecified
 *        Not specified. (Value: "STATE_UNSPECIFIED")
 *    @arg @c kGTLRCloudKMS_SingleTenantHsmInstanceProposal_State_Succeeded The
 *        SingleTenantHsmInstanceProposal has been executed successfully.
 *        (Value: "SUCCEEDED")
 */
@property(nonatomic, copy, nullable) NSString *state;
