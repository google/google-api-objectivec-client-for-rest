...
@class GTLRNetworkServices_AgentConnectivityTemplate;
@class GTLRNetworkServices_AgentConnectivityTemplate_Labels;
@class GTLRNetworkServices_AgentGateway;
@class GTLRNetworkServices_AgentGateway_Labels;
@class GTLRNetworkServices_AgentGatewayAgentGatewayOutputCard;
@class GTLRNetworkServices_AgentGatewayGoogleManaged;
...
@class GTLRNetworkServices_DnsPeeringConfig;
@class GTLRNetworkServices_EgressNetworkConfig;
@class GTLRNetworkServices_EgressNetworkConfigTlsConfig;
...
@class GTLRNetworkServices_MulticastConsumerAssociation;
@class GTLRNetworkServices_MulticastConsumerAssociation_Labels;
@class GTLRNetworkServices_MulticastGroupConsumerActivation;
@class GTLRNetworkServices_MulticastGroupConsumerActivation_Labels;
@class GTLRNetworkServices_MulticastLogConfig;
@class GTLRNetworkServices_MulticastResourceState;
 ...
 *
 *  Value: "ACCESS_PATH_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentConnectivityTemplate_AccessPath_AccessPathUnspecified;
/**
 *  Govern agent connections to destinations.
 *
 *  Value: "AGENT_TO_ANYWHERE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentConnectivityTemplate_AccessPath_AgentToAnywhere;
/**
 *  Protect connection to Agent or Tool.
 *
 *  Value: "CLIENT_TO_AGENT"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentConnectivityTemplate_AccessPath_ClientToAgent;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentConnectivityTemplate_AccessTypes_AccessTypeUnspecified;
/**
 *  Private network access.
 *
 *  Value: "PRIVATE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentConnectivityTemplate_AccessTypes_Private;
/**
 ...
 *  Value: "MCP"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentGateway_Protocols_Mcp;
/**
 *  Unspecified protocol.
 *
 *  Value: "PROTOCOL_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentGateway_Protocols_ProtocolUnspecified;
 ...
 *  Value: "AGENT_TO_ANYWHERE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentGatewayGoogleManaged_GovernedAccessPath_AgentToAnywhere;
/**
 *  Protect connection to Agent or Tool.
 *
 *  Value: "CLIENT_TO_AGENT"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentGatewayGoogleManaged_GovernedAccessPath_ClientToAgent;
/**
 *  Governed access path is not specified.
 *
 *  Value: "GOVERNED_ACCESS_PATH_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_AgentGatewayGoogleManaged_GovernedAccessPath_GovernedAccessPathUnspecified;
 ...
 *  Value: "ALL_TRAFFIC"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_EgressNetworkConfig_VpcEgress_AllTraffic;
/**
 *  Only private IP ranges are routed through the VPC connector.
 *
 *  Value: "PRIVATE_RANGES_ONLY"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_EgressNetworkConfig_VpcEgress_PrivateRangesOnly;
/**
 *  Unspecified
 *
 *  Value: "VPC_EGRESS_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_EgressNetworkConfig_VpcEgress_VpcEgressUnspecified;
 ...
 *
 *  Value: "ADDITIONAL_ROOTS_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_EgressNetworkConfigTlsConfig_AdditionalRoots_AdditionalRootsUnspecified;
/**
 *  Trust only the certificates provided in `trust_config`.
 *
 *  Value: "NO_ADDITIONAL_ROOTS"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_EgressNetworkConfigTlsConfig_AdditionalRoots_NoAdditionalRoots;
/**
 *  Trust certificates provided in `trust_config` and publicly trusted roots.
 *
 *  Value: "PUBLICLY_TRUSTED_ROOTS"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_EgressNetworkConfigTlsConfig_AdditionalRoots_PubliclyTrustedRoots;
 ...
 *  Value: "ACTIVE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastConsumerAssociation_ResourceState_Active;
/**
 *  The consumer resource state is not specified.
 *
 *  Value: "CONSUMER_RESOURCE_STATE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastConsumerAssociation_ResourceState_ConsumerResourceStateUnspecified;
/**
 ...
 *  Value: "OBSOLETE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastConsumerAssociation_ResourceState_Obsolete;
 ...
 *  Value: "ACTIVE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastGroupConsumerActivation_ResourceState_Active;
/**
 *  The consumer resource state is not specified.
 *
 *  Value: "CONSUMER_RESOURCE_STATE_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastGroupConsumerActivation_ResourceState_ConsumerResourceStateUnspecified;
/**
 *  The associated admin resource has been deleted. The consumer resource state
 *  becomes obsolete.
 *
 *  Value: "OBSOLETE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastGroupConsumerActivation_ResourceState_Obsolete;
 ...
 *  Value: "ACTIVE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastResourceState_State_Active;
/**
 *  The resource is being created.
 *
 *  Value: "CREATING"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastResourceState_State_Creating;
/**
 *  The resource is failed to be deleted.
 *
 *  Value: "DELETE_FAILED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastResourceState_State_DeleteFailed;
/**
 *  The resource is being deleted.
 *
 *  Value: "DELETING"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastResourceState_State_Deleting;
/**
 ...
 *  Value: "INACTIVE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastResourceState_State_Inactive;
/**
 ...
 *  Value: "OBSOLETE"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastResourceState_State_Obsolete;
/**
 *  The resource is in unspecified state.
 *
 *  Value: "STATE_ENUM_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastResourceState_State_StateEnumUnspecified;
/**
 *  The resource is failed to be updated.
 *
 *  Value: "UPDATE_FAILED"
 */
FOUNDATION_EXTERN NSString * const kGTLRNetworkServices_MulticastResourceState_State_UpdateFailed;
/**
 ...
 */
@interface GTLRNetworkServices_AgentConnectivityTemplate : GTLRObject

/**
 *  Required. Immutable. The path of the access. Maps roughly to ingress/egress,
 *  though we keep CLIENT_TO_AGENT and AGENT_TO_ANYWHERE as carryovers from
 *  Agent Gateway's original resource model. The path is immutable once set.
 *  Exactly one path can be set.
 *
 *  Likely values:
 *    @arg @c kGTLRNetworkServices_AgentConnectivityTemplate_AccessPath_AccessPathUnspecified
 *        Unspecified access path. (Value: "ACCESS_PATH_UNSPECIFIED")
 *    @arg @c kGTLRNetworkServices_AgentConnectivityTemplate_AccessPath_AgentToAnywhere
 *        Govern agent connections to destinations. (Value: "AGENT_TO_ANYWHERE")
 *    @arg @c kGTLRNetworkServices_AgentConnectivityTemplate_AccessPath_ClientToAgent
 *        Protect connection to Agent or Tool. (Value: "CLIENT_TO_AGENT")
 */
@property(nonatomic, copy, nullable) NSString *accessPath;
...
@property(nonatomic, strong, nullable) GTLRNetworkServices_EgressNetworkConfig *egressNetworkConfig;
 ...
 *  resource.
 */
@property(nonatomic, strong, nullable) GTLRNetworkServices_AgentConnectivityTemplate_Labels *labels;
 ...
 */
@interface GTLRNetworkServices_AgentConnectivityTemplate_Labels : GTLRObject
@end
 ...
 *  project.
 */
@property(nonatomic, strong, nullable) GTLRNetworkServices_AgentGatewayGoogleManaged *googleManaged;

/** Optional. Set of label tags associated with the AgentGateway resource. */
@property(nonatomic, strong, nullable) GTLRNetworkServices_AgentGateway_Labels *labels;
 ...
 */
@property(nonatomic, strong, nullable) NSArray<NSString *> *registries;

/**
 *  Optional. Attach to existing Application Load Balancers or Secure Web
 *  Proxies.
 */
@property(nonatomic, strong, nullable) GTLRNetworkServices_AgentGatewaySelfManaged *selfManaged;
 ...
 *        fetch them all at once.
 */
@interface GTLRNetworkServices_AgentGateway_Labels : GTLRObject
@end
 ...
 */
@interface GTLRNetworkServices_AgentGatewayAgentGatewayOutputCard : GTLRObject

/** Output only. mTLS Endpoint associated with this AgentGateway */
@property(nonatomic, copy, nullable) NSString *mtlsEndpoint;

/** Output only. Root Certificates for Agents to validate this AgentGateway */
@property(nonatomic, strong, nullable) NSArray<NSString *> *rootCertificates;

/** Output only. Service Account used by Service Extensions to operate. */
@property(nonatomic, copy, nullable) NSString *serviceExtensionsServiceAccount;
 ...
 */
@interface GTLRNetworkServices_AgentGatewayGoogleManaged : GTLRObject

/**
 *  Optional. Operating Mode of Agent Gateway.
 *
 *  Likely values:
 *    @arg @c kGTLRNetworkServices_AgentGatewayGoogleManaged_GovernedAccessPath_AgentToAnywhere
 *        Govern agent conections to destinations. (Value: "AGENT_TO_ANYWHERE")
 *    @arg @c kGTLRNetworkServices_AgentGatewayGoogleManaged_GovernedAccessPath_ClientToAgent
 *        Protect connection to Agent or Tool. (Value: "CLIENT_TO_AGENT")
 *    @arg @c kGTLRNetworkServices_AgentGatewayGoogleManaged_GovernedAccessPath_GovernedAccessPathUnspecified
 *        Governed access path is not specified. (Value:
 *        "GOVERNED_ACCESS_PATH_UNSPECIFIED")
 */
@property(nonatomic, copy, nullable) NSString *governedAccessPath;
 ...
 */
@interface GTLRNetworkServices_AgentGatewayNetworkConfig : GTLRObject

/**
 *  Optional. Optional DNS peering configuration for connectivity to your
 *  private VPC network.
 */
@property(nonatomic, strong, nullable) GTLRNetworkServices_AgentGatewayNetworkConfigDnsPeeringConfig *dnsPeeringConfig;

/**
 *  Optional. Optional PSC-Interface network attachment for connectivity to your
 *  private VPCs network.
 */
@property(nonatomic, strong, nullable) GTLRNetworkServices_AgentGatewayNetworkConfigEgress *egress;
 ...
 */
@interface GTLRNetworkServices_AgentGatewayNetworkConfigDnsPeeringConfig : GTLRObject
 ...
 */
@interface GTLRNetworkServices_AgentGatewayNetworkConfigEgress : GTLRObject
...
/**
 *  Configuration for Self Managed deployment mode. Attach to existing
 *  Application Load Balancers or Secure Web Proxies.
 */
@interface GTLRNetworkServices_AgentGatewaySelfManaged : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<NSString *> *resourceUris;
 ...
 *  a callout extension: For global AuthzExtension, `service` must be a
 ...
 *  to one of the following: * a [backend
 *  service](https://cloud.google.com/compute/docs/reference/rest/v1/backendServices)
 *  in the format:
 *  `https://www.googleapis.com/compute/v1/projects/{project}/regions/{region}/backendServices/{backendService}`.
 *  * a fully qualified domain name that can be resolved by the Google Cloud
 *  DNS. * `iap.googleapis.com` and it can only be referenced by an AuthzPolicy
 *  with the policyProfile set to REQUEST_AUTHZ. *
...
@property(nonatomic, strong, nullable) GTLRNetworkServices_DnsPeeringConfig *dnsPeeringConfig;
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRNetworkServices_EgressNetworkConfig_VpcEgress_AllTraffic All
 *        outbound traffic is routed through the VPC connector. (Value:
 *        "ALL_TRAFFIC")
 *    @arg @c kGTLRNetworkServices_EgressNetworkConfig_VpcEgress_PrivateRangesOnly
 *        Only private IP ranges are routed through the VPC connector. (Value:
 *        "PRIVATE_RANGES_ONLY")
 *    @arg @c kGTLRNetworkServices_EgressNetworkConfig_VpcEgress_VpcEgressUnspecified
 *        Unspecified (Value: "VPC_EGRESS_UNSPECIFIED")
 */
@property(nonatomic, copy, nullable) NSString *vpcEgress;
 ...
 */
@interface GTLRNetworkServices_EgressNetworkConfigTlsConfig : GTLRObject

/**
 *  Optional. The additional roots to trust.
 *
 *  Likely values:
 *    @arg @c kGTLRNetworkServices_EgressNetworkConfigTlsConfig_AdditionalRoots_AdditionalRootsUnspecified
 *        Unspecified additional roots. (Value: "ADDITIONAL_ROOTS_UNSPECIFIED")
 *    @arg @c kGTLRNetworkServices_EgressNetworkConfigTlsConfig_AdditionalRoots_NoAdditionalRoots
 *        Trust only the certificates provided in `trust_config`. (Value:
 *        "NO_ADDITIONAL_ROOTS")
 *    @arg @c kGTLRNetworkServices_EgressNetworkConfigTlsConfig_AdditionalRoots_PubliclyTrustedRoots
 *        Trust certificates provided in `trust_config` and publicly trusted
 *        roots. (Value: "PUBLICLY_TRUSTED_ROOTS")
 */
@property(nonatomic, copy, nullable) NSString *additionalRoots;
 ...
 *  endpoint. This is typically used for sidecar model where the proxy
 ...
 */
@property(nonatomic, copy, nullable) NSString *clientTlsPolicy GTLR_DEPRECATED;
 ...
 *  data plane. The lifetime of the cookie may be set to a value from 0 to 86400
 ...
 *        its "agentConnectivityTemplates" property. If returned as the result
 *        of a query, it should support automatic pagination (when @c
 *        shouldFetchNextPages is enabled).
 */
@interface GTLRNetworkServices_ListAgentConnectivityTemplatesResponse : GTLRCollectionObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRNetworkServices_AgentConnectivityTemplate *> *agentConnectivityTemplates;
 ...
 *
 *  @note This class supports NSFastEnumeration and indexed subscripting over
 *        its "agentGateways" property. If returned as the result of a query, it
 *        should support automatic pagination (when @c shouldFetchNextPages is
 *        enabled).
 */
@interface GTLRNetworkServices_ListAgentGatewaysResponse : GTLRCollectionObject
 ...
 *        subscripting on this class.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRNetworkServices_AgentGateway *> *agentGateways;
 ...
 *
 *  @note This class supports NSFastEnumeration and indexed subscripting over
 *        its "multicastConsumerAssociations" property. If returned as the
 *        result of a query, it should support automatic pagination (when @c
 *        shouldFetchNextPages is enabled).
 */
@interface GTLRNetworkServices_ListMulticastConsumerAssociationsResponse : GTLRCollectionObject
 ...
 *        subscripting on this class.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRNetworkServices_MulticastConsumerAssociation *> *multicastConsumerAssociations;
 ...
 *
 *  @note This class supports NSFastEnumeration and indexed subscripting over
 *        its "multicastGroupConsumerActivations" property. If returned as the
 *        result of a query, it should support automatic pagination (when @c
 *        shouldFetchNextPages is enabled).
 */
@interface GTLRNetworkServices_ListMulticastGroupConsumerActivationsResponse : GTLRCollectionObject
 ...
 *        subscripting on this class.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRNetworkServices_MulticastGroupConsumerActivation *> *multicastGroupConsumerActivations;
 ...
 */
@interface GTLRNetworkServices_MulticastConsumerAssociation : GTLRObject
 ...
 */
@property(nonatomic, copy, nullable) NSString *multicastDomainActivation;
 ...
 *  consumers close to the multicast infrastructure created for this domain, on
 *  a best effort basis.
 */
@property(nonatomic, copy, nullable) NSString *placementPolicy;
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRNetworkServices_MulticastConsumerAssociation_ResourceState_Active
 *        The consumer resource state is active. (Value: "ACTIVE")
 *    @arg @c kGTLRNetworkServices_MulticastConsumerAssociation_ResourceState_ConsumerResourceStateUnspecified
 *        The consumer resource state is not specified. (Value:
 *        "CONSUMER_RESOURCE_STATE_UNSPECIFIED")
 *    @arg @c kGTLRNetworkServices_MulticastConsumerAssociation_ResourceState_Obsolete
 *        The associated admin resource has been deleted. The consumer resource
 *        state becomes obsolete. (Value: "OBSOLETE")
 */
@property(nonatomic, copy, nullable) NSString *resourceState GTLR_DEPRECATED;

/** Output only. [Output only] The state of the resource. */
@property(nonatomic, strong, nullable) GTLRNetworkServices_MulticastResourceState *state;
 ...
 *        fetch them all at once.
 */
@interface GTLRNetworkServices_MulticastConsumerAssociation_Labels : GTLRObject
@end
 ...
 */
@interface GTLRNetworkServices_MulticastGroupConsumerActivation : GTLRObject
...
/**
 *  Optional. Specifies the logging options for the activities performed related
 *  to the multicast group consumer activation. Defaults to false. If logging is
 *  enabled, logs are exported to Cloud Logging.
 */
@property(nonatomic, strong, nullable) GTLRNetworkServices_MulticastLogConfig *logConfig;
 ...
 */
@property(nonatomic, copy, nullable) NSString *multicastConsumerAssociation;
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRNetworkServices_MulticastGroupConsumerActivation_ResourceState_Active
 *        The consumer resource state is active. (Value: "ACTIVE")
 *    @arg @c kGTLRNetworkServices_MulticastGroupConsumerActivation_ResourceState_ConsumerResourceStateUnspecified
 *        The consumer resource state is not specified. (Value:
 *        "CONSUMER_RESOURCE_STATE_UNSPECIFIED")
 *    @arg @c kGTLRNetworkServices_MulticastGroupConsumerActivation_ResourceState_Obsolete
 *        The associated admin resource has been deleted. The consumer resource
 *        state becomes obsolete. (Value: "OBSOLETE")
 */
@property(nonatomic, copy, nullable) NSString *resourceState GTLR_DEPRECATED;
 ...
 *        fetch them all at once.
 */
@interface GTLRNetworkServices_MulticastGroupConsumerActivation_Labels : GTLRObject
@end
 ...
 */
@interface GTLRNetworkServices_MulticastLogConfig : GTLRObject
 ...
 */
@interface GTLRNetworkServices_MulticastResourceState : GTLRObject

/**
 *  Optional. The state of the multicast resource.
 *
 *  Likely values:
 *    @arg @c kGTLRNetworkServices_MulticastResourceState_State_Active The
 *        resource is in a normal state and ready to use. (Value: "ACTIVE")
 *    @arg @c kGTLRNetworkServices_MulticastResourceState_State_Creating The
 *        resource is being created. (Value: "CREATING")
 *    @arg @c kGTLRNetworkServices_MulticastResourceState_State_DeleteFailed The
 *        resource is failed to be deleted. (Value: "DELETE_FAILED")
 *    @arg @c kGTLRNetworkServices_MulticastResourceState_State_Deleting The
 *        resource is being deleted. (Value: "DELETING")
 *    @arg @c kGTLRNetworkServices_MulticastResourceState_State_Inactive The
 *        multicast consumer resource that is deactivated by the multicast
 *        administrator based on permission. (Value: "INACTIVE")
 *    @arg @c kGTLRNetworkServices_MulticastResourceState_State_Obsolete The
 *        multicast consumer resource that is obsoleted due to multicast admin
 *        setup teardown. (Value: "OBSOLETE")
 *    @arg @c kGTLRNetworkServices_MulticastResourceState_State_StateEnumUnspecified
 *        The resource is in unspecified state. (Value:
 *        "STATE_ENUM_UNSPECIFIED")
 *    @arg @c kGTLRNetworkServices_MulticastResourceState_State_UpdateFailed The
 *        resource is failed to be updated. (Value: "UPDATE_FAILED")
 *    @arg @c kGTLRNetworkServices_MulticastResourceState_State_Updating The
 ...
 *  /locations/ * /namespaces/ * /services/ *`. This field is for Service
 *  Directory integration which will be deprecated soon.
 */
@property(nonatomic, copy, nullable) NSString *service GTLR_DEPRECATED;
 ...
 */
@property(nonatomic, copy, nullable) NSString *serviceId GTLR_DEPRECATED;
