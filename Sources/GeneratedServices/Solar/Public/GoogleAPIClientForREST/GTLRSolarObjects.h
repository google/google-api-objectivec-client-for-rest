...
@class GTLRSolar_BuildingInsightsDetectedArrays;
 ...
 *
 *  Value: "DETECTION_STATUS_ARRAYS_DETECTED"
 */
FOUNDATION_EXTERN NSString * const kGTLRSolar_BuildingInsightsDetectedArrays_DetectionStatus_DetectionStatusArraysDetected;
/**
 *  Detected solar array data is unavailable for this building.
 *
 *  Value: "DETECTION_STATUS_DATA_UNAVAILABLE"
 */
FOUNDATION_EXTERN NSString * const kGTLRSolar_BuildingInsightsDetectedArrays_DetectionStatus_DetectionStatusDataUnavailable;
/**
 *  No solar arrays detected for this building.
 *
 *  Value: "DETECTION_STATUS_NO_ARRAYS_DETECTED"
 */
FOUNDATION_EXTERN NSString * const kGTLRSolar_BuildingInsightsDetectedArrays_DetectionStatus_DetectionStatusNoArraysDetected;
/**
 *  Unspecified status.
 *
 *  Value: "DETECTION_STATUS_UNSPECIFIED"
 */
FOUNDATION_EXTERN NSString * const kGTLRSolar_BuildingInsightsDetectedArrays_DetectionStatus_DetectionStatusUnspecified;
 ...
 */
@property(nonatomic, strong, nullable) GTLRSolar_BuildingInsightsDetectedArrays *detectedArrays;
 ...
 */
@interface GTLRSolar_BuildingInsightsDetectedArrays : GTLRObject

/**
 *  Indicates the detection status of solar arrays for this building.
 *
 *  Likely values:
 *    @arg @c kGTLRSolar_BuildingInsightsDetectedArrays_DetectionStatus_DetectionStatusArraysDetected
 *        At least one solar array has been detected for this building. (Value:
 *        "DETECTION_STATUS_ARRAYS_DETECTED")
 *    @arg @c kGTLRSolar_BuildingInsightsDetectedArrays_DetectionStatus_DetectionStatusDataUnavailable
 *        Detected solar array data is unavailable for this building. (Value:
 *        "DETECTION_STATUS_DATA_UNAVAILABLE")
 *    @arg @c kGTLRSolar_BuildingInsightsDetectedArrays_DetectionStatus_DetectionStatusNoArraysDetected
 *        No solar arrays detected for this building. (Value:
 *        "DETECTION_STATUS_NO_ARRAYS_DETECTED")
 *    @arg @c kGTLRSolar_BuildingInsightsDetectedArrays_DetectionStatus_DetectionStatusUnspecified
 *        Unspecified status. (Value: "DETECTION_STATUS_UNSPECIFIED")
 */
@property(nonatomic, copy, nullable) NSString *detectionStatus;

/** The date indicating when the latest solar array data was captured. */
@property(nonatomic, strong, nullable) GTLRSolar_Date *latestCaptureDate;
