...
@class GTLRTexttospeech_AdvancedVoiceOptions;
@class GTLRTexttospeech_AudioConfig;
@class GTLRTexttospeech_CustomPronunciationParams;
...
@class GTLRTexttospeech_Turn;
@class GTLRTexttospeech_Voice;
@class GTLRTexttospeech_VoiceCloneParams;
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRTexttospeech_CustomPronunciationParams_PhoneticEncoding_PhoneticEncodingXSampa;
 ...
 */
@interface GTLRTexttospeech_CustomPronunciationParams : GTLRObject
 ...
 */
@interface GTLRTexttospeech_MultiSpeakerMarkup : GTLRObject

/** Required. Speaker turns. */
@property(nonatomic, strong, nullable) NSArray<GTLRTexttospeech_Turn *> *turns;
 ...
 */
@property(nonatomic, copy, nullable) NSString *speaker;
 ...
 */
@interface GTLRTexttospeech_VoiceCloneParams : GTLRObject

/** Required. Created by GenerateVoiceCloningKey. */
@property(nonatomic, copy, nullable) NSString *voiceCloningKey;
