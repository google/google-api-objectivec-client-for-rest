...
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountRiskReason_Reason_AccountInLargeRelatedGroup = @"ACCOUNT_IN_LARGE_RELATED_GROUP";
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountRiskReason_Reason_ClientAccessedManyAccounts = @"CLIENT_ACCESSED_MANY_ACCOUNTS";
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountRiskReason_Reason_ClientHistoricalBotActivity = @"CLIENT_HISTORICAL_BOT_ACTIVITY";
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountRiskReason_Reason_DisposableEmailDomain = @"DISPOSABLE_EMAIL_DOMAIN";
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountRiskReason_Reason_RiskReasonUnspecified = @"RISK_REASON_UNSPECIFIED";
...
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentRiskReason_Reason_AssociatedWithFraudCluster = @"ASSOCIATED_WITH_FRAUD_CLUSTER";
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentRiskReason_Reason_ExcessiveEnumerationPattern = @"EXCESSIVE_ENUMERATION_PATTERN";
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentRiskReason_Reason_GeolocationDiscrepancy = @"GEOLOCATION_DISCREPANCY";
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentRiskReason_Reason_HighTransactionVelocity = @"HIGH_TRANSACTION_VELOCITY";
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentRiskReason_Reason_ReasonUnspecified = @"REASON_UNSPECIFIED";
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentRiskReason_Reason_ShortIdentityHistory = @"SHORT_IDENTITY_HISTORY";
...
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1TokenProperties_InvalidReason_DomainMismatch = @"DOMAIN_MISMATCH";
...
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1TokenProperties_InvalidReason_KeyMismatch = @"KEY_MISMATCH";
...
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1TokenProperties_InvalidReason_UnexpectedAction = @"UNEXPECTED_ACTION";
...
NSString * const kGTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1WafSettings_WafService_Akamai = @"AKAMAI";
...
@dynamic accountTakeoverVerdict, labels;
...
// ----------------------------------------------------------------------------
//
//   GTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountRiskReason
//

@implementation GTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountRiskReason
@dynamic reason;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountTakeoverVerdict
//

@implementation GTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountTakeoverVerdict
@dynamic risk, riskReasons, trustReasons;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"riskReasons" : [GTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountRiskReason class],
    @"trustReasons" : [GTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountTrustReason class]
  };
  return map;
}
...
// ----------------------------------------------------------------------------
//
//   GTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountTrustReason
//

@implementation GTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountTrustReason
@dynamic reason;
@end
...
@dynamic behavioralTrustVerdict, cardTestingVerdict, riskReasons,
         stolenInstrumentVerdict, transactionRisk;

+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    @"riskReasons" : [GTLRRecaptchaEnterprise_GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentRiskReason class]
  };
  return map;
}
