 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeRecaptchaEnterpriseCloudPlatform;
...
// GTLRRecaptchaEnterpriseQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
