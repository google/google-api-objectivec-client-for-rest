 ...
 *    Cloud console](https://support.google.com/cloud/answer/6158840). It may
 *    also include a location, such as
 ...
 *  Deletes all error events of a given project.
 *
 *  Method: clouderrorreporting.projects.locations.deleteEvents
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeClouderrorreportingCloudPlatform
 */
@interface GTLRClouderrorreportingQuery_ProjectsLocationsDeleteEvents : GTLRClouderrorreportingQuery
 ...
 *    is the default when unspecified.
 *
 *  @return GTLRClouderrorreportingQuery_ProjectsLocationsDeleteEvents
 */
+ (instancetype)queryWithProjectName:(NSString *)projectName;
 ...
 *  Lists the specified events.
 *
 *  Method: clouderrorreporting.projects.locations.events.list
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeClouderrorreportingCloudPlatform
 */
@interface GTLRClouderrorreportingQuery_ProjectsLocationsEventsList : GTLRClouderrorreportingQuery
 ...
 *    is the default when unspecified.
 *
 *  @return GTLRClouderrorreportingQuery_ProjectsLocationsEventsList
 *
 *  @note Automatic pagination will be done when @c shouldFetchNextPages is
 *        enabled. See @c shouldFetchNextPages on @c GTLRService for more
 *        information.
 ...
 *  Get the specified group.
 *
 *  Method: clouderrorreporting.projects.locations.groups.get
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeClouderrorreportingCloudPlatform
 */
@interface GTLRClouderrorreportingQuery_ProjectsLocationsGroupsGet : GTLRClouderrorreportingQuery
 ...
 *    is the default when unspecified.
 *
 *  @return GTLRClouderrorreportingQuery_ProjectsLocationsGroupsGet
 */
+ (instancetype)queryWithGroupName:(NSString *)groupName;
 ...
 *  Lists the specified groups.
 *
 *  Method: clouderrorreporting.projects.locations.groupStats.list
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeClouderrorreportingCloudPlatform
 */
@interface GTLRClouderrorreportingQuery_ProjectsLocationsGroupStatsList : GTLRClouderrorreportingQuery
 ...
 *    stats from all regions.
 *
 *  @return GTLRClouderrorreportingQuery_ProjectsLocationsGroupStatsList
 *
 *  @note Automatic pagination will be done when @c shouldFetchNextPages is
 *        enabled. See @c shouldFetchNextPages on @c GTLRService for more
 *        information.
 ...
 *  Replace the data for the specified group. Fails if the group does not exist.
 *
 *  Method: clouderrorreporting.projects.locations.groups.update
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeClouderrorreportingCloudPlatform
 */
@interface GTLRClouderrorreportingQuery_ProjectsLocationsGroupsUpdate : GTLRClouderrorreportingQuery
 ...
 *    is the default when unspecified.
 *
 *  @return GTLRClouderrorreportingQuery_ProjectsLocationsGroupsUpdate
 */
+ (instancetype)queryWithObject:(GTLRClouderrorreporting_ErrorGroup *)object
                           name:(NSString *)name;
