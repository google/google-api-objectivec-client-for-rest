...
NSString * const kGTLRBackupdr_DiskBackupProperties_Architecture_Arm64 = @"ARM64";
NSString * const kGTLRBackupdr_DiskBackupProperties_Architecture_X8664 = @"X86_64";

// GTLRBackupdr_DiskRestoreProperties.accessMode
NSString * const kGTLRBackupdr_DiskRestoreProperties_AccessMode_ReadOnlyMany = @"READ_ONLY_MANY";
NSString * const kGTLRBackupdr_DiskRestoreProperties_AccessMode_ReadWriteMany = @"READ_WRITE_MANY";
NSString * const kGTLRBackupdr_DiskRestoreProperties_AccessMode_ReadWriteSingle = @"READ_WRITE_SINGLE";
...
NSString * const kGTLRBackupdr_LocationMetadata_UnsupportedFeatures_BvAf = @"BV_AF";
NSString * const kGTLRBackupdr_LocationMetadata_UnsupportedFeatures_BvCustomProbers = @"BV_CUSTOM_PROBERS";
NSString * const kGTLRBackupdr_LocationMetadata_UnsupportedFeatures_CepMonitoringComputeInstance = @"CEP_MONITORING_COMPUTE_INSTANCE";
NSString * const kGTLRBackupdr_LocationMetadata_UnsupportedFeatures_CepMonitoringDisk = @"CEP_MONITORING_DISK";
...
NSString * const kGTLRBackupdr_ResourceBackupConfig_TargetResourceType_FilestoreInstance = @"FILESTORE_INSTANCE";
...
@dynamic alloyDbBackupProperties, backupApplianceBackupProperties,
         ...
         enforcedRetentionEndTime, ETag, expireTime,
         filestoreInstanceBackupProperties, gcpBackupPlanInfo, gcpResource,
         kmsKeyVersions, labels, name, resourceSizeBytes, satisfiesPzi,
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_BackupGcpResource
//

@implementation GTLRBackupdr_BackupGcpResource
...
@dynamic backupRules, backupVault, backupVaultServiceAccount,
         computeInstanceBackupPlanProperties, createTime, descriptionProperty,
         diskBackupPlanProperties, ETag, labels, logRetentionDays,
...
+ (NSDictionary<NSString *, Class> *)arrayPropertyToClassMap {
  NSDictionary<NSString *, Class> *map = @{
    ...
    @"supportedResourceTypes" : [NSString class]
  };
  return map;
}
...
@dynamic databaseInstalledVersion, finalBackup, instanceCreateTime,
         instanceDeleteTime, instanceTier, sourceInstance;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_ComputeInstanceBackupPlanProperties
//
...
@dynamic project, useProjectServiceAccount, zoneProperty;
...
@dynamic backupBlockedByVaultAccessRestriction, backupConfigInfo, backupCount,
         configState, createTime, dataSourceBackupApplianceApplication,
         dataSourceGcpResource, ETag, labels, name, state, totalStoredBytes,
         updateTime;
...
@dynamic alloyDbClusterDatasourceProperties,
         ...
         filestoreInstanceDatasourceProperties, gcpResourcename, location, type;
@end
...
@dynamic alloyDbClusterProperties, cloudSqlInstanceProperties,
         filestoreInstanceProperties, gcpResourcename, location, type;
@end
...
@dynamic createTime, dataSource, dataSourceBackupConfigInfo,
         ...
         dataSourceGcpResourceInfo, name, totalStoredBytes;
@end
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_DiskDataSourceProperties
//

@implementation GTLRBackupdr_DiskDataSourceProperties
@dynamic descriptionProperty, name, sizeGb, type;
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_DiskRestoreProperties_Labels
//

@implementation GTLRBackupdr_DiskRestoreProperties_Labels
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_DiskRestoreProperties_ResourceManagerTags
//
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_DiskTargetEnvironment
//

@implementation GTLRBackupdr_DiskTargetEnvironment
@dynamic project, useProjectServiceAccount, zoneProperty;
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_FetchBackupsForResourceTypeResponse
//

@implementation GTLRBackupdr_FetchBackupsForResourceTypeResponse
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_FetchResourceBackupConfigsResponse
//

@implementation GTLRBackupdr_FetchResourceBackupConfigsResponse
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_FilestoreInstanceBackupProperties
//

@implementation GTLRBackupdr_FilestoreInstanceBackupProperties
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_FilestoreInstanceDataSourceProperties
//

@implementation GTLRBackupdr_FilestoreInstanceDataSourceProperties
@dynamic instanceCreateTime, name;
@end


// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_FilestoreInstanceDataSourceReferenceProperties
//

@implementation GTLRBackupdr_FilestoreInstanceDataSourceReferenceProperties
@dynamic instanceCreateTime, name;
@end
...
@implementation GTLRBackupdr_ListDataSourceReferencesResponse
@dynamic dataSourceReferences, nextPageToken, unreachable;
...
// ----------------------------------------------------------------------------
//
//   GTLRBackupdr_RegionDiskTargetEnvironment
//

@implementation GTLRBackupdr_RegionDiskTargetEnvironment
@dynamic project, region, replicaZones, useProjectServiceAccount;
