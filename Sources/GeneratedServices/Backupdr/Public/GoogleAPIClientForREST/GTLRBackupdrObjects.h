 ...
 *  Value: "UPDATING"
 */
FOUNDATION_EXTERN NSString * const kGTLRBackupdr_BackupPlan_State_Updating;
 ...
 *        (Value: "STATE_UNSPECIFIED")
 *    @arg @c kGTLRBackupdr_BackupPlan_State_Updating The resource is being
 ...
 *  daily backups. Minimum value is 7 and maximum value is 366 for weekly
