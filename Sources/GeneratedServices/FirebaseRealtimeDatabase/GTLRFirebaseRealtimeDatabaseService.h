 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeFirebaseRealtimeDatabaseCloudPlatform;
/**
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeFirebaseRealtimeDatabaseCloudPlatformReadOnly;
/**
 *  Authorization scope: View and administer all your Firebase data and settings
 *
 *  Value "https://www.googleapis.com/auth/firebase"
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeFirebaseRealtimeDatabaseFirebase;
/**
 *  Authorization scope: View all your Firebase data and settings
 *
 *  Value "https://www.googleapis.com/auth/firebase.readonly"
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopeFirebaseRealtimeDatabaseFirebaseReadonly;
 ...
 *  provisioning and management of Realtime Database instances.
 */
@interface GTLRFirebaseRealtimeDatabaseService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRFirebaseRealtimeDatabaseQuery.h. The query can the be sent with
