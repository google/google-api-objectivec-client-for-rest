...
@class GTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle;
 ...
 *  Value: "API_CURRENT"
 */
FOUNDATION_EXTERN NSString * const kGTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle_PolicyApiLifecycleStage_ApiCurrent;
/**
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle_PolicyApiLifecycleStage_ApiDeprecated;
/**
 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle_PolicyApiLifecycleStage_ApiDevelopment;
/**
 ...
 *  Value: "API_PREVIEW"
 */
FOUNDATION_EXTERN NSString * const kGTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle_PolicyApiLifecycleStage_ApiPreview;
/**
 ...
 *  explicitly prohibited. In Editions, the `field_presence` feature can be used
 ...
 *  group wire format and treat group fields as unknown fields. In Editions, the
 ...
 */
@interface GTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle : GTLRObject
 ...
 *  its end support date will result in a Bad Request (400 error). Could only be
 *  set if policy_api_lifecycle_stage is API_DEPRECATED.
 */
 ...
 *
 *  Likely values:
 *    @arg @c kGTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle_PolicyApiLifecycleStage_ApiCurrent
 ...
 *    @arg @c kGTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle_PolicyApiLifecycleStage_ApiDeprecated
 ...
 *    @arg @c kGTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle_PolicyApiLifecycleStage_ApiDevelopment
 ...
 *    @arg @c kGTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle_PolicyApiLifecycleStage_ApiPreview
 ...
 *        "API_PREVIEW")
 *    @arg @c kGTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle_PolicyApiLifecycleStage_ApiUnspecified
 *        Policy Api Lifecycle is Unspecified. (Value: "API_UNSPECIFIED")
 */
...
@property(nonatomic, strong, nullable) GTLRChromePolicy_GoogleChromePolicyVersionsV1PolicyApiLifecycle *policyApiLifecycle;
 ...
 *        The required label is only allowed in proto2. In proto3 and Editions
 *        it's explicitly prohibited. In Editions, the `field_presence` feature
 *        can be used to get this behavior. (Value: "LABEL_REQUIRED")
 */
 ...
 *        after proto2. However, Proto3 implementations should still be able to
 *        parse the group wire format and treat group fields as unknown fields.
 *        In Editions, the group wire format can be enabled via the
 *        `message_encoding` feature. (Value: "TYPE_GROUP")
