...
@class GTLRPubsub_UnstructuredInference;
@class GTLRPubsub_UnstructuredInference_Parameters;
 ...
 */
@interface GTLRPubsub_AIInference : GTLRObject
...
@property(nonatomic, strong, nullable) GTLRPubsub_UnstructuredInference *unstructuredInference;
 ...
 *  requests built from the Pub/Sub message data and provided parameters will be
 *  sent to.
 */
 ...
 */
@interface GTLRPubsub_UnstructuredInference : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) GTLRPubsub_UnstructuredInference_Parameters *parameters;
 ...
 */
@interface GTLRPubsub_UnstructuredInference_Parameters : GTLRObject
@end
