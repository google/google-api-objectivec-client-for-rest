...
@implementation GTLRDataprocQuery_ProjectsLocationsBatchesSparkApplicationsComputeTuningConfig

@dynamic executionId, name, parent, semanticQueryId;

+ (instancetype)queryWithName:(NSString *)name {
  NSArray *pathParams = @[ @"name" ];
  NSString *pathURITemplate = @"v1/{+name}:computeTuningConfig";
  GTLRDataprocQuery_ProjectsLocationsBatchesSparkApplicationsComputeTuningConfig *query =
    [[self alloc] initWithPathURITemplate:pathURITemplate
                               HTTPMethod:nil
                       pathParameterNames:pathParams];
  query.name = name;
  query.expectedObjectClass = [GTLRDataproc_ComputeTuningConfigResponse class];
  query.loggingName = @"dataproc.projects.locations.batches.sparkApplications.computeTuningConfig";
  return query;
}
