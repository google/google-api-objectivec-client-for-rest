 ...
 *
 *  Method: dataproc.projects.locations.batches.sparkApplications.computeTuningConfig
 *
 *  Authorization scope(s):
 *    @c kGTLRAuthScopeDataproc
 *    @c kGTLRAuthScopeDataprocCloudPlatform
 *    @c kGTLRAuthScopeDataprocReadOnly
 */
@interface GTLRDataprocQuery_ProjectsLocationsBatchesSparkApplicationsComputeTuningConfig : GTLRDataprocQuery
 ...
 *  autotuning configuration for in the format
 *  "projects/PROJECT_ID/locations/DATAPROC_REGION/batches/BATCH_ID/sparkApplications/APPLICATION_ID"
 */
@property(nonatomic, copy, nullable) NSString *name;
...
@property(nonatomic, copy, nullable) NSString *semanticQueryId;

/**
 *  Fetches a @c GTLRDataproc_ComputeTuningConfigResponse.
 *
 *  Returns autotuning configuration for a specific query plan id and cohort id.
 *  Called by Spark during query planning.
 *
 ...
 *    "projects/PROJECT_ID/locations/DATAPROC_REGION/batches/BATCH_ID/sparkApplications/APPLICATION_ID"
 *
 *  @return GTLRDataprocQuery_ProjectsLocationsBatchesSparkApplicationsComputeTuningConfig
 */
+ (instancetype)queryWithName:(NSString *)name;
