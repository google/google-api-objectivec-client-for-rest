...
@class GTLRCloudSecurityToken_GoogleIdentityStsV1AccessBoundary;
 ...
 *  resources.
 */
@interface GTLRCloudSecurityToken_GoogleIdentityStsV1AccessBoundary : GTLRObject
 ...
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudSecurityToken_GoogleIdentityStsV1AccessBoundaryRule *> *accessBoundaryRules;
 ...
 *  single resource.
 */
@interface GTLRCloudSecurityToken_GoogleIdentityStsV1AccessBoundaryRule : GTLRObject

/**
 *  The availability condition further constrains the access allowed by the
 *  access boundary rule. If the condition evaluates to `true`, then this access
 *  boundary rule will provide access to the specified resource, assuming the
 *  principal has the required permissions for the resource. If the condition
 *  does not evaluate to `true`, then access to the specified resource will not
 *  be available. Note that all access boundary rules in an access boundary are
 *  evaluated together as a union. As such, another access boundary rule may
 *  allow access to the resource, even if this access boundary rule does not
 *  allow access. To learn which resources support conditions in their IAM
 *  policies, see the [IAM
 *  documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
 *  The maximum length of the `expression` field is 2048 characters.
 */
@property(nonatomic, strong, nullable) GTLRCloudSecurityToken_GoogleTypeExpr *availabilityCondition;
 ...
 *  roles.
 */
@property(nonatomic, strong, nullable) NSArray<NSString *> *availablePermissions;
 ...
 */
@property(nonatomic, copy, nullable) NSString *availableResource;
 ...
 *  resources.
 */
@interface GTLRCloudSecurityToken_GoogleIdentityStsV1betaAccessBoundary : GTLRObject
 ...
 *  attached. One access boundary can contain at most 10 rules.
 */
@property(nonatomic, strong, nullable) NSArray<GTLRCloudSecurityToken_GoogleIdentityStsV1betaAccessBoundaryRule *> *accessBoundaryRules;
 ...
 *  single resource.
 */
@interface GTLRCloudSecurityToken_GoogleIdentityStsV1betaAccessBoundaryRule : GTLRObject
 ...
 */
@interface GTLRCloudSecurityToken_GoogleIdentityStsV1betaOptions : GTLRObject
 ...
 *  endpoints, as defined in https://tools.ietf.org/html/rfc8693.
 */
@interface GTLRCloudSecurityToken_GoogleIdentityStsV1Options : GTLRObject
 ...
 *  information.
 */
@interface GTLRCloudSecurityToken_GoogleTypeExpr : GTLRObject
