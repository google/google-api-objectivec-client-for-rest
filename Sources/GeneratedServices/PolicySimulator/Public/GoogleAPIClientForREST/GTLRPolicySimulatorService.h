 ...
 */
FOUNDATION_EXTERN NSString * const kGTLRAuthScopePolicySimulatorCloudPlatform;
...
/**
 *  Service for executing Policy Simulator API queries.
 *
 *  Policy Simulator is a collection of endpoints for creating, running, and
 *  viewing a Replay. A `Replay` is a type of simulation that lets you see how
 *  your members' access to resources might change if you changed your IAM
 ...
 *  under the proposed policy.
 */
@interface GTLRPolicySimulatorService : GTLRService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLRPolicySimulatorQuery.h. The query can the be sent with GTLRService's
// execute methods,
//
