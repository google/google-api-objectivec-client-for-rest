...
@dynamic databaseFunction, databasePackage, entityType, mappings, parentEntity,
         schema, sequence, shortName, storedProcedure, synonym, table, tree,
         view;
