...
@class GTLRGmail_ClassificationLabelFieldValue;
@class GTLRGmail_ClassificationLabelValue;
 ...
 */
@interface GTLRGmail_ClassificationLabelFieldValue : GTLRObject
...
/**
 *  Classification Labels applied to the email message. Classification Labels
 *  are different from Gmail inbox labels. Only used for Google Workspace
 *  accounts. [Learn more about classification
 *  labels](https://support.google.com/a/answer/9292382).
 */
@interface GTLRGmail_ClassificationLabelValue : GTLRObject

/** Field values for the given classification label ID. */
@property(nonatomic, strong, nullable) NSArray<GTLRGmail_ClassificationLabelFieldValue *> *fields;
 ...
 *  encryption](https://support.google.com/a/answer/14153163) is set up for the
 *  Google Workspace organization, users can optionally store their private key
 *  on their smart card and use it to sign and decrypt email messages in Gmail
 *  by inserting their smart card into a reader attached to their Windows
 *  device.
 */
